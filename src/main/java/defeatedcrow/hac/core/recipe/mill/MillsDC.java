...
public class MillsDC {
	...
	private MillsDC() {
		...
		list1.add(new Crops("grasswort", FoodInit.CROP_AM_GLASSWORT, CoreInit.DUST_TRONA, FoodInit.DUST_PLANT));
		list1.add(new Crops("parsnip", FoodInit.CROP_AP_PARSNIP, FoodInit.FOOD_SYRUP, FoodInit.DUST_PLANT));
		...
		list1.add(new Crops("turmeric", FoodInit.CROP_GN_TURMERIC, () -> Items.YELLOW_DYE, FoodInit.DUST_PLANT));
		list1.add(new Crops("crocus", FoodInit.CROP_IR_CROCUS, () -> Items.PURPLE_DYE, FoodInit.DUST_PLANT));
		list1.add(new Crops("saffron", FoodInit.CROP_IR_SAFFRON, () -> Items.YELLOW_DYE, FoodInit.DUST_PLANT));
		list1.add(new Crops("buckwheat", FoodInit.CROP_KN_BUCKWHEAT, FoodInit.FOOD_BUCKWHEAT, FoodInit.DUST_PLANT));
		list1.add(new Crops("indigo", FoodInit.CROP_KN_INDIGO, () -> Items.BLUE_DYE, FoodInit.DUST_PLANT));
		...
		list1.add(new Crops("spiranthes", FoodInit.CROP_OR_SPIRANTHES, () -> Items.PINK_DYE, FoodInit.DUST_PLANT));
		list1.add(new Crops("cymbidium", FoodInit.CROP_OR_CYMBIDIUM, () -> Items.LIME_DYE, FoodInit.DUST_PLANT));
		list1.add(new Crops("rogeria", FoodInit.CROP_PD_ROGERIA, FoodInit.FOOD_PLANT_OIL, FoodInit.DUST_PLANT));
		...
		list1.add(new Crops("anemone", FoodInit.CROP_RA_ANEMONE, () -> Items.WHITE_DYE, FoodInit.DUST_PLANT));
		list1.add(new Crops("delphinium", FoodInit.CROP_RA_DELPHINIUM, () -> Items.LIGHT_BLUE_DYE, FoodInit.DUST_PLANT));
