...
public class DeepfryCroquetteModel<T extends Entity> extends EntityModel<T> {

	private final ModelPart bowl;
	private final ModelPart vegi;
	private final ModelPart fry;

	public DeepfryCroquetteModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition fry = partdefinition.addOrReplaceChild("fry", CubeListBuilder.create(), PartPose.ZERO);
		PartDefinition cube_r13 = fry.addOrReplaceChild("cube_r13", CubeListBuilder.create()
				.texOffs(0, 26).addBox(-3.0F, -5.0F, 0.0F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.5236F, -1.7453F, 0.0F));
		PartDefinition cube_r14 = fry.addOrReplaceChild("cube_r14", CubeListBuilder.create()
				.texOffs(0, 19).addBox(-1.0F, -3.0F, -3.0F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.2618F, -0.1745F));
		PartDefinition cube_r15 = fry.addOrReplaceChild("cube_r15", CubeListBuilder.create()
				.texOffs(0, 19).addBox(2.0F, -2.5F, -3.5F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.1745F, -0.1745F));
