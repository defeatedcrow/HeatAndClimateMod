...
public class CurryBeansEntity extends FoodEntityBase {

	public CurryBeansEntity(World worldIn) {
		super(worldIn);
		this.setSize(0.75F, 0.25F);
	}

	public CurryBeansEntity(World worldIn, double posX, double posY, double posZ) {
		super(worldIn, posX, posY, posZ);
		this.setSize(0.75F, 0.25F);
	}

	public CurryBeansEntity(World worldIn, double posX, double posY, double posZ, @Nullable EntityPlayer player) {
	...
	protected ItemStack[] drops() {
		return new ItemStack[] {
				new ItemStack(FoodInit.curry, 1, 1),
				new ItemStack(FoodInit.curry, 1, 1)
		};
	}
