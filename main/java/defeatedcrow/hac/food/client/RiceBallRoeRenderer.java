...
public class RiceBallRoeRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/riceball_roe.png");
	private static final ModelOnigiri MODEL = new ModelOnigiri(false);

	public RiceBallRoeRenderer(RenderManager renderManager) {
		super(renderManager);
	}
