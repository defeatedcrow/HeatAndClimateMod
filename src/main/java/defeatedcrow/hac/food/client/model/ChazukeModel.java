...
public class ChazukeModel<T extends Entity> extends EntityModel<T> implements TranslucentPartModel {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition rice = partdefinition.addOrReplaceChild("rice", CubeListBuilder.create()
		    .texOffs(23, 10)
		    .addBox(-3.5F, -6.0F, -3.5F, 7.0F, 4.0F, 7.0F, new CubeDeformation(0.0F))
		    .texOffs(25, 22)
		    .addBox(-3.0F, -7.0F, -3.0F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
		    .texOffs(45, 11)
		    .addBox(-2.0F, -8.0F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.ZERO);

		PartDefinition cube_r4 = rice.addOrReplaceChild("cube_r4", CubeListBuilder.create()
		    .texOffs(48, 26)
		    .addBox(-2.0F, -9.1F, -2.0F, 4.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.2618F, 0.0F));

		PartDefinition cube_r5 = rice.addOrReplaceChild("cube_r5", CubeListBuilder.create()
		    .texOffs(41, 22)
		    .addBox(-1.0F, -9.0F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		    .texOffs(50, 22)
		    .addBox(-2.0F, -9.0F, -1.0F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -2.618F, 0.0F));

		PartDefinition soup = partdefinition.addOrReplaceChild("soup", CubeListBuilder.create()
		    .texOffs(0, 24)
		    .addBox(-4.0F, -6.5F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.ZERO);
		...
		PartDefinition cube_r6 = mochi.addOrReplaceChild("cube_r6", CubeListBuilder.create()
		    .texOffs(52, 17)
		    .addBox(-2.0F, 0.0F, 1.0F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -7.0F, 0.0F, -0.1745F, 1.0472F, 0.0F));

		PartDefinition cube_r7 = mochi.addOrReplaceChild("cube_r7", CubeListBuilder.create()
		    .texOffs(52, 17)
		    .addBox(-2.0F, -0.5F, 0.0F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -7.0F, 0.0F, -0.5236F, -2.618F, 0.0F));

		PartDefinition cube_r8 = mochi.addOrReplaceChild("cube_r8", CubeListBuilder.create()
		    .texOffs(52, 17)
		    .addBox(-3.0F, 0.0F, 0.0F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -7.0F, 0.0F, -0.2618F, 0.0F, 0.0F));
