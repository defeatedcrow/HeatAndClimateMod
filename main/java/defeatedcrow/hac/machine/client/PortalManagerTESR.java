...
import defeatedcrow.hac.machine.client.model.ModelPortalManager;
...
public class PortalManagerTESR extends DCTorqueTESRBase {
	...
	private static final DCTileModelBase MODEL = new ModelPortalManager();
	...
	public void render(TileTorqueBase te, double x, double y, double z, float partialTicks, int destroyStage, float a) {
		...
		this.bindTexture(new ResourceLocation(getTexPass(i)));
