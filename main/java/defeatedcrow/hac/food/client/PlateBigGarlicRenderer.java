...
public class PlateBigGarlicRenderer extends DCRenderFoodBase<PlateBigGarlicEntity> {
	...
	@Override
	public void doRender(PlateBigGarlicEntity entity, double x, double y, double z, float yaw, float partialTicks) {
