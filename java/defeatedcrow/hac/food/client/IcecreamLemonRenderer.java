...
public class IcecreamLemonRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate", "textures/entity/food/icecream_lemon.png");
	private static final ModelIcecream MODEL = new ModelIcecream(false);

	public IcecreamLemonRenderer(RenderManager renderManager) {
		super(renderManager);
	}
