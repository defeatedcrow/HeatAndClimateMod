...
public class FoodBasicRecipe {
	...
	public static void load(RecipeResourcesMain res) {
		...
		DCRecipe.jsonShapelessRecipe("food", new ItemStack(FoodInit.salad, 1, 2), new Object[] {
				"cropLotusRoot",
				"cropCarrot"
		});
	...
	public static void loadCrops(RecipeResourcesMain res) {
		...
		for (int i = 0; i < 6; i++) {
			DCRecipe.jsonShapelessRecipe("food", new ItemStack(FoodInit.seeds, 1, i), new Object[] {
