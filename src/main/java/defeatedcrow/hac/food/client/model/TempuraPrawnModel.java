...
public class TempuraPrawnModel<T extends Entity> extends EntityModel<T> {

	private final ModelPart bowl;
	private final ModelPart meal;

	public TempuraPrawnModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r5 = meal.addOrReplaceChild("cube_r5", CubeListBuilder.create()
				.texOffs(20, 15).addBox(0.5F, -1.5F, 4.75F, 3.0F, 0.0F, 2.0F, new CubeDeformation(0.0F))
				.texOffs(23, 17).addBox(1.5F, -2.0F, 3.25F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
				.texOffs(4, 22).addBox(0.4F, -1.75F, 0.75F, 3.0F, 0.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(13, 15).addBox(0.9F, -2.25F, 0.75F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.3491F, -0.3491F, 0.0F));

		PartDefinition cube_r6 = meal.addOrReplaceChild("cube_r6", CubeListBuilder.create()
				.texOffs(-4, 21).addBox(0.5F, -2.0F, -3.5F, 3.0F, 0.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(0, 14).addBox(1.0F, -2.5F, -3.5F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0873F, -0.3491F, 0.0F));

		PartDefinition cube_r7 = meal.addOrReplaceChild("cube_r7", CubeListBuilder.create()
				.texOffs(20, 15).addBox(-2.5F, -2.25F, 4.5F, 3.0F, 0.0F, 2.0F, new CubeDeformation(0.0F))
				.texOffs(23, 17).addBox(-1.5F, -2.75F, 3.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.6981F, 0.7854F, 0.0F));

		PartDefinition cube_r8 = meal.addOrReplaceChild("cube_r8", CubeListBuilder.create()
				.texOffs(4, 22).addBox(-2.6F, -1.5F, 0.0F, 3.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.25F, 0.0F, 0.6109F, 0.7854F, 0.0F));

		PartDefinition cube_r9 = meal.addOrReplaceChild("cube_r9", CubeListBuilder.create()
				.texOffs(13, 15).addBox(-2.1F, -3.25F, 0.5F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.6109F, 0.7854F, 0.0F));

		PartDefinition cube_r10 = meal.addOrReplaceChild("cube_r10", CubeListBuilder.create()
				.texOffs(-4, 21).addBox(-2.5F, -1.5F, -4.0F, 3.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.25F, 0.0F, 0.2618F, 0.7854F, 0.0F));

		PartDefinition cube_r11 = meal.addOrReplaceChild("cube_r11", CubeListBuilder.create()
				.texOffs(0, 14).addBox(-2.0F, -3.25F, -4.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.2618F, 0.7854F, 0.0F));
