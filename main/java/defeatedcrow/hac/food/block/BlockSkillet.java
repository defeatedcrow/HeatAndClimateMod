...
public class BlockSkillet extends DCTileBlockFaced implements IAirflowTile {
	...
	public boolean onRightClick(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand,
		...
		if (player != null && !world.isRemote && hand == EnumHand.MAIN_HAND) {
			...
			if (tile != null && tile instanceof TileSkillet) {
	...
	public static void changeLitState(World world, BlockPos pos, boolean f) {
		...
		if (state.getBlock() == FoodInit.skillet) {
			if (f) {
	...
	public void randomDisplayTick(IBlockState state, World world, BlockPos pos, Random rand) {
		if (state != null && BlockSkillet.isLit(world, pos)) {
