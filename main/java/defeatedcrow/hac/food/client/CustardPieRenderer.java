...
public class CustardPieRenderer extends DCRenderFoodBase<PieChocolateEntity> {
	...
	public CustardPieRenderer(RenderManager renderManager) {
		super(renderManager);
	}
