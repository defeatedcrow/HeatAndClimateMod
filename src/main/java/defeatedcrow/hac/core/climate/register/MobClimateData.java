...
public enum MobClimateData {
	ALLAY(EntityType.ALLAY, 3.0F, 2.0F),
	AXOLOTL(EntityType.AXOLOTL, 3.0F, 2.0F),
	...
	COW(EntityType.COW, 2.0F, 4.0F),
	CREEPER(EntityType.CREEPER, 3.0F, 2.0F),
	DROWNED(EntityType.DROWNED, 0.0F, 6.0F),
	...
	FROG(EntityType.FROG, 3.0F, 1.0F),
	GHAST(EntityType.GHAST, 8.0F, 0.0F),
	GORT(EntityType.GOAT, 3.0F, 6.0F),
	GURDIAN(EntityType.GUARDIAN, 3.0F, 2.0F),
	HOGLIN(EntityType.HOGLIN, 8.0F, 1.0F),
	HORSE(EntityType.HORSE, 3.0F, 4.0F),
	...
	ZONBIE(EntityType.ZOMBIE, 1.0F, 6.0F);
