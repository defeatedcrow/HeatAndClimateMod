...
public class BlockTagProviderDC extends BlockTagsProvider {
	...
	public BlockTagProviderDC(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider, @Nullable ExistingFileHelper helper) {
	...
	protected void addTags(Provider provider) {
		...
		tag(TagDC.BlockTag.ORES_COLOR).addTags(TagDC.BlockTag.ORES_WHITE, TagDC.BlockTag.ORES_BLUE, TagDC.BlockTag.ORES_BLACK, TagDC.BlockTag.ORES_RED, TagDC.BlockTag.ORES_GREEN, TagDC.BlockTag.ORES_WHITE_DEEP,
		...
		tag(BlockTags.WOODEN_DOORS).add(BuildInit.DOOR_BEECH.get(), BuildInit.DOOR_WALNUT.get(), BuildInit.DOOR_SWEET.get(), BuildInit.DOOR_CHERRY.get(), BuildInit.DOOR_CAMPHOR.get(), BuildInit.DOOR_CITRUS.get(), BuildInit.DOOR_ASH.get(),
		    BuildInit.DOOR_SUMAC.get(), BuildInit.DOOR_LACQUER.get(), BuildInit.DOOR_EUCALYPTUS.get(), BuildInit.DOOR_KUKUI.get());

		tag(BlockTags.WOODEN_TRAPDOORS).add(BuildInit.TRAPDOOR_BEECH.get(), BuildInit.TRAPDOOR_WALNUT.get(), BuildInit.DOOR_SWEET.get(), BuildInit.TRAPDOOR_CHERRY.get(), BuildInit.TRAPDOOR_CAMPHOR.get(), BuildInit.TRAPDOOR_CITRUS.get(),
		    BuildInit.TRAPDOOR_ASH.get(), BuildInit.TRAPDOOR_SUMAC.get(), BuildInit.TRAPDOOR_LACQUER.get(), BuildInit.TRAPDOOR_EUCALYPTUS.get(), BuildInit.TRAPDOOR_KUKUI.get());
		...
		tag(TagDC.BlockTag.BEE_FLOWERS).add(FoodInit.BLOCK_BR_RAPESEED.get(), FoodInit.BLOCK_HB_LAVENDER.get(), FoodInit.BLOCK_ML_BLUE.get(), FoodInit.BLOCK_ML_TROPICAL.get(), FoodInit.BLOCK_MO_BINDWEED.get(),
		    FoodInit.BLOCK_MO_FLOWER.get(), FoodInit.BLOCK_PD_ROGERIA.get(), FoodInit.BLOCK_SL_NIGHTSHADE.get(), FoodInit.BLOCK_SL_LANTERN.get(), FoodInit.BLOCK_IR_CROCUS.get(), FoodInit.BLOCK_IR_IRIS.get(), FoodInit.BLOCK_IR_SAFFRON.get(),
		    FoodInit.BLOCK_OR_SPIRANTHES.get(), FoodInit.BLOCK_OR_CYMBIDIUM.get(), FoodInit.BLOCK_OR_CATTLEYA.get(), FoodInit.BLOCK_RA_ANEMONE.get(), FoodInit.BLOCK_RA_DELPHINIUM.get(), FoodInit.BLOCK_RA_CLEMATIS.get(),
		    FoodInit.BLOCK_OR_CYMBIDIUM.get(), FoodInit.CROPBLOCK_PL_COCONUT.get(), FoodInit.CROPBLOCK_PL_DATE.get(), FoodInit.CROPBLOCK_PL_OIL.get(), FoodInit.BLOCK_AMR_SNOWDROP.get(), FoodInit.BLOCK_AMR_DAFFODIL.get(),
		    FoodInit.BLOCK_AMR_AMARYLLIS.get(), FoodInit.BLOCK_AMR_LYCORIS.get(), FoodInit.BLOCK_LI_AMANA.get(), FoodInit.BLOCK_LI_FAWN.get(), FoodInit.BLOCK_LI_GOLDBAND.get());

		tag(BlockTags.FLOWERS).addTags(TagDC.BlockTag.BEE_FLOWERS);

		tag(BlockTags.LEAVES).add(FoodInit.LEAVES_BH_COMMON.get(), FoodInit.LEAVES_BH_WALNUT.get(), FoodInit.LEAVES_BH_SWEET.get(), FoodInit.LEAVES_CH_WILD.get(), FoodInit.LEAVES_CH_PLUM.get(), FoodInit.LEAVES_CH_PEACH.get(),
		    FoodInit.LEAVES_CH_ALMOND.get(), FoodInit.LEAVES_CM_TEA.get(), FoodInit.LEAVES_CM_OIL.get(), FoodInit.LEAVES_CM_SCHIMA.get(), FoodInit.LEAVES_CN_CAMPHOR.get(), FoodInit.LEAVES_CN_CINNAMON.get(), FoodInit.LEAVES_CN_AVOCADO.get(),
		    FoodInit.LEAVES_CT_POMELO.get(), FoodInit.LEAVES_CT_MANDARIN.get(), FoodInit.LEAVES_CT_LEMON.get(), FoodInit.LEAVES_CT_PEPPER.get(), FoodInit.LEAVES_ER_HEATH.get(), FoodInit.LEAVES_ER_RHODODENDRON.get(),
		    FoodInit.LEAVES_ER_BLUEBERRY.get(), FoodInit.LEAVES_MR_MULBERRY.get(), FoodInit.LEAVES_MR_PAPER.get(), FoodInit.LEAVES_MR_RUBBER.get(), FoodInit.LEAVES_OL_ASH.get(), FoodInit.LEAVES_OL_OLIVE.get(),
		    FoodInit.LEAVES_OL_OSMANTHUS.get(), FoodInit.LEAVES_OL_JASMINE.get(), FoodInit.LEAVES_PL_COMMON.get(), FoodInit.LEAVES_SU_LACQUER.get(), FoodInit.LEAVES_SU_MANGO.get(), FoodInit.LEAVES_SU_CASHEW.get(),
		    FoodInit.LEAVES_SU_PISTACHIO.get(), FoodInit.LEAVES_MY_EUCALYPTUS.get(), FoodInit.LEAVES_MY_GUAVA.get(), FoodInit.LEAVES_MY_CLOVE.get(), FoodInit.LEAVES_EU_KUKUI.get(), FoodInit.LEAVES_EU_MANCHINEEL.get(),
		    FoodInit.LEAVES_RU_GARDENIA.get(), FoodInit.LEAVES_RU_COFFEE.get(), FoodInit.LEAVES_RU_IXORA.get());
		...
		tag(BlockTags.OVERWORLD_NATURAL_LOGS).add(FoodInit.LOG_BH_COMMON.get(), FoodInit.LOG_BH_WALNUT.get(), FoodInit.LOG_BH_SWEET.get(), FoodInit.LOG_CH_WILD.get(), FoodInit.LOG_CN_CAMPHOR.get(), FoodInit.LOG_CN_CINNAMON.get(),
		    FoodInit.LOG_CT_POMELO.get(), FoodInit.LOG_MR_MULBERRY.get(), FoodInit.LOG_MR_PAPER.get(), FoodInit.LOG_MR_RUBBER.get(), FoodInit.LOG_MY_EUCALYPTUS.get(), FoodInit.LOG_OL_ASH.get(), FoodInit.LOG_PL_COCONUT.get(),
		    FoodInit.LOG_SU_LACQUER.get(), FoodInit.LOG_SU_MANGO.get(), FoodInit.LOG_EU_KUKUI.get(), FoodInit.LOG_EU_MANCHINEEL.get());

		tag(BlockTags.PLANKS).add(FoodInit.PLANK_BH_COMMON.get(), FoodInit.PLANK_BH_WALNUT.get(), FoodInit.PLANK_BH_SWEET.get(), FoodInit.PLANK_CH_WILD.get(), FoodInit.PLANK_CN_CAMPHOR.get(), FoodInit.PLANK_CT_POMELO.get(),
		...
		tag(TagDC.BlockTag.SCYTHE_BREAKABLE).add(Blocks.COBWEB, Blocks.DEAD_BUSH, Blocks.HANGING_ROOTS, Blocks.FERN, Blocks.VINE, Blocks.TRIPWIRE, Blocks.WHEAT, Blocks.CARROTS, Blocks.POTATOES, Blocks.BEETROOTS, Blocks.PUMPKIN,
		...
		tag(TagDC.BlockTag.COOKING_POT).add(MachineInit.COOKING_POT_NORMAL.get(), MachineInit.COOKING_POT_WHITE.get(), MachineInit.COOKING_POT_BLUE.get(), MachineInit.COOKING_POT_BLACK.get(), MachineInit.COOKING_POT_RED.get(),
		    MachineInit.COOKING_POT_GREEN.get());

		tag(TagDC.BlockTag.TEA_POT).add(MachineInit.TEA_POT_NORMAL.get(), MachineInit.TEA_POT_WHITE.get(), MachineInit.TEA_POT_BLUE.get(), MachineInit.TEA_POT_BLACK.get(), MachineInit.TEA_POT_RED.get(), MachineInit.TEA_POT_GREEN.get());

		tag(TagDC.BlockTag.FERMENTATION_JAR).add(MachineInit.FERMENTATION_JAR_NORMAL.get(), MachineInit.FERMENTATION_JAR_WHITE.get(), MachineInit.FERMENTATION_JAR_BLUE.get(), MachineInit.FERMENTATION_JAR_BLACK.get(),
		    MachineInit.FERMENTATION_JAR_RED.get(), MachineInit.FERMENTATION_JAR_GREEN.get());

		tag(TagDC.BlockTag.MONITOR).add(MachineInit.MONITOR_ANDON_LAMP.get(), MachineInit.MONITOR_ANDON_PANEL_1.get(), MachineInit.MONITOR_ANDON_PANEL_2.get(), MachineInit.MONITOR_ANDON_PANEL_3.get(),
		...
		tag(TagDC.BlockTag.WALL_LAMP).add(BuildInit.CHAL_LAMP_TABLE.get(), BuildInit.CHAL_LAMP_FLUORITE.get(), BuildInit.CHAL_LAMP_JET.get(), BuildInit.CHAL_LAMP_DESERTROSE.get(), BuildInit.CHAL_LAMP_SERPENTINE.get(),
		    BuildInit.CANDLESTICK.get());
