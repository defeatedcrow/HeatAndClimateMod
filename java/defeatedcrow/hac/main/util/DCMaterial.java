...
public enum DCMaterial {
	...
	CLOTH(1, "cloth", 1.0F, new int[] {
			...
			2,
			2,
			1 }, 0, 108, 0.0F, 25, 2.0F, 2.0F, new ItemStack(MainInit.materials, 1, 1),
			SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0.0F),
	// 純金属は基本的に利用しない
	...
	SILVER(5, "silver", 2.0F, new int[] {
			...
			5,
			4,
			2 }, 1, 256, 12.0F, 22, 0.5F, 0.5F, new ItemStack(MainInit.oreIngot, 1, 3),
	...
	BRASS(6, "brass", 2.0F, new int[] {
			...
			6,
			5,
			2 }, 2, 384, 6.0F, 10, 0.25F, 0.25F, new ItemStack(MainInit.oreIngot, 1, 4),
	...
	SAPPHIRE(10, "sapphire", 3.0F, new int[] {
			...
			8,
			6,
			3 }, 2, 1280, 7.0F, 18, 0.5F, 0.5F, new ItemStack(MainInit.gems, 1, 4),
