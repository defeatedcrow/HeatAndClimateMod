...
public class CakeCocotteRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/cocotte_egg_raw.png");
	private static final ResourceLocation BAKED = new ResourceLocation("dcs_climate",
			"textures/entity/food/cocotte_egg_baked.png");
	private static final ModelJelly MODEL = new ModelJelly(false);

	public CakeCocotteRenderer(RenderManager renderManager) {
		super(renderManager);
	}
