...
import defeatedcrow.hac.food.client.model.ModelPancakeTower;
...
public class PancakeTowerRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/cake_pancake_tower.png");
	private static final ModelPancakeTower MODEL = new ModelPancakeTower(false);

	public PancakeTowerRenderer(RenderManager renderManager) {
		super(renderManager);
	}
