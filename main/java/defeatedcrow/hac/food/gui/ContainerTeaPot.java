...
public class ContainerTeaPot extends Container {

	public final TileTeaPot processor;
	public final InventoryPlayer player;

	private int[] current = new int[12];

	public ContainerTeaPot(TileTeaPot tile, InventoryPlayer playerInv) {
		this.processor = tile;
