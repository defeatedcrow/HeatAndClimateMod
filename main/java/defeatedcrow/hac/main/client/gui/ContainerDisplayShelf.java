...
public class ContainerDisplayShelf extends Container {

	public final TileDisplayShelf tile;
	public final InventoryPlayer playerInv;

	public ContainerDisplayShelf(TileDisplayShelf chest, EntityPlayer player) {
		this.tile = chest;
		this.playerInv = player.inventory;
		chest.openInventory(player);

		for (int i1 = 0; i1 < 3; ++i1) {
			this.addSlotToContainer(new SlotLowChest(chest, i1, 62 + i1 * 18, 32));
		}
