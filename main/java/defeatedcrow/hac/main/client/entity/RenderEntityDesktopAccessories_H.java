...
import defeatedcrow.hac.main.client.model.ModelDesktopAccessories_G;
...
public class RenderEntityDesktopAccessories_H extends Render<DCEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/desktop_h.png");
	private static final DCTileModelBase MODEL = new ModelDesktopAccessories_G();

	public RenderEntityDesktopAccessories_H(RenderManager renderManager) {
		super(renderManager);
