...
@OnlyIn(Dist.CLIENT)
public class HeatingChamberScreen extends AbstractContainerScreen<HeatingChamberMenu> {

	public HeatingChamberScreen(HeatingChamberMenu menu, Inventory playerInv, Component comp) {
	...
	public void render(PoseStack pose, int mx, int my, float f) {
		...
		if (this.isHovering(69, 24, 38, 32, mx, my)) {
