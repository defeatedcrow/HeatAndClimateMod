...
public class MotuStickRenderer extends DCRenderFoodBase<MotuStickEntity> {
	...
	public MotuStickRenderer(RenderManager renderManager) {
		super(renderManager);
	}
