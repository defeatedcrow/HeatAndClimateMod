...
public class WagashiStrawberryRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate", "textures/entity/food/wagashi_strawberry.png");
	private static final ModelMochi MODEL = new ModelMochi(false);

	public WagashiStrawberryRenderer(RenderManager renderManager) {
		super(renderManager);
	}
