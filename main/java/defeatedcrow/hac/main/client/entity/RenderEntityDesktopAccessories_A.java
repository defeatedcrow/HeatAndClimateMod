...
public class RenderEntityDesktopAccessories_A extends Render<DCEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/desktop_a.png");
	private static final DCTileModelBase MODEL = new ModelDesktopAccessories_A();

	public RenderEntityDesktopAccessories_A(RenderManager renderManager) {
		super(renderManager);
