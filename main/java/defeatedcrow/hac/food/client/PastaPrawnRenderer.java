...
public class PastaPrawnRenderer extends DCRenderFoodBase<FoodEntityBase> {
	...
	private static final ResourceLocation PASTA_TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/pasta_prawn.png");
	private static final ModelDishPasta MODEL = new ModelDishPasta(false);

	public PastaPrawnRenderer(RenderManager renderManager) {
		super(renderManager);
	}
