...
public class ParfaitWatermelonRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/parfait_watermelon.png");
	private static final ModelParfait MODEL = new ModelParfait(false);

	public ParfaitWatermelonRenderer(RenderManager renderManager) {
		super(renderManager);
	}
