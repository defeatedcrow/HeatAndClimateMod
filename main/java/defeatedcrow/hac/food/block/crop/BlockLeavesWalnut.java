...
public class BlockLeavesWalnut extends ClimateCropBase implements ITexturePath, IShearable {
	...
	public BlockLeavesWalnut(String s) {
	...
	public List<ItemStack> getCropItems(IBlockState thisState, int fortune) {
		...
		list.add(new ItemStack(FoodInit.crops, i, 16));
		return list;
	}
