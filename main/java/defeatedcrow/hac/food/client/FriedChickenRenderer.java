...
public class FriedChickenRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/fried_chicken.png");
	private static final ModelDeepFry MODEL = new ModelDeepFry(false);

	public FriedChickenRenderer(RenderManager renderManager) {
		super(renderManager);
	}
