...
public class ModelWindmill_EX extends DCTileModelBase {
	// fields
	...
	public ModelWindmill_EX() {
		...
		shaftcube.setRotationPoint(0F, -4F, 0F);
		...
		winglod1.addBox(3F, -3F, -1.5F, 52, 3, 3);
		winglod1.setRotationPoint(0F, -2F, 0F);
		winglod1.setTextureSize(64, 32);
		winglod1.mirror = true;
		setRotation(winglod1, 0F, 0F, 0F);
		winglod2 = new ModelRenderer(this, 0, 12);
		winglod2.addBox(3F, -3F, -1.5F, 52, 3, 3);
		winglod2.setRotationPoint(0F, -2F, 0F);
		winglod2.setTextureSize(64, 32);
		winglod2.mirror = true;
		setRotation(winglod2, 0F, 1.570796F, 0F);
		winglod3 = new ModelRenderer(this, 0, 12);
		winglod3.addBox(3F, -3F, -1.5F, 52, 3, 3);
		winglod3.setRotationPoint(0F, -2F, 0F);
		winglod3.setTextureSize(64, 32);
		winglod3.mirror = true;
		setRotation(winglod3, 0F, 3.141593F, 0F);
		winglod4 = new ModelRenderer(this, 0, 12);
		winglod4.addBox(3F, -3F, -1.5F, 52, 3, 3);
		winglod4.setRotationPoint(0F, -2F, 0F);
		winglod4.setTextureSize(64, 32);
		winglod4.mirror = true;
		setRotation(winglod4, 0F, -1.570796F, 0F);
		wingcloth1 = new ModelRenderer(this, 0, 20);
		wingcloth1.addBox(5F, -2F, 1F, 50, 1, 10);
		wingcloth1.setRotationPoint(0F, -2F, 0F);
		wingcloth1.setTextureSize(64, 32);
		wingcloth1.mirror = true;
		setRotation(wingcloth1, -0.2617994F, 0F, 0F);
		wingcloth2 = new ModelRenderer(this, 0, 20);
		wingcloth2.addBox(5F, -2F, 1F, 50, 1, 10);
		wingcloth2.setRotationPoint(0F, -2F, 0F);
		wingcloth2.setTextureSize(64, 32);
		wingcloth2.mirror = true;
		setRotation(wingcloth2, -0.2617994F, 1.570796F, 0F);
		wingcloth3 = new ModelRenderer(this, 0, 20);
		wingcloth3.addBox(5F, -2F, 1F, 50, 1, 10);
		wingcloth3.setRotationPoint(0F, -2F, 0F);
		wingcloth3.setTextureSize(64, 32);
		wingcloth3.mirror = true;
		setRotation(wingcloth3, -0.2617994F, 3.141593F, 0F);
		wingcloth4 = new ModelRenderer(this, 0, 20);
		wingcloth4.addBox(5F, -2F, 1F, 50, 1, 10);
		wingcloth4.setRotationPoint(0F, -2F, 0F);
		wingcloth4.setTextureSize(64, 32);
