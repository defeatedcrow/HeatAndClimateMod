...
import defeatedcrow.hac.machine.client.model.ModelWaterPump;
...
public class WaterPumpTESR extends DCTorqueTESRBase {

	private static final DCTileModelBase MODEL = new ModelWaterPump();

	@Override
	protected String getTexPass(int i) {
		return "dcs_climate:textures/tiles/screw_pump.png";
	}
