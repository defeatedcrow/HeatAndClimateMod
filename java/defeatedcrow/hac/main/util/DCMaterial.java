...
public enum DCMaterial {
	...
	LINEN(0, "linen", 1.0F, new int[] {
			...
			SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0.0F), CLOTH(1, "cloth", 1.0F, new int[] {
			1,
			2,
			2,
	...
	COPPER(2, "copper", 2.0F, new int[] {
			...
			SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F), ZINC(3, "zinc", 2.0F, new int[] {
			1,
			2,
			2,
			1 }, 1, 128, 1.0F, 5, 0.5F, 0.5F, new ItemStack(MainInit.oreIngot, 1, 1),
			SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F), NICKEL(4, "nickel", 2.0F, new int[] {
			1,
			2,
			2,
