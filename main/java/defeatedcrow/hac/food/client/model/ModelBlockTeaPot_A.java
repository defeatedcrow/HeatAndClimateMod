...
public class ModelBlockTeaPot_A extends DCTileModelBase {
	...
	public ModelBlockTeaPot_A() {
		...
		shape8.setRotationPoint(0F, 8F, -4F);
	...
	public void render(float f) {
		setRotationAngles(f);
		render(null, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F * 0.75F);
	}
