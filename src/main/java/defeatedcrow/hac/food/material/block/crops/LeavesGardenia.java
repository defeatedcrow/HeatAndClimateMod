...
public class LeavesGardenia extends LeavesCropBlockDC {

	public LeavesGardenia() {
		super(CropType.RUBIA, CropTier.WILD, false);
		this.setSeason(EnumSeason.SPRING_LATE, EnumSeason.AUTUMN_LATE);
		this.cropSeasons.add(EnumSeason.WINTER_EARLY);
		this.cropSeasons.add(EnumSeason.WINTER_LATE);
	}
	...
	public String getRegistryName() {
		return "food/leaves_rubia_gardenia";
	}
	...
	public ItemLike getSeedItem(CropTier t) {
		return FoodInit.BLOCK_RU_GARDENIA.get();
	}

	@Override
	public Item getCropItem(CropTier t) {
		return FoodInit.CROP_RU_GARDENIA.get();
	}
	...
	public List<ItemStack> getCropItems(BlockState state, int fortune) {
		...
		if (stage == CropStage.FLOWER) {
			ItemStack ret = new ItemStack(FoodInit.FLOWER_GARDENIA.get());
