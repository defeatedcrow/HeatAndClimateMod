...
public class WagashiAbekawaRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/wagashi_abekawa.png");
	private static final ModelMochi MODEL = new ModelMochi(false);

	public WagashiAbekawaRenderer(RenderManager renderManager) {
		super(renderManager);
	}
