...
public class EntityDesktopAccessories_B extends DCEntityBase {

	public EntityDesktopAccessories_B(World worldIn) {
		super(worldIn);
	...
	public EntityDesktopAccessories_B(World worldIn, double posX, double posY, double posZ) {
		this(worldIn);
	...
	protected ItemStack drops() {
		return new ItemStack(MainInit.desktopAccessories, 1, 1);
	}
	...
	public boolean processInitialInteract(EntityPlayer player, EnumHand hand) {
		...
		if (MainUtil.isHeldItem(new ItemStack(MainInit.colorChanger), player)) {
			Entity change = new EntityDesktopAccessories_C(player.getEntityWorld());
