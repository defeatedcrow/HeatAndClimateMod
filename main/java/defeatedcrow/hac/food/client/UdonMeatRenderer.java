...
public class UdonMeatRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/udon_meat.png");
	private static final ModelUdon MODEL = new ModelUdon(false);

	public UdonMeatRenderer(RenderManager renderManager) {
		super(renderManager);
	}
