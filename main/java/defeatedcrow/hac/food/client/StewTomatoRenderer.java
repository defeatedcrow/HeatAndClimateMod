...
public class StewTomatoRenderer extends DCRenderFoodBase<FoodEntityBase> {
	...
	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/stew_congee_tomato.png");
	private static final ModelStewBowl MODEL = new ModelStewBowl(false);

	public StewTomatoRenderer(RenderManager renderManager) {
		super(renderManager);
	}
