...
public class PlatePotatoRenderer extends DCRenderFoodBase<PotatoPlateEntity> {
	...
	@Override
	public void doRender(PotatoPlateEntity entity, double x, double y, double z, float yaw, float partialTicks) {
