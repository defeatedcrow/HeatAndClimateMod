...
public class PlateGarlicModel<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition steak = partdefinition.addOrReplaceChild("steak", CubeListBuilder.create().texOffs(0, 32).mirror().addBox(-5.0F, -5.0F, -3.5F, 10.0F, 5.0F, 8.0F, new CubeDeformation(0.0F))
				.texOffs(0, 46).mirror().addBox(0.0F, -6.0F, 1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.0F, 0.0F, 0.0F, -0.0175F, 0.0F));

		PartDefinition butter = steak.addOrReplaceChild("butter", CubeListBuilder.create().texOffs(10, 46).mirror().addBox(-1.0F, -7.5F, -0.5F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose
				.offsetAndRotation(0.0F, 1.0F, 0.0F, 0.0F, 0.0873F, 0.0F));

		PartDefinition garlic3 = steak.addOrReplaceChild("garlic3", CubeListBuilder.create().texOffs(0, 46).mirror().addBox(0.0F, -7.0F, 1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose
				.offsetAndRotation(0.0F, 1.0F, 0.0F, 0.0F, -2.0944F, 0.0F));

		PartDefinition garlic1 = steak.addOrReplaceChild("garlic1", CubeListBuilder.create().texOffs(0, 46).mirror().addBox(-1.0F, -7.0F, 1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose
				.offsetAndRotation(0.0F, 1.0F, 0.0F, 0.0F, 2.0944F, 0.0F));
