...
public class DishMisoniEntity extends FoodEntityBase {

	public DishMisoniEntity(World worldIn) {
		super(worldIn);
	}

	public DishMisoniEntity(World worldIn, double posX, double posY, double posZ) {
		super(worldIn, posX, posY, posZ);
	}

	public DishMisoniEntity(World worldIn, double posX, double posY, double posZ, @Nullable EntityPlayer player) {
		super(worldIn, posX, posY, posZ, player);
	}

	@Override
	protected ItemStack[] drops() {
		return new ItemStack[] { new ItemStack(FoodInit.dishSq, 1, 5), new ItemStack(FoodInit.dishSq, 1, 5) };
	}
