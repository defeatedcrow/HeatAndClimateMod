...
import defeatedcrow.hac.food.client.model.ModelBreakfastJ2;
...
public class SetmealBreakfastJ2Renderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/setmeal_breakfast_j2.png");
	private static final ModelBreakfastJ2 MODEL = new ModelBreakfastJ2(false);

	public SetmealBreakfastJ2Renderer(RenderManager renderManager) {
		super(renderManager);
	}
