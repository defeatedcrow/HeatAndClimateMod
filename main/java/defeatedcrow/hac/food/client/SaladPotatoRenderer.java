...
public class SaladPotatoRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/salad_potato.png");
	private static final ModelSaladVegi MODEL = new ModelSaladVegi(false);

	public SaladPotatoRenderer(RenderManager renderManager) {
		super(renderManager);
	}
