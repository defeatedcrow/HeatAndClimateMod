...
public class FriedPorkRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/fried_pork.png");
	private static final ModelDeepFry MODEL = new ModelDeepFry(false);

	public FriedPorkRenderer(RenderManager renderManager) {
		super(renderManager);
	}
