...
public class ContainerHopperChest extends Container {

	public final TileHopperChest tile;
	public final InventoryPlayer playerInv;

	public ContainerHopperChest(TileHopperChest chest, EntityPlayer player) {
		this.tile = chest;
