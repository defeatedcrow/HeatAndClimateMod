...
public class BlockHerb extends ClimateCropBase implements ITexturePath {
	...
	public ItemStack getSeedItem(IBlockState thisState) {
		...
		return new ItemStack(FoodInit.seeds, i, 7);
	}

	@Override
	public List<ItemStack> getCropItems(IBlockState thisState, int fortune) {
		List<ItemStack> list = new ArrayList<ItemStack>();
		list.add(new ItemStack(FoodInit.crops, 1, 9));
		return list;
	}
