...
public class StewBorschtRenderer extends DCRenderFoodBase<FoodEntityBase> {
	...
	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/stew_borscht.png");
	private static final ModelStewBowl MODEL = new ModelStewBowl(false);

	public StewBorschtRenderer(RenderManager renderManager) {
		super(renderManager);
	}
