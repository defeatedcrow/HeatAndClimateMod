...
public class WagashiButterRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate", "textures/entity/food/wagashi_butter.png");
	private static final ModelMochi MODEL = new ModelMochi(false);

	public WagashiButterRenderer(RenderManager renderManager) {
		super(renderManager);
	}
