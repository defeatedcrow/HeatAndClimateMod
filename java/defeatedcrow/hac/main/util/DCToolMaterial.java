...
public class DCToolMaterial {
	...
	public static void load() {
		...
		DCToolMaterial.DC_NICKELSILVER = EnumHelper.addToolMaterial("dcs_" + DCMaterialEnum.NICKELSILVER.name,
				...
				DCMaterialEnum.NICKELSILVER.efficiency, DCMaterialEnum.NICKELSILVER.attackDam, DCMaterialEnum.NICKELSILVER.enchant);
		...
		DCToolMaterial.DC_CHALCEDONY = EnumHelper.addToolMaterial("dcs_" + DCMaterialEnum.CHALCEDONY.name,
				DCMaterialEnum.CHALCEDONY.harvestTier, DCMaterialEnum.CHALCEDONY.duration, DCMaterialEnum.CHALCEDONY.efficiency,
				DCMaterialEnum.CHALCEDONY.attackDam, DCMaterialEnum.CHALCEDONY.enchant);
		...
		DCToolMaterial.DC_SAPPHIRE = EnumHelper.addToolMaterial("dcs_" + DCMaterialEnum.SAPPHIRE.name,
				DCMaterialEnum.SAPPHIRE.harvestTier, DCMaterialEnum.SAPPHIRE.duration, DCMaterialEnum.SAPPHIRE.efficiency,
				DCMaterialEnum.SAPPHIRE.attackDam, DCMaterialEnum.SAPPHIRE.enchant);
		...
		DCToolMaterial.DC_TITANIUM = EnumHelper.addToolMaterial("dcs_" + DCMaterialEnum.TITANIUM.name,
				DCMaterialEnum.TITANIUM.harvestTier, DCMaterialEnum.TITANIUM.duration, DCMaterialEnum.TITANIUM.efficiency,
				DCMaterialEnum.TITANIUM.attackDam, DCMaterialEnum.TITANIUM.enchant);
