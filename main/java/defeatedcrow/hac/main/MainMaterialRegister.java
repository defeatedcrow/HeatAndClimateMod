...
public class MainMaterialRegister {
	...
	static void registerMain() {
		...
		DCMaterialReg.registerBlock(MainInit.metalBlock, ClimateCore.PACKAGE_BASE +
				"_ore_metalblock", ClimateMain.MOD_ID);

		MainInit.dustBlock = new BlockDusts(Material.GROUND, ClimateCore.PACKAGE_BASE + "_dustblock", 15);
		DCMaterialReg.registerBlock(MainInit.dustBlock, ClimateCore.PACKAGE_BASE +
				"_ore_dustblock", ClimateMain.MOD_ID);

		MainInit.dustBlock_2 = new BlockDusts2(Material.GROUND, ClimateCore.PACKAGE_BASE + "_dustblock2", 1);
		DCMaterialReg.registerBlock(MainInit.dustBlock_2, ClimateCore.PACKAGE_BASE +
				"_ore_dustblock2", ClimateMain.MOD_ID);
		...
		DCMaterialReg.registerBlock(MainInit.markingPanel, ClimateCore.PACKAGE_BASE +
				"_build_markingpanel", ClimateMain.MOD_ID);

		MainInit.lightOrb = new BlockLightOrb(ClimateCore.PACKAGE_BASE + "_build_lightorb");
		DCMaterialReg.registerBlock(MainInit.lightOrb, ClimateCore.PACKAGE_BASE +
				"_build_lightorb", ClimateMain.MOD_ID);
		...
		DCMaterialReg.registerBlock(MainInit.thermometer, ClimateCore.PACKAGE_BASE +
				"_device_thermometer", ClimateMain.MOD_ID);

		MainInit.windvane = new BlockWindVane(ClimateCore.PACKAGE_BASE + "_device_windvane");
		DCMaterialReg.registerBlock(MainInit.windvane, ClimateCore.PACKAGE_BASE +
				"_device_windvane", ClimateMain.MOD_ID);

		MainInit.stevenson_screen = new BlockStevensonScreen(ClimateCore.PACKAGE_BASE + "_device_stevenson_screen");
		DCMaterialReg.registerBlock(MainInit.stevenson_screen, ClimateCore.PACKAGE_BASE +
				"_device_stevenson_screen", ClimateMain.MOD_ID);
		...
		DCMaterialReg.registerItem(MainInit.crowDrill, ClimateCore.PACKAGE_BASE +
				"_creative_drill", ClimateMain.MOD_ID);
		...
		DCMaterialReg.registerItem(MainInit.entityScope, ClimateCore.PACKAGE_BASE +
				"_entity_scope", ClimateMain.MOD_ID);

		MainInit.foodMaterials = new ItemFoodMaterials(3).setUnlocalizedName(ClimateCore.PACKAGE_BASE +
				"_food_materials");
		DCMaterialReg.registerItem(MainInit.foodMaterials, ClimateCore.PACKAGE_BASE +
				"_food_materials", ClimateMain.MOD_ID);

		MainInit.bakedApple = new ItemDCFoods(6, false).setUnlocalizedName(ClimateCore.PACKAGE_BASE + "_food_itemfood");
		DCMaterialReg.registerItem(MainInit.bakedApple, ClimateCore.PACKAGE_BASE +
				"_food_itemfood", ClimateMain.MOD_ID);

		MainInit.wrench = new ItemWrench(
				DCToolMaterial.getToolMaterial(0)).setUnlocalizedName(ClimateCore.PACKAGE_BASE + "_wrench_brass");
	...
	static void registerModuleBuilding() {
		...
		DCMaterialReg.registerBlock(MainInit.clayBricks, ClimateCore.PACKAGE_BASE +
				"_build_claybrick", ClimateMain.MOD_ID);
		...
		DCMaterialReg.registerBlock(MainInit.selenite, ClimateCore.PACKAGE_BASE +
				"_build_selenite", ClimateMain.MOD_ID);

		MainInit.linoleum = new BlockLinoleum(Material.WOOD, ClimateCore.PACKAGE_BASE + "_build_linoleum");
		DCMaterialReg.registerBlock(MainInit.linoleum, ClimateCore.PACKAGE_BASE +
				"_build_linoleum", ClimateMain.MOD_ID);
		...
		ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.stairsDirtbrick), "dcs_climate", "dcs_stairs_dirtbrick", "build", 15, false);
		...
		ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.halfSlab), "dcs_climate", "dcs_build_slab", "build", 5, true);
		...
		DCMaterialReg.registerBlock(MainInit.fenceGypsum, ClimateCore.PACKAGE_BASE +
				"_fence_gypsum", ClimateMain.MOD_ID);
		ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.fenceGypsum), "dcs_climate", "dcs_fence_gypsum", "build", 15, false);

		MainInit.fenceMarble = new BlockFenceBase("dcs_fence_marble").setUnlocalizedName("dcs_fence_marble");
		DCMaterialReg.registerBlock(MainInit.fenceMarble, ClimateCore.PACKAGE_BASE +
				"_fence_marble", ClimateMain.MOD_ID);
		ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.fenceMarble), "dcs_climate", "dcs_fence_marble", "build", 15, false);

		MainInit.fenceSerpentine = new BlockFenceBase(
				"dcs_fence_serpentine").setUnlocalizedName("dcs_fence_serpentine");
		DCMaterialReg.registerBlock(MainInit.fenceSerpentine, ClimateCore.PACKAGE_BASE +
				"_fence_serpentine", ClimateMain.MOD_ID);
		ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.fenceSerpentine), "dcs_climate", "dcs_fence_serpentine", "build", 15, false);
		...
		DCMaterialReg.registerBlock(MainInit.chalLamp, ClimateCore.PACKAGE_BASE +
				"_build_challamp", ClimateMain.MOD_ID);

		MainInit.wallLamp = new BlockWallLamp(ClimateCore.PACKAGE_BASE + "_build_walllamp");
		DCMaterialReg.registerBlock(MainInit.wallLamp, ClimateCore.PACKAGE_BASE +
				"_build_walllamp", ClimateMain.MOD_ID);
		...
		if (ModuleConfig.build_advanced) {
			...
			DCMaterialReg.registerBlock(MainInit.pillarSteel, ClimateCore.PACKAGE_BASE +
					"_pillar_steel", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.pillarSteel), "dcs_climate", "dcs_pillar_steel", "build", 15, false);

			MainInit.fenceSteel = new BlockFenceBase("dcs_fence_steel").setUnlocalizedName("dcs_fence_steel");
			DCMaterialReg.registerBlock(MainInit.fenceSteel, ClimateCore.PACKAGE_BASE +
					"_fence_steel", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.fenceSteel), "dcs_climate", "dcs_fence_steel", "build", 15, false);

			MainInit.fenceNetSteel = new BlockMetalFenceBase("dcs_fence_net_steel",
					false).setUnlocalizedName("dcs_fence_net_steel");
			DCMaterialReg.registerBlock(MainInit.fenceNetSteel, ClimateCore.PACKAGE_BASE +
					"_fence_net_steel", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.fenceNetSteel), "dcs_climate", "dcs_fence_net_steel", "build", 3, false);

			MainInit.fenceLadderSteel = new BlockMetalLadder(
					"dcs_fence_ladder_steel").setUnlocalizedName("dcs_fence_ladder_steel");
			DCMaterialReg.registerBlock(MainInit.fenceLadderSteel, ClimateCore.PACKAGE_BASE +
					"_fence_ladder_steel", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.fenceLadderSteel), "dcs_climate", "dcs_fence_ladder_steel", "build", 3, false);

			MainInit.fenceAluminium = new BlockMetalFenceBase("dcs_fence_aluminium",
					false).setUnlocalizedName("dcs_fence_aluminium");
			DCMaterialReg.registerBlock(MainInit.fenceAluminium, ClimateCore.PACKAGE_BASE +
					"_fence_aluminium", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.fenceAluminium), "dcs_climate", "dcs_fence_aluminium", "build", 3, false);
			...
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.fenceNet), "dcs_climate", "dcs_fence_net", "build", 3, false);

			MainInit.fenceGlass = new BlockMetalFenceBase("dcs_fence_glass",
					true).setUnlocalizedName("dcs_fence_glass");
			DCMaterialReg.registerBlock(MainInit.fenceGlass, ClimateCore.PACKAGE_BASE +
					"_fence_glass", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.fenceGlass), "dcs_climate", "dcs_fence_glass", "build", 3, false);

			MainInit.fenceLadder = new BlockMetalLadder("dcs_fence_ladder").setUnlocalizedName("dcs_fence_ladder");
			DCMaterialReg.registerBlock(MainInit.fenceLadder, ClimateCore.PACKAGE_BASE +
					"_fence_ladder", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.fenceLadder), "dcs_climate", "dcs_fence_ladder", "build", 3, false);

			MainInit.awning = new BlockAwning("dcs_build_awning").setUnlocalizedName("dcs_build_awning");
			DCMaterialReg.registerBlock(MainInit.awning, ClimateCore.PACKAGE_BASE +
					"_build_awning", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.awning), "dcs_climate", "dcs_build_awning", "build", 3, false);

			MainInit.tableMarble = new BlockTableBase(ClimateCore.PACKAGE_BASE + "_table_marble", false);
			DCMaterialReg.registerBlock(MainInit.tableMarble, ClimateCore.PACKAGE_BASE +
					"_table_marble", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.tableMarble), "dcs_climate", "dcs_table_marble", "build", 0, false);

			MainInit.tableGypsum = new BlockTableBase(ClimateCore.PACKAGE_BASE + "_table_gypsum", false);
			DCMaterialReg.registerBlock(MainInit.tableGypsum, ClimateCore.PACKAGE_BASE +
					"_table_gypsum", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.tableGypsum), "dcs_climate", "dcs_table_gypsum", "build", 0, false);

			MainInit.tableWood = new BlockTableBase(ClimateCore.PACKAGE_BASE + "_table_wood", false);
			DCMaterialReg.registerBlock(MainInit.tableWood, ClimateCore.PACKAGE_BASE +
					"_table_wood", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.tableWood), "dcs_climate", "dcs_table_wood", "build", 0, false);

			MainInit.tableDark = new BlockTableBase(ClimateCore.PACKAGE_BASE + "_table_darkwood", false);
			DCMaterialReg.registerBlock(MainInit.tableDark, ClimateCore.PACKAGE_BASE +
					"_table_darkwood", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.tableDark), "dcs_climate", "dcs_table_darkwood", "build", 0, false);

			MainInit.squaretableWood = new BlockTableBase(ClimateCore.PACKAGE_BASE + "_squaretable_wood", false);
			DCMaterialReg.registerBlock(MainInit.squaretableWood, ClimateCore.PACKAGE_BASE +
					"_squaretable_wood", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.squaretableWood), "dcs_climate", "dcs_squaretable_wood", "build", 0, false);

			MainInit.squaretableMarble = new BlockTableBase(ClimateCore.PACKAGE_BASE + "_squaretable_marble", false);
			DCMaterialReg.registerBlock(MainInit.squaretableMarble, ClimateCore.PACKAGE_BASE +
					"_squaretable_marble", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.squaretableMarble), "dcs_climate", "dcs_squaretable_marble", "build", 0, false);

			MainInit.squaretableChecker = new BlockTableBase(ClimateCore.PACKAGE_BASE + "_squaretable_checker", false);
			DCMaterialReg.registerBlock(MainInit.squaretableChecker, ClimateCore.PACKAGE_BASE +
					"_squaretable_checker", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.squaretableChecker), "dcs_climate", "dcs_squaretable_checker", "build", 0, false);

			MainInit.squaretableBlack = new BlockTableBase(ClimateCore.PACKAGE_BASE + "_squaretable_black", false);
			DCMaterialReg.registerBlock(MainInit.squaretableBlack, ClimateCore.PACKAGE_BASE +
					"_squaretable_black", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.squaretableBlack), "dcs_climate", "dcs_squaretable_black", "build", 0, false);

			MainInit.carpetRed = new BlockTableBase(ClimateCore.PACKAGE_BASE + "_carpet_red", true);
			DCMaterialReg.registerBlock(MainInit.carpetRed, ClimateCore.PACKAGE_BASE +
					"_carpet_red", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.carpetRed), "dcs_climate", "dcs_carpet_red", "build", 0, false);

			MainInit.carpetWhite = new BlockTableBase(ClimateCore.PACKAGE_BASE + "_carpet_white", true);
			DCMaterialReg.registerBlock(MainInit.carpetWhite, ClimateCore.PACKAGE_BASE +
					"_carpet_white", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.carpetWhite), "dcs_climate", "dcs_carpet_white", "build", 0, false);

			MainInit.carpetGray = new BlockTableBase(ClimateCore.PACKAGE_BASE + "_carpet_gray", true);
			DCMaterialReg.registerBlock(MainInit.carpetGray, ClimateCore.PACKAGE_BASE +
					"_carpet_gray", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.carpetGray), "dcs_climate", "dcs_carpet_gray", "build", 0, false);

			MainInit.sofaBlack = new BlockSofaBase(ClimateCore.PACKAGE_BASE + "_sofa_black");
			DCMaterialReg.registerBlock(MainInit.sofaBlack, ClimateCore.PACKAGE_BASE +
					"_sofa_black", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.sofaBlack), "dcs_climate", "dcs_sofa_black", "build", 0, false);
			...
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.sofaRed), "dcs_climate", "dcs_sofa_red", "build", 0, false);

			MainInit.stoolBlack = new BlockSofaBase(ClimateCore.PACKAGE_BASE + "_stool_black").setSmallAABB();
			DCMaterialReg.registerBlock(MainInit.stoolBlack, ClimateCore.PACKAGE_BASE +
					"_stool_black", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.stoolBlack), "dcs_climate", "dcs_stool_black", "build", 0, false);
			...
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.stoolRed), "dcs_climate", "dcs_stool_red", "build", 0, false);

			MainInit.chairWood = new BlockSofaBase(ClimateCore.PACKAGE_BASE + "_chair_wood").setSmallAABB();
			DCMaterialReg.registerBlock(MainInit.chairWood, ClimateCore.PACKAGE_BASE +
					"_chair_wood", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.chairWood), "dcs_climate", "dcs_chair_wood", "build", 0, false);

			MainInit.chairMarble = new BlockSofaBase(ClimateCore.PACKAGE_BASE + "_chair_marble").setSmallAABB();
			DCMaterialReg.registerBlock(MainInit.chairMarble, ClimateCore.PACKAGE_BASE +
					"_chair_marble", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.chairMarble), "dcs_climate", "dcs_chair_marble", "build", 0, false);

			MainInit.chairChecker = new BlockSofaBase(ClimateCore.PACKAGE_BASE + "_chair_checker").setSmallAABB();
			DCMaterialReg.registerBlock(MainInit.chairChecker, ClimateCore.PACKAGE_BASE +
					"_chair_checker", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.chairChecker), "dcs_climate", "dcs_chair_checker", "build", 0, false);

			MainInit.chairBlack = new BlockSofaBase(ClimateCore.PACKAGE_BASE + "_chair_black").setSmallAABB();
			DCMaterialReg.registerBlock(MainInit.chairBlack, ClimateCore.PACKAGE_BASE +
					"_chair_black", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.chairBlack), "dcs_climate", "dcs_chair_black", "build", 0, false);
			...
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.plate), "dcs_climate", "dcs_build_plate", "build", 1, false);

			MainInit.lampCarbide = new BlockCarbideLamp(ClimateCore.PACKAGE_BASE + "_lamp_carbide_lantern");
			DCMaterialReg.registerBlock(MainInit.lampCarbide, ClimateCore.PACKAGE_BASE +
					"_lamp_carbide_lantern", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.lampCarbide), "dcs_climate", "dcs_lamp_carbide_lantern", "build", 0, false);

			MainInit.lampGas = new BlockCarbideLamp(ClimateCore.PACKAGE_BASE + "_lamp_carbide_glass");
			DCMaterialReg.registerBlock(MainInit.lampGas, ClimateCore.PACKAGE_BASE +
					"_lamp_carbide_glass", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.lampGas), "dcs_climate", "dcs_lamp_carbide_glass", "build", 0, false);

			MainInit.chestMarble = new BlockLowChest(Material.WOOD, ClimateCore.PACKAGE_BASE +
					"_device_lowchest_marble", true);
			registerChestBlock(MainInit.chestMarble, ClimateCore.PACKAGE_BASE +
					"_device_lowchest_marble", ClimateMain.MOD_ID);
			...
			MainInit.chestWood = new BlockLowChest(Material.WOOD, ClimateCore.PACKAGE_BASE + "_device_lowchest_wood",
					true);
			registerChestBlock(MainInit.chestWood, ClimateCore.PACKAGE_BASE +
					"_device_lowchest_wood", ClimateMain.MOD_ID);
			ClimateMain.proxy.regTEJson(MainInit.chestWood, "dcs_climate", "dcs_device_lowchest_wood", "device");

			MainInit.chestChecker = new BlockLowChest(Material.WOOD, ClimateCore.PACKAGE_BASE +
					"_device_lowchest_checker", true);
			registerChestBlock(MainInit.chestChecker, ClimateCore.PACKAGE_BASE +
					"_device_lowchest_checker", ClimateMain.MOD_ID);
			...
			MainInit.chestBlack = new BlockLowChest(Material.WOOD, ClimateCore.PACKAGE_BASE + "_device_lowchest_black",
					true);
			registerChestBlock(MainInit.chestBlack, ClimateCore.PACKAGE_BASE +
					"_device_lowchest_black", ClimateMain.MOD_ID);
			...
			MainInit.wallshelfMarble = new BlockWallShelf(Material.WOOD, ClimateCore.PACKAGE_BASE + "_wallshelf_marble",
					true);
			registerChestBlock(MainInit.wallshelfMarble, ClimateCore.PACKAGE_BASE +
					"_wallshelf_marble", ClimateMain.MOD_ID);
			...
			MainInit.wallshelfWood = new BlockWallShelf(Material.WOOD, ClimateCore.PACKAGE_BASE + "_wallshelf_wood",
					true);
			registerChestBlock(MainInit.wallshelfWood, ClimateCore.PACKAGE_BASE +
					"_wallshelf_wood", ClimateMain.MOD_ID);
			ClimateMain.proxy.regTEJson(MainInit.wallshelfWood, "dcs_climate", "dcs_wallshelf_wood", "device");

			MainInit.wallshelfChecker = new BlockWallShelf(Material.WOOD, ClimateCore.PACKAGE_BASE +
					"_wallshelf_checker", true);
			registerChestBlock(MainInit.wallshelfChecker, ClimateCore.PACKAGE_BASE +
					"_wallshelf_checker", ClimateMain.MOD_ID);
			...
			MainInit.wallshelfBlack = new BlockWallShelf(Material.WOOD, ClimateCore.PACKAGE_BASE + "_wallshelf_black",
					true);
			registerChestBlock(MainInit.wallshelfBlack, ClimateCore.PACKAGE_BASE +
					"_wallshelf_black", ClimateMain.MOD_ID);
			...
			DCMaterialReg.registerBlock(MainInit.sinkMetal, ClimateCore.PACKAGE_BASE +
					"_device_sink_half", ClimateMain.MOD_ID);
			...
			DCMaterialReg.registerBlock(MainInit.sinkChest, ClimateCore.PACKAGE_BASE +
					"_device_sink_full", ClimateMain.MOD_ID);
			...
			DCMaterialReg.registerBlock(MainInit.hedgeSpring, ClimateCore.PACKAGE_BASE +
					"_hedge_spring", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.hedgeSpring), "dcs_climate", "dcs_hedge_spring", "crop", 15, false);

			MainInit.hedgeSummer = new BlockHedge("dcs_hedge_summer").setUnlocalizedName("dcs_hedge_summer");
			DCMaterialReg.registerBlock(MainInit.hedgeSummer, ClimateCore.PACKAGE_BASE +
					"_hedge_summer", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.hedgeSummer), "dcs_climate", "dcs_hedge_summer", "crop", 15, false);

			MainInit.hedgeAutumn = new BlockHedge("dcs_hedge_autumn").setUnlocalizedName("dcs_hedge_autumn");
			DCMaterialReg.registerBlock(MainInit.hedgeAutumn, ClimateCore.PACKAGE_BASE +
					"_hedge_autumn", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.hedgeAutumn), "dcs_climate", "dcs_hedge_autumn", "crop", 15, false);

			MainInit.hedgeWinter = new BlockHedge("dcs_hedge_winter").setUnlocalizedName("dcs_hedge_winter");
			DCMaterialReg.registerBlock(MainInit.hedgeWinter, ClimateCore.PACKAGE_BASE +
					"_hedge_winter", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.hedgeWinter), "dcs_climate", "dcs_hedge_winter", "crop", 15, false);

			MainInit.chandelierGypsum = new BlockChandelier(
					"dcs_build_chandelier").setUnlocalizedName("dcs_build_chandelier");
			DCMaterialReg.registerBlock(MainInit.chandelierGypsum, ClimateCore.PACKAGE_BASE +
					"_build_chandelier", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.chandelierGypsum), "dcs_climate", "dcs_build_chandelier", "build", 0, false);

			MainInit.doorMarble = new BlockDoorDC(ClimateCore.PACKAGE_BASE + "_door_marble", Material.ROCK);
			DCMaterialReg.registerBlock(MainInit.doorMarble, ClimateCore.PACKAGE_BASE +
					"_door_marble", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.doorMarble), "dcs_climate", "dcs_door_marble", "build", 0, true);
			...
			DCMaterialReg.registerBlock(MainInit.doorSteel, ClimateCore.PACKAGE_BASE +
					"_door_steel", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.doorSteel), "dcs_climate", "dcs_door_steel", "build", 0, true);
			...
			DCMaterialReg.registerBlock(MainInit.realtimeClock, ClimateCore.PACKAGE_BASE +
					"_device_realtimeclock", ClimateMain.MOD_ID);

			MainInit.realtimeClock_L = new BlockRealtimeClock_L(Material.GROUND, ClimateCore.PACKAGE_BASE +
					"_device_realtimeclock_l");
			DCMaterialReg.registerBlock(MainInit.realtimeClock_L, ClimateCore.PACKAGE_BASE +
					"_device_realtimeclock_l", ClimateMain.MOD_ID);

			MainInit.mcClock_L = new BlockMCClock_L(Material.GROUND, ClimateCore.PACKAGE_BASE + "_device_mcclock_l");
			DCMaterialReg.registerBlock(MainInit.mcClock_L, ClimateCore.PACKAGE_BASE +
					"_device_mcclock_l", ClimateMain.MOD_ID);

			MainInit.curtainWhite = new BlockCurtain("dcs_build_curtain").setUnlocalizedName("dcs_build_curtain");
			DCMaterialReg.registerBlock(MainInit.curtainWhite, ClimateCore.PACKAGE_BASE +
					"_build_curtain", ClimateMain.MOD_ID);
			ClimateMain.proxy.regBlockJson(Item.getItemFromBlock(MainInit.curtainWhite), "dcs_climate", "dcs_build_curtain", "build", 0, true);

			MainInit.chestMetal = new BlockMetalChest(Material.IRON, ClimateCore.PACKAGE_BASE + "_device_chest_metal");
			registerChestBlock(MainInit.chestMetal, ClimateCore.PACKAGE_BASE +
					"_device_chest_metal", ClimateMain.MOD_ID);

			MainInit.chestMagnet = new BlockMagnetChest(Material.IRON, ClimateCore.PACKAGE_BASE +
					"_device_chest_magnet");
			registerChestBlock(MainInit.chestMagnet, ClimateCore.PACKAGE_BASE +
					"_device_chest_magnet", ClimateMain.MOD_ID);

			MainInit.chestVillage = new BlockVillageChest(Material.IRON, ClimateCore.PACKAGE_BASE +
					"_device_chest_village");
			registerChestBlock(MainInit.chestVillage, ClimateCore.PACKAGE_BASE +
					"_device_chest_village", ClimateMain.MOD_ID);

			MainInit.achievementShield = new BlockAcvShield(Material.GROUND, "dcs_build_shield",
					2).setUnlocalizedName("dcs_build_shield");
			...
			DCMaterialReg.registerItem(MainInit.cushionGray, ClimateCore.PACKAGE_BASE +
					"_big_cushion", ClimateMain.MOD_ID);
	...
	static void registerModuleEquip() {
		if (ModuleConfig.tool) {
			...
			for (int j = 0; j < 8; j++) {
				...
				MainInit.dcAxe[j] = new ItemAxeDC(DCToolMaterial.getToolMaterial(j),
						name[j]).setCreativeTab(ClimateMain.tool).setUnlocalizedName(ClimateCore.PACKAGE_BASE +
								"_axe_" + name[j]);
				DCMaterialReg.registerItem(MainInit.dcAxe[j], ClimateCore.PACKAGE_BASE + "_axe_" +
						name[j], ClimateMain.MOD_ID);
			}

			for (int j = 0; j < 8; j++) {
				MainInit.dcPickaxe[j] = new ItemPickaxeDC(DCToolMaterial.getToolMaterial(j),
						name[j]).setCreativeTab(ClimateMain.tool).setUnlocalizedName(ClimateCore.PACKAGE_BASE +
								"_pickaxe_" + name[j]);
				DCMaterialReg.registerItem(MainInit.dcPickaxe[j], ClimateCore.PACKAGE_BASE + "_pickaxe_" +
						name[j], ClimateMain.MOD_ID);
			}

			for (int j = 0; j < 8; j++) {
				MainInit.dcSpade[j] = new ItemSpadeDC(DCToolMaterial.getToolMaterial(j),
						name[j]).setCreativeTab(ClimateMain.tool).setUnlocalizedName(ClimateCore.PACKAGE_BASE +
								"_spade_" + name[j]);
				DCMaterialReg.registerItem(MainInit.dcSpade[j], ClimateCore.PACKAGE_BASE + "_spade_" +
						name[j], ClimateMain.MOD_ID);
			}

			for (int j = 0; j < 4; j++) {
				MainInit.dcSword[j] = new ItemSwordDC(DCToolMaterial.getToolMaterial(j), name[j],
						false).setCreativeTab(ClimateMain.tool).setUnlocalizedName(ClimateCore.PACKAGE_BASE +
								"_sword_" + name[j]);
				DCMaterialReg.registerItem(MainInit.dcSword[j], ClimateCore.PACKAGE_BASE + "_sword_" +
						name[j], ClimateMain.MOD_ID);
			}
			for (int j = 4; j < 6; j++) {
				MainInit.dcSword[j] = new ItemSwordDC(DCToolMaterial.getToolMaterial(j), name[j],
						true).setCreativeTab(ClimateMain.tool).setUnlocalizedName(ClimateCore.PACKAGE_BASE + "_sword_" +
								name[j]);
				DCMaterialReg.registerItem(MainInit.dcSword[j], ClimateCore.PACKAGE_BASE + "_sword_" +
						name[j], ClimateMain.MOD_ID);
			}

			MainInit.dcSword[6] = new ItemSwordDC(DCToolMaterial.getToolMaterial(6), name[6],
					false).setCreativeTab(ClimateMain.tool).setUnlocalizedName(ClimateCore.PACKAGE_BASE + "_sword_" +
							name[6]);
			DCMaterialReg.registerItem(MainInit.dcSword[6], ClimateCore.PACKAGE_BASE + "_sword_" +
					name[6], ClimateMain.MOD_ID);

			MainInit.dcSword[7] = new ItemSwordDC(DCToolMaterial.getToolMaterial(7), name[7],
					true).setCreativeTab(ClimateMain.tool).setUnlocalizedName(ClimateCore.PACKAGE_BASE + "_sword_" +
							name[7]);
			DCMaterialReg.registerItem(MainInit.dcSword[7], ClimateCore.PACKAGE_BASE + "_sword_" +
					name[7], ClimateMain.MOD_ID);

			MainInit.dcScythe[0] = new ItemScytheDC(DCToolMaterial.getToolMaterial(0),
					"brass").setCreativeTab(ClimateMain.tool).setUnlocalizedName(ClimateCore.PACKAGE_BASE +
							"_scythe_brass");
			DCMaterialReg.registerItem(MainInit.dcScythe[0], ClimateCore.PACKAGE_BASE +
					"_scythe_brass", ClimateMain.MOD_ID);

			MainInit.dcScythe[1] = new ItemScytheDC(DCToolMaterial.getToolMaterial(1),
					"steel").setCreativeTab(ClimateMain.tool).setUnlocalizedName(ClimateCore.PACKAGE_BASE +
							"_scythe_steel");
			DCMaterialReg.registerItem(MainInit.dcScythe[1], ClimateCore.PACKAGE_BASE +
					"_scythe_steel", ClimateMain.MOD_ID);

			MainInit.dcScythe[2] = new ItemScytheDC(DCToolMaterial.getToolMaterial(4),
					"chalcedony").setCreativeTab(ClimateMain.tool).setUnlocalizedName(ClimateCore.PACKAGE_BASE +
							"_scythe_chalcedony");
			DCMaterialReg.registerItem(MainInit.dcScythe[2], ClimateCore.PACKAGE_BASE +
					"_scythe_chalcedony", ClimateMain.MOD_ID);

			MainInit.dcScythe[3] = new ItemScytheDC(DCToolMaterial.getToolMaterial(7),
					"garnet").setCreativeTab(ClimateMain.tool).setUnlocalizedName(ClimateCore.PACKAGE_BASE +
							"_scythe_garnet");
			DCMaterialReg.registerItem(MainInit.dcScythe[3], ClimateCore.PACKAGE_BASE +
					"_scythe_garnet", ClimateMain.MOD_ID);

			MainInit.earthSpade = new ItemSpadeEarth().setCreativeTab(ClimateMain.tool).setUnlocalizedName(ClimateCore.PACKAGE_BASE +
					"_spade_earth");
			DCMaterialReg.registerItem(MainInit.earthSpade, ClimateCore.PACKAGE_BASE +
					"_spade_earth", ClimateMain.MOD_ID);

			MainInit.earthRake = new ItemRakeEarth().setCreativeTab(ClimateMain.tool).setUnlocalizedName(ClimateCore.PACKAGE_BASE +
					"_rake_earth");
			DCMaterialReg.registerItem(MainInit.earthRake, ClimateCore.PACKAGE_BASE +
					"_rake_earth", ClimateMain.MOD_ID);
			...
			for (int i = 0; i < 4; i++) {
				...
				MainInit.brassArmor[i] = new ItemArmorDC(DCArmorMaterial.DC_BRASS, DCMaterialEnum.BRASS, slot,
						"brass").setCreativeTab(ClimateMain.cloth).setUnlocalizedName(ClimateCore.PACKAGE_BASE + "_" +
								type[i] + "_brass");
				DCMaterialReg.registerItem(MainInit.brassArmor[i], ClimateCore.PACKAGE_BASE + "_" + type[i] +
						"_brass", ClimateMain.MOD_ID);
				...
				MainInit.steelArmor[i] = new ItemArmorDC(DCArmorMaterial.DC_STEEL, DCMaterialEnum.STEEL, slot,
						"steel").setCreativeTab(ClimateMain.cloth).setUnlocalizedName(ClimateCore.PACKAGE_BASE + "_" +
								type[i] + "_steel");
				DCMaterialReg.registerItem(MainInit.steelArmor[i], ClimateCore.PACKAGE_BASE + "_" + type[i] +
						"_steel", ClimateMain.MOD_ID);

				MainInit.chalcArmor[i] = new ItemArmorDC(DCArmorMaterial.DC_CHALCEDONY, DCMaterialEnum.CHALCEDONY, slot,
						"chalcedony").setCreativeTab(ClimateMain.cloth).setUnlocalizedName(ClimateCore.PACKAGE_BASE +
								"_" + type[i] + "_chalcedony");
				DCMaterialReg.registerItem(MainInit.chalcArmor[i], ClimateCore.PACKAGE_BASE + "_" + type[i] +
						"_chalcedony", ClimateMain.MOD_ID);

				MainInit.sapphireArmor[i] = new ItemArmorDC(DCArmorMaterial.DC_SAPPHIRE, DCMaterialEnum.SAPPHIRE, slot,
						"sapphire").setCreativeTab(ClimateMain.cloth).setUnlocalizedName(ClimateCore.PACKAGE_BASE +
								"_" + type[i] + "_sapphire");
				...
				MainInit.titaniumArmor[i] = new ItemArmorDC(DCArmorMaterial.DC_TITANIUM, DCMaterialEnum.TITANIUM, slot,
						"titanium").setCreativeTab(ClimateMain.cloth).setUnlocalizedName(ClimateCore.PACKAGE_BASE +
								"_" + type[i] + "_titanium");
		...
		MainInit.linenUnder = new ItemArmorThinDC(DCArmorMaterial.DC_LINEN, DCMaterialEnum.LINEN,
				...
				"linen").setCreativeTab(ClimateMain.cloth).setUnlocalizedName(ClimateCore.PACKAGE_BASE +
						"_leggins_linen");
		DCMaterialReg.registerItem(MainInit.linenUnder, ClimateCore.PACKAGE_BASE +
				"_leggins_linen", ClimateMain.MOD_ID);

		MainInit.linenCoat = new ItemArmorThinDC(DCArmorMaterial.DC_LINEN, DCMaterialEnum.LINEN,
				EntityEquipmentSlot.CHEST,
				"linen").setCreativeTab(ClimateMain.cloth).setUnlocalizedName(ClimateCore.PACKAGE_BASE + "_coat_linen");
		...
		MainInit.clothUnder = new ItemArmorThinDC(DCArmorMaterial.DC_CLOTH, DCMaterialEnum.CLOTH,
				EntityEquipmentSlot.LEGS,
				"cloth").setCreativeTab(ClimateMain.cloth).setUnlocalizedName(ClimateCore.PACKAGE_BASE +
						"_leggins_cloth");
		DCMaterialReg.registerItem(MainInit.clothUnder, ClimateCore.PACKAGE_BASE +
				"_leggins_cloth", ClimateMain.MOD_ID);

		MainInit.clothCoat = new ItemArmorOvercoat(DCArmorMaterial.DC_CLOTH, DCMaterialEnum.CLOTH,
				EntityEquipmentSlot.CHEST,
				"trench").setCreativeTab(ClimateMain.cloth).setUnlocalizedName(ClimateCore.PACKAGE_BASE +
						"_coat_trench");
		...
		MainInit.workerSuit = new ItemArmorThinDC(DCArmorMaterial.DC_CLOTH, DCMaterialEnum.CLOTH,
				EntityEquipmentSlot.LEGS,
				"worker").setCreativeTab(ClimateMain.cloth).setUnlocalizedName(ClimateCore.PACKAGE_BASE +
						"_leggins_worker");
		DCMaterialReg.registerItem(MainInit.workerSuit, ClimateCore.PACKAGE_BASE +
				"_leggins_worker", ClimateMain.MOD_ID);

		MainInit.blackSuit = new ItemArmorThinDC(DCArmorMaterial.DC_CLOTH, DCMaterialEnum.CLOTH,
				EntityEquipmentSlot.LEGS,
				"suit").setCreativeTab(ClimateMain.cloth).setUnlocalizedName(ClimateCore.PACKAGE_BASE +
						"_leggins_suit");
		...
		MainInit.blackCoat = new ItemArmorOvercoat(DCArmorMaterial.DC_SYNTHETIC, DCMaterialEnum.SYNTHETIC,
				EntityEquipmentSlot.CHEST,
				"black").setShort().setCreativeTab(ClimateMain.cloth).setUnlocalizedName(ClimateCore.PACKAGE_BASE +
						"_coat_black");
		...
		MainInit.trackSuit = new ItemArmorThinDC(DCArmorMaterial.DC_SYNTHETIC, DCMaterialEnum.SYNTHETIC,
				EntityEquipmentSlot.LEGS,
				"tracksuit").setCreativeTab(ClimateMain.cloth).setUnlocalizedName(ClimateCore.PACKAGE_BASE +
						"_leggins_track");
		...
		MainInit.combatDress = new ItemArmorThinDC(DCArmorMaterial.DC_SYNTHETIC, DCMaterialEnum.SYNTHETIC,
				EntityEquipmentSlot.LEGS,
				"combatdress").setCreativeTab(ClimateMain.cloth).setUnlocalizedName(ClimateCore.PACKAGE_BASE +
						"_leggins_combatdress");
		DCMaterialReg.registerItem(MainInit.combatDress, ClimateCore.PACKAGE_BASE +
				"_leggins_combatdress", ClimateMain.MOD_ID);
		...
		MainInit.hoodieB = new ItemArmorHoodie(DCArmorMaterial.DC_CLOTH, DCMaterialEnum.CLOTH,
				EntityEquipmentSlot.CHEST,
				"black").setCreativeTab(ClimateMain.cloth).setUnlocalizedName(ClimateCore.PACKAGE_BASE +
						"_hoodie_black");
		...
		MainInit.magicUnder = new ItemArmorThinDC(DCArmorMaterial.DC_SYNTHETIC, DCMaterialEnum.SYNTHETIC,
				EntityEquipmentSlot.LEGS,
				"magic").setCreativeTab(ClimateMain.cloth).setUnlocalizedName(ClimateCore.PACKAGE_BASE +
						"_leggins_magic");
		DCMaterialReg.registerItem(MainInit.magicUnder, ClimateCore.PACKAGE_BASE +
				"_leggins_magic", ClimateMain.MOD_ID);

		MainInit.magicCoat = new ItemArmorOvercoat(DCArmorMaterial.DC_SYNTHETIC, DCMaterialEnum.SYNTHETIC,
				EntityEquipmentSlot.CHEST,
				"magic").setCreativeTab(ClimateMain.cloth).setUnlocalizedName(ClimateCore.PACKAGE_BASE + "_coat_magic");
	...
	static void registerModuleContainer() {
		...
		DCMaterialReg.registerBlock(MainInit.cardboard, ClimateCore.PACKAGE_BASE +
	...
	public static void registerFluids() {
		...
		MainInit.oilBlock = new DCFluidBlockBase(MainInit.oil,
				"seedoil_still").setUnlocalizedName(ClimateCore.PACKAGE_BASE + "_fluidblock_oil");
		DCMaterialReg.registerBlock(MainInit.oilBlock, ClimateCore.PACKAGE_BASE +
				"_fluidblock_oil", ClimateMain.MOD_ID);
		...
		MainInit.greenTeaBlock = new DCFluidBlockBase(MainInit.greenTea,
				"greentea_still").setUnlocalizedName(ClimateCore.PACKAGE_BASE + "_fluidblock_greentea");
		DCMaterialReg.registerBlock(MainInit.greenTeaBlock, ClimateCore.PACKAGE_BASE +
				"_fluidblock_greentea", ClimateMain.MOD_ID);
		...
		MainInit.blackTeaBlock = new DCFluidBlockBase(MainInit.blackTea,
				"blacktea_still").setUnlocalizedName(ClimateCore.PACKAGE_BASE + "_fluidblock_blacktea");
		DCMaterialReg.registerBlock(MainInit.blackTeaBlock, ClimateCore.PACKAGE_BASE +
				"_fluidblock_blacktea", ClimateMain.MOD_ID);
		...
		MainInit.coffeeBlock = new DCFluidBlockBase(MainInit.coffee,
				"coffee_still").setUnlocalizedName(ClimateCore.PACKAGE_BASE + "_fluidblock_coffee");
		DCMaterialReg.registerBlock(MainInit.coffeeBlock, ClimateCore.PACKAGE_BASE +
				"_fluidblock_coffee", ClimateMain.MOD_ID);
		...
		MainInit.creamBlock = new DCFluidBlockBase(MainInit.cream,
				"cream_still").setUnlocalizedName(ClimateCore.PACKAGE_BASE + "_fluidblock_cream");
		DCMaterialReg.registerBlock(MainInit.creamBlock, ClimateCore.PACKAGE_BASE +
				"_fluidblock_cream", ClimateMain.MOD_ID);
		...
		MainInit.tomatoBlock = new DCFluidBlockBase(MainInit.tomatoJuice,
				"vegetable_still").setUnlocalizedName(ClimateCore.PACKAGE_BASE + "_fluidblock_vegetable");
		DCMaterialReg.registerBlock(MainInit.tomatoBlock, ClimateCore.PACKAGE_BASE +
				"_fluidblock_vegetable", ClimateMain.MOD_ID);
		...
		MainInit.stockBlock = new DCFluidBlockBase(MainInit.stock,
				"stock_still").setUnlocalizedName(ClimateCore.PACKAGE_BASE + "_fluidblock_stock");
		DCMaterialReg.registerBlock(MainInit.stockBlock, ClimateCore.PACKAGE_BASE +
				"_fluidblock_stock", ClimateMain.MOD_ID);
		...
		MainInit.lemonBlock = new DCFluidBlockBase(MainInit.lemon,
				"lemon_still").setUnlocalizedName(ClimateCore.PACKAGE_BASE + "_fluidblock_lemonade");
		DCMaterialReg.registerBlock(MainInit.lemonBlock, ClimateCore.PACKAGE_BASE +
				"_fluidblock_lemonade", ClimateMain.MOD_ID);
		...
		MainInit.blackLiquorBlock = new DCFluidBlockBase(MainInit.blackLiquor,
				"black_liquor_still").setUnlocalizedName(ClimateCore.PACKAGE_BASE + "_fluidblock_black_liquor");
		DCMaterialReg.registerBlock(MainInit.blackLiquorBlock, ClimateCore.PACKAGE_BASE +
				"_fluidblock_black_liquor", ClimateMain.MOD_ID);
		...
		MainInit.hotSpringBlock = new DCFluidBlockBase(MainInit.hotSpring,
				"hotspring_still").setUnlocalizedName(ClimateCore.PACKAGE_BASE + "_fluidblock_hotspring");
		DCMaterialReg.registerBlock(MainInit.hotSpringBlock, ClimateCore.PACKAGE_BASE +
				"_fluidblock_hotspring", ClimateMain.MOD_ID);
		...
		}.setUnlocalizedName(ClimateCore.PACKAGE_BASE +
				".mazai").setLuminosity(15).setViscosity(1200).setDensity(1200).setTemperature(270);
		FluidRegistry.registerFluid(MainInit.mazai);
		MainInit.mazaiBlock = new DCFluidBlockBase(MainInit.mazai,
				"mazai_still").setUnlocalizedName(ClimateCore.PACKAGE_BASE + "_fluidblock_mazai");
		DCMaterialReg.registerBlock(MainInit.mazaiBlock, ClimateCore.PACKAGE_BASE +
				"_fluidblock_mazai", ClimateMain.MOD_ID);
		...
		MainInit.soyMilkBlock = new DCFluidBlockBase(MainInit.soyMilk,
				"soy_milk_still").setUnlocalizedName(ClimateCore.PACKAGE_BASE + "_fluidblock_soy_milk");
		DCMaterialReg.registerBlock(MainInit.soyMilkBlock, ClimateCore.PACKAGE_BASE +
				"_fluidblock_soy_milk", ClimateMain.MOD_ID);
		...
		MainInit.hydrogenBlock = new DCFluidBlockBase(MainInit.hydrogen,
				"hydrogen_still").setUnlocalizedName(ClimateCore.PACKAGE_BASE + "_fluidblock_hydrogen");
		DCMaterialReg.registerBlock(MainInit.hydrogenBlock, ClimateCore.PACKAGE_BASE +
				"_fluidblock_hydrogen", ClimateMain.MOD_ID);
		...
		MainInit.ammoniaBlock = new DCFluidBlockBase(MainInit.ammonia,
				"ammonia_still").setUnlocalizedName(ClimateCore.PACKAGE_BASE + "_fluidblock_ammonia");
		DCMaterialReg.registerBlock(MainInit.ammoniaBlock, ClimateCore.PACKAGE_BASE +
				"_fluidblock_ammonia", ClimateMain.MOD_ID);
		...
		MainInit.nitricAcidBlock = new DCFluidBlockBase(MainInit.nitricAcid,
				"nitric_acid_still").setUnlocalizedName(ClimateCore.PACKAGE_BASE + "_fluidblock_nitric_acid");
		DCMaterialReg.registerBlock(MainInit.nitricAcidBlock, ClimateCore.PACKAGE_BASE +
				"_fluidblock_nitric_acid", ClimateMain.MOD_ID);
		...
		MainInit.sulfuricAcidBlock = new DCFluidBlockBase(MainInit.sulfuricAcid,
				"sulfuric_acid_still").setUnlocalizedName(ClimateCore.PACKAGE_BASE + "_fluidblock_sulfuric_acid");
		DCMaterialReg.registerBlock(MainInit.sulfuricAcidBlock, ClimateCore.PACKAGE_BASE +
		...
		MainInit.fuelGasBlock = new DCFluidBlockBase(MainInit.fuelGas,
				"fuel_gas_still").setUnlocalizedName(ClimateCore.PACKAGE_BASE + "_fluidblock_fuel_gas");
		DCMaterialReg.registerBlock(MainInit.fuelGasBlock, ClimateCore.PACKAGE_BASE +
				"_fluidblock_fuel_gas", ClimateMain.MOD_ID);
		...
		MainInit.fuelOilBlock = new DCFluidBlockBase(MainInit.fuelOil,
				"fuel_oil_still").setUnlocalizedName(ClimateCore.PACKAGE_BASE + "_fluidblock_fuel_oil");
		DCMaterialReg.registerBlock(MainInit.fuelOilBlock, ClimateCore.PACKAGE_BASE +
				"_fluidblock_fuel_oil", ClimateMain.MOD_ID);
		...
		MainInit.nitrogenBlock = new DCFluidBlockBase(MainInit.nitrogen,
				"nitrogen_still").setUnlocalizedName(ClimateCore.PACKAGE_BASE + "_fluidblock_nitrogen");
		DCMaterialReg.registerBlock(MainInit.nitrogenBlock, ClimateCore.PACKAGE_BASE +
				"_fluidblock_nitrogen", ClimateMain.MOD_ID);
		...
		MainInit.ethanolBlock = new DCFluidBlockBase(MainInit.ethanol,
				"ethanol_still").setUnlocalizedName(ClimateCore.PACKAGE_BASE + "_fluidblock_ethanol");
		DCMaterialReg.registerBlock(MainInit.ethanolBlock, ClimateCore.PACKAGE_BASE +
				"_fluidblock_ethanol", ClimateMain.MOD_ID);
	...
	static void registerIntegration() {
		...
		if (DCIntegrationCore.loadedMekanism) {
			...
			DCMaterialReg.registerItem(MainInit.metalMaterials, ClimateCore.PACKAGE_BASE +
					"_metal", ClimateMain.MOD_ID);
		}
	}
