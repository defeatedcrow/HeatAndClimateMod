...
public class AchievementClimate {
	...
	public static final Achievement CLIMATE_MASTER = (new Achievement("achievement.climate_master",
			"dcs.climate_master", -2, -2, new ItemStack(FoodInit.cropTomato, 1, 7), (Achievement) null) {
		@Override
	...
	public static final Achievement MACHINE_GEAR = (new Achievement("achievement.machine_gear", "dcs.machine_gear", 0,
	...
	public static final Achievement MACHINE_CHANGE = (new Achievement("achievement.machine_rotate",
			"dcs.machine_rotate", 2, 0, MainInit.wrench, MACHINE_PLACE)).registerStat();

	public static final Achievement MACHINE_USING = (new Achievement("achievement.machine_stonemill",
			"dcs.machine_stonemill", 3, 0, MachineInit.stonemill, MACHINE_CHANGE)).registerStat();

	/* magic */
	public static final Achievement MAGIC_MASTER = (new Achievement("achievement.magic_master", "dcs.magic_master", -2,
	...
	public static final Achievement MAGIC_GEM = (new Achievement("achievement.magic_getgem", "dcs.magic_getgem", 0, 2,
	...
	public static final Achievement MAGIC_CHARM = (new Achievement("achievement.magic_charm", "dcs.magic_charm", 2, 2,
			new ItemStack(MagicInit.pendant, 1, 0), MAGIC_GEM_RARE)).registerStat();

	public static final Achievement MAGIC_KNIFE = (new Achievement("achievement.magic_knife", "dcs.magic_knife", 3, 2,
