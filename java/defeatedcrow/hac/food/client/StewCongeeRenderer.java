...
public class StewCongeeRenderer extends DCRenderFoodBase<FoodEntityBase> {
	...
	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/stew_congee.png");
	private static final ModelStewBowl MODEL = new ModelStewBowl(false);

	public StewCongeeRenderer(RenderManager renderManager) {
		super(renderManager);
	}
