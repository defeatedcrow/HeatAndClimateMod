...
public class LeavesJasmine extends LeavesCropBlockDC {

	public LeavesJasmine() {
		super(CropType.OLIVE, CropTier.EPIC, false);
	...
	public String getRegistryName() {
		return "food/leaves_olive_jasmine";
	}
	...
	public ItemLike getSeedItem(CropTier t) {
		return FoodInit.BLOCK_OL_JASMINE.get();
	}

	@Override
	public Item getCropItem(CropTier t) {
		return FoodInit.CROP_OL_JASMINE.get();
	}
	...
	public List<ItemStack> getCropItems(BlockState state, int fortune) {
		...
		if (stage == CropStage.FLOWER) {
			ItemStack ret = new ItemStack(FoodInit.CROP_OL_JASMINE.get());
