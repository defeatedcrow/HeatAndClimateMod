...
public class ItemMagicOvercoat extends ItemArmorOvercoat implements IMagicClothing {

	public ItemMagicOvercoat(ArmorMaterial m, DCMaterialEnum mat, EntityEquipmentSlot slot, String t) {
		super(m, mat, slot, t);
	}
