...
public class EntityDesktopAccessories_H extends DCEntityBase {

	public EntityDesktopAccessories_H(World worldIn) {
		super(worldIn);
		this.setSize(0.3F, 0.0625F);
	}
	...
	public EntityDesktopAccessories_H(World worldIn, double posX, double posY, double posZ) {
		this(worldIn);
	...
	protected ItemStack drops() {
		return new ItemStack(MainInit.desktopAccessories, 1, 7);
	}
	...
	public boolean processInitialInteract(EntityPlayer player, EnumHand hand) {
		...
		if (MainUtil.isHeldItem(new ItemStack(MainInit.colorChanger), player)) {
			Entity change = new EntityDesktopAccessories_I(player.getEntityWorld());
