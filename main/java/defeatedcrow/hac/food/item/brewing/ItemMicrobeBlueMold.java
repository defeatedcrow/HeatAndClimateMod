...
public class ItemMicrobeBlueMold extends MicrobeItem implements IMicrobe {

	public ItemMicrobeBlueMold() {
		super();
	}

	@Override
	public Item getMicrobeItem() {
		return FoodInit.blueMold;
	}

	@Override
	public String getTexPath(int meta, boolean f) {
		String s = "items/food/brewing/mold_blue";
		if (f) {
			s = "textures/" + s;
		}
