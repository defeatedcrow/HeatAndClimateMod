...
public class SauceLiverRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/sauce_liver.png");
	private static final ModelCocotte MODEL = new ModelCocotte(false);

	public SauceLiverRenderer(RenderManager renderManager) {
		super(renderManager);
	}
