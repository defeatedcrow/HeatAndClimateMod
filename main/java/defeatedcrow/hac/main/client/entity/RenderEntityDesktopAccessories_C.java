...
import defeatedcrow.hac.main.client.model.ModelDesktopAccessories_B;
...
public class RenderEntityDesktopAccessories_C extends Render<DCEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/desktop_c.png");
	private static final DCTileModelBase MODEL = new ModelDesktopAccessories_B();

	public RenderEntityDesktopAccessories_C(RenderManager renderManager) {
		super(renderManager);
