...
public class PlateLegsModel<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition steak6 = Steak.addOrReplaceChild("steak6", CubeListBuilder.create().texOffs(26, 32).mirror().addBox(3.5F, -2.8F, 3.0F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose
				.offsetAndRotation(0.0F, 1.0F, 0.0F, 0.1222F, -2.8798F, 0.0F));

		PartDefinition steak5 = Steak.addOrReplaceChild("steak5", CubeListBuilder.create().texOffs(15, 32).mirror().addBox(1.5F, -3.0F, 1.5F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose
				.offsetAndRotation(0.0F, 1.0F, 0.0F, 0.0873F, -2.7925F, 0.0F));

		PartDefinition steak4 = Steak.addOrReplaceChild("steak4", CubeListBuilder.create().texOffs(0, 32).mirror().addBox(0.5F, -3.0F, -3.0F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose
				.offsetAndRotation(0.0F, 1.0F, 0.0F, 0.0349F, -2.618F, 0.0F));

		PartDefinition steak3 = Steak.addOrReplaceChild("steak3", CubeListBuilder.create().texOffs(26, 32).mirror().addBox(1.0F, -3.8F, 3.5F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose
				.offsetAndRotation(0.0F, 1.0F, 0.0F, 0.4363F, -0.6981F, 0.0F));

		PartDefinition steak2 = Steak.addOrReplaceChild("steak2", CubeListBuilder.create().texOffs(15, 32).mirror().addBox(-1.0F, -4.0F, 1.8F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose
				.offsetAndRotation(0.0F, 1.0F, 0.0F, 0.3927F, -0.6109F, 0.0F));

		PartDefinition steak1 = Steak.addOrReplaceChild("steak1", CubeListBuilder.create().texOffs(0, 32).mirror().addBox(-2.0F, -4.0F, -3.0F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose
