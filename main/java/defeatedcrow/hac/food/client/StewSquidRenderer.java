...
public class StewSquidRenderer extends DCRenderFoodBase<FoodEntityBase> {
	...
	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/stew_congee_squid.png");
	private static final ModelStewBowl MODEL = new ModelStewBowl(false);

	public StewSquidRenderer(RenderManager renderManager) {
		super(renderManager);
	}
