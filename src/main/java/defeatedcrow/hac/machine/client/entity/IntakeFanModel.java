...
public class IntakeFanModel extends Model {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition main = partdefinition.addOrReplaceChild("main", CubeListBuilder.create()
				.texOffs(0, 0).addBox(-6.0F, -2.0F, -8.0F, 12.0F, 2.0F, 8.0F, new CubeDeformation(0.0F))
				.texOffs(0, 0).addBox(-6.0F, -16.0F, -8.0F, 12.0F, 2.0F, 8.0F, new CubeDeformation(0.0F))
				.texOffs(16, 8).addBox(-8.0F, -16.0F, -8.0F, 2.0F, 16.0F, 8.0F, new CubeDeformation(0.0F))
				.texOffs(16, 8).addBox(6.0F, -16.0F, -8.0F, 2.0F, 16.0F, 8.0F, new CubeDeformation(0.0F))
				.texOffs(2, 11).addBox(-2.0F, -10.0F, -2.0F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(2, 11).addBox(-2.0F, -10.0F, -8.0F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(40, 0).addBox(-6.0F, -14.0F, -7.5F, 12.0F, 12.0F, 0.0F, new CubeDeformation(0.0F))
				.texOffs(40, 12).addBox(-6.0F, -14.0F, -0.5F, 12.0F, 12.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.ZERO);

		PartDefinition fan = partdefinition.addOrReplaceChild("fan", CubeListBuilder.create()
				.texOffs(1, 17).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -8.0F, -6.0F, 0.0F, 0.0F, -1.9635F));
		...
		PartDefinition power_on = partdefinition.addOrReplaceChild("power_on", CubeListBuilder.create()
				.texOffs(0, 2).addBox(-4.5F, -1.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.ZERO);

		PartDefinition power_off = partdefinition.addOrReplaceChild("power_off", CubeListBuilder.create()
				.texOffs(4, 2).addBox(-4.5F, -1.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.ZERO);

		PartDefinition error_on = partdefinition.addOrReplaceChild("error_on", CubeListBuilder.create()
				.texOffs(0, 0).addBox(-6.0F, -1.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.ZERO);

		PartDefinition error_off = partdefinition.addOrReplaceChild("error_off", CubeListBuilder.create()
				.texOffs(4, 0).addBox(-6.0F, -1.5F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.ZERO);
