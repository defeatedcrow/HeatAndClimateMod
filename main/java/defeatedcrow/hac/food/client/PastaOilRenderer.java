...
public class PastaOilRenderer extends DCRenderFoodBase<FoodEntityBase> {
	...
	private static final ResourceLocation PASTA_TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/pasta_oil.png");
	private static final ModelDishPasta MODEL = new ModelDishPasta(false);

	public PastaOilRenderer(RenderManager renderManager) {
		super(renderManager);
	}
