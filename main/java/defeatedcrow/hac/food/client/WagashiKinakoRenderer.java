...
public class WagashiKinakoRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate", "textures/entity/food/wagashi_kinako.png");
	private static final ModelMochi MODEL = new ModelMochi(false);

	public WagashiKinakoRenderer(RenderManager renderManager) {
		super(renderManager);
	}
