...
public class WagashiZundaRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate", "textures/entity/food/wagashi_zunda.png");
	private static final ModelMochi MODEL = new ModelMochi(false);

	public WagashiZundaRenderer(RenderManager renderManager) {
		super(renderManager);
	}
