...
public class PlateFishRenderer extends DCRenderFoodBase<FishPlateEntity> {
	...
	@Override
	public void doRender(FishPlateEntity entity, double x, double y, double z, float yaw, float partialTicks) {
