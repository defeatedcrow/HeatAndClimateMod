...
public class PizzaRoeEntity extends FoodEntityBase {

	public PizzaRoeEntity(World worldIn) {
		super(worldIn);
		this.setSize(0.5F, 0.1F);
	}

	public PizzaRoeEntity(World worldIn, double posX, double posY, double posZ) {
		super(worldIn, posX, posY, posZ);
		this.setSize(0.5F, 0.1F);
	}

	public PizzaRoeEntity(World worldIn, double posX, double posY, double posZ, @Nullable EntityPlayer player) {
	...
	protected ItemStack[] drops() {
		return new ItemStack[] { new ItemStack(FoodInit.pizza, 1, 0), new ItemStack(FoodInit.pizza, 1, 1) };
	}
