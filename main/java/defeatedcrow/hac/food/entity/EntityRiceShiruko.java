...
public class EntityRiceShiruko extends FoodEntityBase {

	public EntityRiceShiruko(World worldIn) {
		super(worldIn);
		this.setSize(0.35F, 0.35F);
	}

	public EntityRiceShiruko(World worldIn, double posX, double posY, double posZ) {
		super(worldIn, posX, posY, posZ);
		this.setSize(0.35F, 0.35F);
	}

	public EntityRiceShiruko(World worldIn, double posX, double posY, double posZ, @Nullable EntityPlayer player) {
	...
	protected ItemStack[] drops() {
		return new ItemStack[] {
				new ItemStack(FoodInit.ricebowl, 1, 7),
				new ItemStack(FoodInit.ricebowl, 1, 7)
		};
	}
