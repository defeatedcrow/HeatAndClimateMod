...
public class HopperGoldTile extends HopperBaseTile {

	public HopperGoldTile(BlockPos pos, BlockState state) {
		super(MachineInit.HOPPER_GOLD_TILE.get(), pos, state);
	}
	...
	protected AbstractContainerMenu createMenu(int i, Inventory inv) {
		return HopperFilterMenu.goldMenu(i, inv, this);
	}
