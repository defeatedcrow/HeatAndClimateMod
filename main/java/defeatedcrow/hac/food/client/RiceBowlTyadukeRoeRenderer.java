...
public class RiceBowlTyadukeRoeRenderer extends DCRenderFoodBase<FoodEntityBase> {

	protected static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/ricebowl_tyaduke_roe.png");
	protected static final ModelRiceBowl2 MODEL = new ModelRiceBowl2(false);

	public RiceBowlTyadukeRoeRenderer(RenderManager renderManager) {
		super(renderManager);
	}
