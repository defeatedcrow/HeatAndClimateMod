...
public class PastaBasilRenderer extends DCRenderFoodBase<FoodEntityBase> {
	...
	private static final ResourceLocation PASTA_TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/pasta_basil.png");
	private static final ModelDishPasta MODEL = new ModelDishPasta(false);

	public PastaBasilRenderer(RenderManager renderManager) {
		super(renderManager);
	}
