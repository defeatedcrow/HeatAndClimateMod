...
public class WagashiKurimanjuRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate", "textures/entity/food/wagashi_kurimanju.png");
	private static final ModelMochi MODEL = new ModelMochi(false);

	public WagashiKurimanjuRenderer(RenderManager renderManager) {
		super(renderManager);
	}
