...
public class PlateBeefRenderer extends DCRenderFoodBase<PlateBeefEntity> {
	...
	@Override
	public void doRender(PlateBeefEntity entity, double x, double y, double z, float yaw, float partialTicks) {
