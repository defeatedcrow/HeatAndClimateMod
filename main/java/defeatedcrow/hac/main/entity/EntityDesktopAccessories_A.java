...
public class EntityDesktopAccessories_A extends DCEntityBase {

	public EntityDesktopAccessories_A(World worldIn) {
		super(worldIn);
	...
	public EntityDesktopAccessories_A(World worldIn, double posX, double posY, double posZ) {
		this(worldIn);
	...
	protected ItemStack drops() {
		return new ItemStack(MainInit.desktopAccessories, 1, 0);
	}
	...
	public boolean processInitialInteract(EntityPlayer player, EnumHand hand) {
		...
		if (MainUtil.isHeldItem(new ItemStack(MainInit.colorChanger), player)) {
			Entity change = new EntityDesktopAccessories_B(player.getEntityWorld());
