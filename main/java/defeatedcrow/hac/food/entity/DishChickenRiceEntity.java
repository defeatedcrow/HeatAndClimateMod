...
public class DishChickenRiceEntity extends FoodEntityBase {

	public DishChickenRiceEntity(World worldIn) {
		super(worldIn);
		this.setSize(0.75F, 0.25F);
	}

	public DishChickenRiceEntity(World worldIn, double posX, double posY, double posZ) {
		super(worldIn, posX, posY, posZ);
		this.setSize(0.75F, 0.25F);
	}

	public DishChickenRiceEntity(World worldIn, double posX, double posY, double posZ, @Nullable EntityPlayer player) {
	...
	protected ItemStack[] drops() {
		return new ItemStack[] {
				new ItemStack(FoodInit.dishBig, 1, 7),
				new ItemStack(FoodInit.dishBig, 1, 7)
		};
	}
