...
public class StewPumpkinRenderer extends DCRenderFoodBase<FoodEntityBase> {
	...
	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/stew_pumpkin.png");
	private static final ModelStewBowl MODEL = new ModelStewBowl(false);

	public StewPumpkinRenderer(RenderManager renderManager) {
		super(renderManager);
	}
