...
public class PastaRoeRenderer extends DCRenderFoodBase<FoodEntityBase> {
	...
	private static final ResourceLocation PASTA_TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/pasta_roe.png");
	private static final ModelDishPasta MODEL = new ModelDishPasta(false);

	public PastaRoeRenderer(RenderManager renderManager) {
		super(renderManager);
	}
