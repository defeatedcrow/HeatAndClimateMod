...
public class SauceRaisinRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/sauce_raisin.png");
	private static final ModelCocotte MODEL = new ModelCocotte(false);

	public SauceRaisinRenderer(RenderManager renderManager) {
		super(renderManager);
	}
