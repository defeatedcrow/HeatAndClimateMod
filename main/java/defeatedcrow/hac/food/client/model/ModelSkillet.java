...
public class ModelSkillet extends DCTileModelBase {
	// fields
	...
	public ModelSkillet() {
		...
		side1.setRotationPoint(0F, 21F, -3F);
		...
		side2.setRotationPoint(0F, 21F, 7F);
		...
		side3.setRotationPoint(-5F, 21F, 2F);
		...
		side4.setRotationPoint(5F, 21F, 2F);
		...
		handle.setRotationPoint(0F, 20.7F, 0F);
