...
public class EntityDesktopAccessories_G extends DCEntityBase {

	public EntityDesktopAccessories_G(World worldIn) {
		super(worldIn);
		this.setSize(0.8F, 0.0625F);
	}
	...
	public EntityDesktopAccessories_G(World worldIn, double posX, double posY, double posZ) {
		this(worldIn);
	...
	protected ItemStack drops() {
		return new ItemStack(MainInit.desktopAccessories, 1, 6);
	}
	...
	public boolean processInitialInteract(EntityPlayer player, EnumHand hand) {
		...
		if (MainUtil.isHeldItem(new ItemStack(MainInit.colorChanger), player)) {
			Entity change = new EntityDesktopAccessories_H(player.getEntityWorld());
