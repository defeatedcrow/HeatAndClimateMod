...
public class RenderEntitySmallCushionB extends Render<EntitySmallCushionA> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/cushion_blue.png");
	private static final ModelSmallCution MODEL = new ModelSmallCution(false);

	public RenderEntitySmallCushionB(RenderManager renderManager) {
		super(renderManager);
