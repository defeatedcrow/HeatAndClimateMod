...
public class CushionSquareModel<T extends ObjectEntityBaseDC> extends EntityModel<ObjectEntityBaseDC> {

	private final ModelPart main;

	public CushionSquareModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("main", CubeListBuilder.create()
		    .texOffs(0, 0)
		    .addBox(-4.0F, -2.0F, -4.0F, 8.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.ZERO);
