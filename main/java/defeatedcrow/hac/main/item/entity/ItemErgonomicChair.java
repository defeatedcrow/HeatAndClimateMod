...
public class ItemErgonomicChair extends DCEntityItem {

	public ItemErgonomicChair() {
		super();
	}
	...
	public Entity getPlacementEntity(World world, EntityPlayer player, double x, double y, double z, ItemStack item) {
		...
		DCEntityBase ret = new EntityErgonomicChair(world, x, y, z, player);
		if (i == 1) {
			ret = new EntityErgonomicChairWhite(world, x, y, z, player);
		}
		return ret;
	}
