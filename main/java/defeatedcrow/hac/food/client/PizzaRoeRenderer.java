...
public class PizzaRoeRenderer extends DCRenderFoodBase<FoodEntityBase> {
	...
	public PizzaRoeRenderer(RenderManager renderManager) {
		super(renderManager);
	}
