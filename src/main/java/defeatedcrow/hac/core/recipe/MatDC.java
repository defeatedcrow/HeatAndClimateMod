...
public class MatDC {
	...
	public static final Alloy TOOL_STEEL = new Alloy("tool_steel", Rarity.RARE, () -> CoreInit.METALBLOCK_TOOL_STEEL.get(), () -> CoreInit.DUSTBLOCK_TOOL_STEEL.get(), () -> CoreInit.INGOT_TOOL_STEEL
		.get(), () -> TagDC.ItemTag.DUST_IRON, () -> TagDC.ItemTag.DUST_CHROMIUM, () -> TagDC.ItemTag.DUST_MOLYBDENUM);
	...
	public static final Alloy TITANIUM = new Alloy("titanium", Rarity.RARE, () -> CoreInit.METALBLOCK_TITANIUM.get(), () -> CoreInit.DUSTBLOCK_TITANIUM.get(), () -> CoreInit.INGOT_TITANIUM
		.get(), () -> TagDC.ItemTag.DUSTBLOCK_TINANIUM, () -> TagDC.ItemTag.DUST_ALUMINUM, () -> TagDC.ItemTag.DUST_CHROMIUM);
	...
	public static final Alloy MANGALLOY = new Alloy("mangalloy", Rarity.RARE, () -> CoreInit.METALBLOCK_MANGALLOY.get(), () -> CoreInit.DUSTBLOCK_MANGALLOY.get(), () -> CoreInit.INGOT_MANGALLOY
		.get(), () -> TagDC.ItemTag.DUST_IRON, () -> TagDC.ItemTag.DUST_MANGANESE, () -> TagDC.ItemTag.DUST_COAL);
	...
	public static final Alloy[] ALLOY_VARIANT = { BRASS, BRONZE, NICKEL_SILVER, STEEL, SUS, TOOL_STEEL, TITANIUM, MAGNET, MANGALLOY, BSCCO };
	...
	public static final Wood BEECH_COMMON = new Wood("beech_common", () -> FoodInit.LOG_BH_COMMON.get(), () -> FoodInit.PLANK_BH_COMMON.get(), () -> BuildInit.STARIS_BEECH.get(), () -> BuildInit.SLAB_BEECH
		.get(), () -> BuildInit.FENCE_BEECH.get());
	public static final Wood BEECH_WALNUT = new Wood("beech_walnut", () -> FoodInit.LOG_BH_WALNUT.get(), () -> FoodInit.PLANK_BH_WALNUT.get(), () -> BuildInit.STARIS_WALNUT.get(), () -> BuildInit.SLAB_WALNUT
		.get(), () -> BuildInit.FENCE_WALNUT.get());
	public static final Wood BEECH_SWEET = new Wood("beech_sweet", () -> FoodInit.LOG_BH_SWEET.get(), () -> FoodInit.PLANK_BH_SWEET.get(), () -> BuildInit.STARIS_SWEET.get(), () -> BuildInit.SLAB_SWEET
		.get(), () -> BuildInit.FENCE_SWEET.get());

	public static final Wood[] WOOD_VARIANT = { BEECH_COMMON, BEECH_WALNUT, BEECH_SWEET };
