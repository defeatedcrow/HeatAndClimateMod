...
@OnlyIn(Dist.CLIENT)
public class TileRendererVillagerChest implements BlockEntityRenderer<VillagerChestTile> {

	protected VillagerChestModel model;

	public TileRendererVillagerChest(BlockEntityRendererProvider.Context ctx) {
		this.model = new VillagerChestModel(ctx.bakeLayer(VillagerChestTile.NORMAL.getLayerLocation()));
	}

	@Override
	public void render(VillagerChestTile tile, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight, int i2) {
