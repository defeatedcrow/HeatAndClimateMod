...
public class LeavesRubber extends LeavesCropBlockDC {

	public LeavesRubber() {
		super(CropType.MORUS, CropTier.RARE);
	...
	public String getRegistryName() {
		return "food/leaves_morus_rubber";
	}

	@Override
	public List<JsonModelDC> getBlockModel() {
		return ImmutableList.of(
			new JsonModelDC("dcs_climate:block/dcs_leaves", ImmutableMap.of("all", "dcs_climate:block/tree/morus_rubber_leaves")),
			new JsonModelDC("dcs_climate:block/dcs_leaves", ImmutableMap.of("all", "dcs_climate:block/tree/morus_rubber_leaves")),
			new JsonModelDC("dcs_climate:block/dcs_leaves", ImmutableMap.of("all", "dcs_climate:block/tree/morus_rubber_leaves")),
			new JsonModelDC("dcs_climate:block/dcs_leaves", ImmutableMap.of("all", "dcs_climate:block/tree/morus_rubber_leaves")),
			new JsonModelDC("dcs_climate:block/dcs_leaves", ImmutableMap.of("all", "dcs_climate:block/tree/morus_rubber_leaves_f")),
			new JsonModelDC("dcs_climate:block/dcs_leaves", ImmutableMap.of("all", "dcs_climate:block/tree/morus_rubber_leaves_c")));
	}
	...
	public ItemLike getSeedItem(CropTier t) {
		return FoodInit.BLOCK_MR_RUBBER.get();
	}
