...
public class LeavesDamaschena extends LeavesCropBlockDC {

	public LeavesDamaschena() {
		super(CropType.ROSE, CropTier.RARE, false);
	...
	public String getRegistryName() {
		return "food/leaves_rose_damaschena";
	}
	...
	public ItemLike getSeedItem(CropTier t) {
		return FoodInit.BLOCK_RO_DAMASCHENA.get();
	}
