...
public class MachineInit {
	...
	public static final RegistryObject<Block> CHAMBER_BRICK_A = regBlock("chamber_brick_a", () -> new BrickChamberBlock("chamber_brick_a"), Rarity.COMMON, TagDC.ItemTag.CLIMATE_MACHINE);
	public static final RegistryObject<Block> CHAMBER_BRICK_B = regBlock("chamber_brick_b", () -> new BrickChamberBlock("chamber_brick_b"), Rarity.COMMON, TagDC.ItemTag.CLIMATE_MACHINE);
	public static final RegistryObject<Block> CHAMBER_IRON = regBlock("chamber_iron", () -> new HeatingChamberBlock("chamber_iron"), Rarity.UNCOMMON, TagDC.ItemTag.CLIMATE_MACHINE);
	public static final RegistryObject<Block> FUEL_BURNER = regBlock("fuel_burner", () -> new FluidChamberBlock("fuel_burner"), Rarity.RARE, TagDC.ItemTag.CLIMATE_MACHINE);
	public static final RegistryObject<Block> KICHEN_STOVE = regBlock("kitchen_stove", () -> new KichenStoveBlock("kitchen_stove"), Rarity.RARE, TagDC.ItemTag.CLIMATE_MACHINE);
	public static final RegistryObject<Block> KICHEN_OVEN_WOOD = regBlock("kitchen_oven_wood", () -> new KichenOvenBlock("kitchen_oven_wood"), Rarity.RARE, TagDC.ItemTag.CLIMATE_MACHINE);
	public static final RegistryObject<Block> KICHEN_OVEN_BLACK = regBlock("kitchen_oven_black", () -> new KichenOvenBlock("kitchen_oven_black"), Rarity.RARE, TagDC.ItemTag.CLIMATE_MACHINE);
	public static final RegistryObject<Block> KICHEN_OVEN_LAB = regBlock("kitchen_oven_lab", () -> new KichenOvenBlock("kitchen_oven_lab"), Rarity.RARE, TagDC.ItemTag.CLIMATE_MACHINE);

	public static final RegistryObject<Block> KICHEN_BENCH_BRICK = regBlock("kitchen_bench_brick", () -> new KichenBenchBlock("kitchen_bench_brick"), Rarity.COMMON, TagDC.ItemTag.HAC_MACHINE);
	public static final RegistryObject<Block> KICHEN_BENCH_SUS = regBlock("kitchen_bench_sus", () -> new KichenBenchBlock("kitchen_bench_sus"), Rarity.RARE, TagDC.ItemTag.HAC_MACHINE);
	public static final RegistryObject<Block> KICHEN_BENCH_WOOD_A = regBlock("kitchen_bench_wood_a", () -> new KichenBenchBlock("kitchen_bench_wood_a"), Rarity.COMMON, TagDC.ItemTag.HAC_MACHINE);
	public static final RegistryObject<Block> KICHEN_BENCH_WOOD_B = regBlock("kitchen_bench_wood_b", () -> new KichenBenchBlock("kitchen_bench_wood_b"), Rarity.COMMON, TagDC.ItemTag.HAC_MACHINE);
	public static final RegistryObject<Block> KICHEN_BENCH_BLACK_A = regBlock("kitchen_bench_black_a", () -> new KichenBenchBlock("kitchen_bench_black_a"), Rarity.COMMON, TagDC.ItemTag.HAC_MACHINE);
	public static final RegistryObject<Block> KICHEN_BENCH_BLACK_B = regBlock("kitchen_bench_black_b", () -> new KichenBenchBlock("kitchen_bench_black_b"), Rarity.COMMON, TagDC.ItemTag.HAC_MACHINE);
	public static final RegistryObject<Block> KICHEN_BENCH_LAB_A = regBlock("kitchen_bench_lab_a", () -> new KichenBenchBlock("kitchen_bench_lab_a"), Rarity.COMMON, TagDC.ItemTag.HAC_MACHINE);
	public static final RegistryObject<Block> KICHEN_BENCH_LAB_B = regBlock("kitchen_bench_lab_b", () -> new KichenBenchBlock("kitchen_bench_lab_b"), Rarity.COMMON, TagDC.ItemTag.HAC_MACHINE);

	public static final RegistryObject<Block> KICHEN_SINK_BRICK = regBlock("fluid_sink_brick", () -> new FluidSinkBlock_Brick("fluid_sink_brick", false), Rarity.COMMON, TagDC.ItemTag.HAC_MACHINE);
	public static final RegistryObject<Block> HALF_SINK_BRICK = regBlock("half_sink_brick", () -> new FluidSinkBlock_Brick("half_sink_brick", true), Rarity.COMMON, TagDC.ItemTag.HAC_MACHINE);
	public static final RegistryObject<Block> KICHEN_SINK_SUS = regBlock("fluid_sink_sus", () -> new FluidSinkBlock_Brick("fluid_sink_sus", false), Rarity.RARE, TagDC.ItemTag.HAC_MACHINE);
	public static final RegistryObject<Block> HALF_SINK_SUS = regBlock("half_sink_sus", () -> new FluidSinkBlock_Brick("half_sink_sus", true), Rarity.RARE, TagDC.ItemTag.HAC_MACHINE);
	public static final RegistryObject<Block> KICHEN_SINK_WOOD = regBlock("fluid_sink_wood", () -> new FluidSinkBlock_Brick("fluid_sink_wood", false), Rarity.COMMON, TagDC.ItemTag.HAC_MACHINE);
	public static final RegistryObject<Block> KICHEN_SINK_BLACK = regBlock("fluid_sink_black", () -> new FluidSinkBlock_Brick("fluid_sink_black", false), Rarity.COMMON, TagDC.ItemTag.HAC_MACHINE);
	public static final RegistryObject<Block> KICHEN_SINK_LAB = regBlock("fluid_sink_lab", () -> new FluidSinkBlock_Brick("fluid_sink_lab", false), Rarity.COMMON, TagDC.ItemTag.HAC_MACHINE);

	public static final RegistryObject<Block> HOPPER_FILTER = regBlock("hopper_filter", () -> new HopperFilterBlock("hopper_filter"), Rarity.COMMON, TagDC.ItemTag.HAC_MACHINE);
	public static final RegistryObject<Block> HOPPER_GOLD = regBlock("hopper_gold", () -> new HopperGoldBlock("hopper_gold"), Rarity.COMMON, TagDC.ItemTag.HAC_MACHINE);
	public static final RegistryObject<Block> HOPPER_FILTER_GOLD = regBlock("hopper_filter_gold", () -> new HopperFilterGoldBlock("hopper_filter_gold"), Rarity.COMMON, TagDC.ItemTag.HAC_MACHINE);
	public static final RegistryObject<Block> HOPPER_EXP = regBlock("hopper_exp", () -> new HopperEXPBlock("hopper_exp"), Rarity.UNCOMMON, TagDC.ItemTag.HAC_MACHINE);

	public static final RegistryObject<Block> CONVEYOR = regBlock("conveyor", () -> new ConveyorNormalBlock("conveyor"), Rarity.UNCOMMON, TagDC.ItemTag.HAC_MACHINE);
	public static final RegistryObject<Block> CONVEYOR_VERTICAL = regBlock("conveyor_vertical", () -> new ConveyorVerticalBlock("conveyor_vertical"), Rarity.UNCOMMON, TagDC.ItemTag.HAC_MACHINE);
	public static final RegistryObject<Block> CONVEYOR_SMELTING = regBlock("conveyor_smelting", () -> new ConveyorSmeltingBlock("conveyor_smelting"), Rarity.UNCOMMON, TagDC.ItemTag.HAC_MACHINE);
	public static final RegistryObject<Block> CONVEYOR_DROPPER = regBlock("conveyor_dropper", () -> new ConveyorDropperBlock("conveyor_dropper"), Rarity.UNCOMMON, TagDC.ItemTag.HAC_MACHINE);
	public static final RegistryObject<Block> CONVEYOR_SORTER = regBlock("conveyor_sorter", () -> new ConveyorSortingBlock("conveyor_sorter"), Rarity.UNCOMMON, TagDC.ItemTag.HAC_MACHINE);
	public static final RegistryObject<Block> CONVEYOR_FILLER = regBlock("conveyor_filler", () -> new ConveyorFillerBlock("conveyor_filler"), Rarity.UNCOMMON, TagDC.ItemTag.HAC_MACHINE);
	...
	public static final RegistryObject<Block> PIPE_BRASS = regBlock("pipe_brass", () -> new FluidPipeAlloyBlock("pipe_brass"), Rarity.COMMON, TagDC.ItemTag.FLUID_PIPE);
	public static final RegistryObject<Block> PIPE_NICKELSILVER = regBlock("pipe_nickelsilver", () -> new FluidPipeNickelsilverBlock("pipe_nickelsilver"), Rarity.UNCOMMON, TagDC.ItemTag.FLUID_PIPE);
	...
	public static final RegistryObject<Block> SPRINKLER = regBlock("sprinkler", () -> new SprinklerBlock("sprinkler"), Rarity.UNCOMMON, TagDC.ItemTag.HAC_MACHINE);
	...
	public static final RegistryObject<Block> FAUCET_A = regBlock("faucet_a", () -> new FaucetBlock("faucet_a"), Rarity.RARE, TagDC.ItemTag.HAC_MACHINE);
	public static final RegistryObject<Block> FAUCET_B = regBlock("faucet_b", () -> new FaucetBlock("faucet_b"), Rarity.RARE, TagDC.ItemTag.HAC_MACHINE);
	public static final RegistryObject<Block> FAUCET_C = regBlock("faucet_c", () -> new FaucetBlock("faucet_c"), Rarity.RARE, TagDC.ItemTag.HAC_MACHINE);
	public static final RegistryObject<Block> FAUCET_D = regBlock("faucet_d", () -> new FaucetBlock("faucet_d"), Rarity.RARE, TagDC.ItemTag.HAC_MACHINE);

	public static final RegistryObject<Block> SPILE = regBlock("spilecup", () -> new SpileCupBlock("spilecup"), Rarity.COMMON, TagDC.ItemTag.HAC_MACHINE);

	public static final RegistryObject<Block> COOKING_POT_NORMAL = regBlock("cooking_pot_normal", () -> new CookingPotBlock("cooking_pot_normal"), Rarity.UNCOMMON, TagDC.ItemTag.CLIMATE_MACHINE);
	public static final RegistryObject<Block> COOKING_POT_WHITE = regBlock("cooking_pot_white", () -> new CookingPotBlock("cooking_pot_white"), Rarity.UNCOMMON, TagDC.ItemTag.CLIMATE_MACHINE);
	public static final RegistryObject<Block> COOKING_POT_BLUE = regBlock("cooking_pot_blue", () -> new CookingPotBlock("cooking_pot_blue"), Rarity.UNCOMMON, TagDC.ItemTag.CLIMATE_MACHINE);
	public static final RegistryObject<Block> COOKING_POT_BLACK = regBlock("cooking_pot_black", () -> new CookingPotBlock("cooking_pot_black"), Rarity.UNCOMMON, TagDC.ItemTag.CLIMATE_MACHINE);
	public static final RegistryObject<Block> COOKING_POT_RED = regBlock("cooking_pot_red", () -> new CookingPotBlock("cooking_pot_red"), Rarity.UNCOMMON, TagDC.ItemTag.CLIMATE_MACHINE);
	public static final RegistryObject<Block> COOKING_POT_GREEN = regBlock("cooking_pot_green", () -> new CookingPotBlock("cooking_pot_green"), Rarity.UNCOMMON, TagDC.ItemTag.CLIMATE_MACHINE);

	public static final RegistryObject<Block> TEA_POT_NORMAL = regBlock("tea_pot_normal", () -> new TeaPotBlock("tea_pot_normal"), Rarity.UNCOMMON, TagDC.ItemTag.CLIMATE_MACHINE);
	public static final RegistryObject<Block> TEA_POT_WHITE = regBlock("tea_pot_white", () -> new TeaPotBlock("tea_pot_white"), Rarity.UNCOMMON, TagDC.ItemTag.CLIMATE_MACHINE);
	public static final RegistryObject<Block> TEA_POT_BLUE = regBlock("tea_pot_blue", () -> new TeaPotBlock("tea_pot_blue"), Rarity.UNCOMMON, TagDC.ItemTag.CLIMATE_MACHINE);
	public static final RegistryObject<Block> TEA_POT_BLACK = regBlock("tea_pot_black", () -> new TeaPotBlock("tea_pot_black"), Rarity.UNCOMMON, TagDC.ItemTag.CLIMATE_MACHINE);
	public static final RegistryObject<Block> TEA_POT_RED = regBlock("tea_pot_red", () -> new TeaPotBlock("tea_pot_red"), Rarity.UNCOMMON, TagDC.ItemTag.CLIMATE_MACHINE);
	public static final RegistryObject<Block> TEA_POT_GREEN = regBlock("tea_pot_green", () -> new TeaPotBlock("tea_pot_green"), Rarity.UNCOMMON, TagDC.ItemTag.CLIMATE_MACHINE);

	public static final RegistryObject<Block> COFFEE_SIPHON = regBlock("coffee_siphon", () -> new CoffeeMakerBlock("coffee_siphon"), Rarity.UNCOMMON, TagDC.ItemTag.CLIMATE_MACHINE);
	public static final RegistryObject<Block> COFFEE_MACCHINETTA = regBlock("coffee_macchinetta", () -> new CoffeeMacchinettaBlock("coffee_macchinetta"), Rarity.RARE, TagDC.ItemTag.CLIMATE_MACHINE);

	public static final RegistryObject<Block> FERMENTATION_JAR_NORMAL = regBlock("fermentation_jar_normal", () -> new FermentationJarBlock("fermentation_jar_normal", false), Rarity.COMMON, TagDC.ItemTag.CLIMATE_MACHINE);
	public static final RegistryObject<Block> FERMENTATION_JAR_WHITE = regBlock("fermentation_jar_white", () -> new FermentationJarBlock("fermentation_jar_white", false), Rarity.COMMON, TagDC.ItemTag.CLIMATE_MACHINE);
	public static final RegistryObject<Block> FERMENTATION_JAR_BLUE = regBlock("fermentation_jar_blue", () -> new FermentationJarBlock("fermentation_jar_blue", true), Rarity.COMMON, TagDC.ItemTag.CLIMATE_MACHINE);
	public static final RegistryObject<Block> FERMENTATION_JAR_BLACK = regBlock("fermentation_jar_black", () -> new FermentationJarBlock("fermentation_jar_black", false), Rarity.COMMON, TagDC.ItemTag.CLIMATE_MACHINE);
	public static final RegistryObject<Block> FERMENTATION_JAR_RED = regBlock("fermentation_jar_red", () -> new FermentationJarBlock("fermentation_jar_red", true), Rarity.COMMON, TagDC.ItemTag.CLIMATE_MACHINE);
	public static final RegistryObject<Block> FERMENTATION_JAR_GREEN = regBlock("fermentation_jar_green", () -> new FermentationJarBlock("fermentation_jar_green", true), Rarity.COMMON, TagDC.ItemTag.CLIMATE_MACHINE);

	public static final RegistryObject<Block> WATER_PUMP = regBlock("water_pump", () -> new WaterPumpBlock("water_pump"), Rarity.UNCOMMON, TagDC.ItemTag.ENERGY_MACHINE);
	public static final RegistryObject<Block> VOLUTE_PUMP = regBlock("volute_pump", () -> new VolutePumpBlock("volute_pump"), Rarity.RARE, TagDC.ItemTag.ENERGY_MACHINE);
	public static final RegistryObject<Block> STONE_MILL = regBlock("stone_mill", () -> new StoneMillBlock("stone_mill"), Rarity.UNCOMMON, TagDC.ItemTag.ENERGY_MACHINE);
	public static final RegistryObject<Block> ROLL_CRUSHER = regBlock("roll_crusher", () -> new RollCrusherBlock("roll_crusher"), Rarity.RARE, TagDC.ItemTag.ENERGY_MACHINE);
	public static final RegistryObject<Block> INTAKE_FAN = regBlock("intake_fan", () -> new IntakeFanBlock("intake_fan"), Rarity.RARE, TagDC.ItemTag.ENERGY_MACHINE);
	public static final RegistryObject<Block> EXHAUST_VENT = regBlock("exhaust_vent", () -> new ExhaustVentBlock("exhaust_vent"), Rarity.UNCOMMON, TagDC.ItemTag.CLIMATE_MACHINE);
	public static final RegistryObject<Block> ITEM_ASPIRATOR = regBlock("item_aspirator", () -> new ItemAspiratorBlock("item_aspirator"), Rarity.RARE, TagDC.ItemTag.ENERGY_MACHINE);
	public static final RegistryObject<Block> CROP_ASPIRATOR = regBlock("crop_aspirator", () -> new CropAspiratorBlock("crop_aspirator"), Rarity.RARE, TagDC.ItemTag.ENERGY_MACHINE);
	...
	public static final RegistryObject<Block> BOILER_BIOMASS = regBlock("boiler_biomass", () -> new BoilerBiomassBlock("boiler_biomass"), Rarity.UNCOMMON, TagDC.ItemTag.ENERGY_MACHINE);
	public static final RegistryObject<Block> HYDRO_TURBINE = regBlock("hydro_turbine", () -> new HydroTurbineBlock("hydro_turbine"), Rarity.RARE, TagDC.ItemTag.ENERGY_MACHINE);
	...
	public static final RegistryObject<Block> CABLE_COPPER = regBlock("cable_copper", () -> new CableCopperBlock("cable_copper"), Rarity.COMMON, TagDC.ItemTag.ENERGY_CABLE);
	public static final RegistryObject<Block> CABLE_COPPER_COATED = regBlock("cable_copper_coated", () -> new CableCopperBlock("cable_copper_coated"), Rarity.COMMON, TagDC.ItemTag.ENERGY_CABLE);
	public static final RegistryObject<Block> CABLE_ALUMINUM_COATED = regBlock("cable_aluminum_coated", () -> new CableAluminumBlock("cable_aluminum_coated"), Rarity.UNCOMMON, TagDC.ItemTag.ENERGY_CABLE);
	...
	public static final RegistryObject<Block> REFLECTIVE_SENSOR = regBlock("reflective_sensor", ReflectiveSensorBlock::new, Rarity.RARE, TagDC.ItemTag.DISPLAY_MACHINE);
	public static final RegistryObject<Block> ENTITY_CAMERA = regBlock("entity_camera", EntityCameraBlock::new, Rarity.RARE, TagDC.ItemTag.DISPLAY_MACHINE);

	public static final RegistryObject<Block> STORMGLASS = regBlock("stormglass", () -> new StormglassBlock("stormglass"), Rarity.COMMON, TagDC.ItemTag.CLIMATE_MACHINE);

	public static final RegistryObject<Block> PLAYER_PRESSURE_PLATE = regBlock("player_pressure_plate", () -> new PlayerPressurePlateBlock("player_pressure_plate"), Rarity.COMMON, TagDC.ItemTag.DISPLAY_MACHINE);
