...
public class JellyLemonRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/jelly_lemon.png");
	private static final ModelJelly MODEL = new ModelJelly(false);

	public JellyLemonRenderer(RenderManager renderManager) {
		super(renderManager);
	}
