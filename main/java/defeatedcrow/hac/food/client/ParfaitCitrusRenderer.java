...
public class ParfaitCitrusRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/parfait_citrus.png");
	private static final ModelParfait MODEL = new ModelParfait(false);

	public ParfaitCitrusRenderer(RenderManager renderManager) {
		super(renderManager);
	}
