...
public class ClimateSmeltingConfig {
	...
	private static Map<String, ClimateSmelting> list = new LinkedHashMap<>();

	public static void addRecipe(String name, ClimateSmelting recipe) {
	...
	public static void initFile() {
		...
		// configフォルダに生成する
		// 生成は最初のみ
		File dir = new File(ClimateCore.dataDir, "/recipes/climate_smelting/");
		if (!dir.getParentFile().exists()) {
			dir.getParentFile().mkdirs();
		}

		for (Entry<String, ClimateSmelting> table : INSTANCE.list.entrySet()) {
