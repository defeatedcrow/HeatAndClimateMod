...
public class StewPurpleRenderer extends DCRenderFoodBase<FoodEntityBase> {
	...
	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/stew_purple.png");
	private static final ModelStewBowl MODEL = new ModelStewBowl(false);

	public StewPurpleRenderer(RenderManager renderManager) {
		super(renderManager);
	}
