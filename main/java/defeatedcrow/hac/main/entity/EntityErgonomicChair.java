...
public class EntityErgonomicChair extends DCEntityBase {

	public EntityErgonomicChair(World worldIn) {
		super(worldIn);
	...
	public EntityErgonomicChair(World worldIn, double posX, double posY, double posZ) {
		this(worldIn);
		this.setSize(0.75F, 0.6F);
		this.setPosition(posX, posY, posZ);
	}

	public EntityErgonomicChair(World worldIn, double posX, double posY, double posZ, @Nullable EntityPlayer player) {
	...
	protected ItemStack drops() {
		return new ItemStack(MainInit.ergonomicChair, 1, 0);
	}
