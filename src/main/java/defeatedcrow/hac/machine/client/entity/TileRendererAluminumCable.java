...
@OnlyIn(Dist.CLIENT)
public class TileRendererAluminumCable implements BlockEntityRenderer<CableAluminumTile> {

	protected CableModel model;

	public TileRendererAluminumCable(BlockEntityRendererProvider.Context ctx) {
		this.model = new CableModel(ctx.bakeLayer(ALUMINUM_COATED.getLayerLocation()));
	}

	@Override
	public void render(CableAluminumTile tile, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight, int i2) {
	...
	protected ResourceLocation getPoweredTexture(Block block) {
		return ALUMINUM_COATED_POWERED.getTextureLocation();
	}

	protected ResourceLocation getCableTexture(FaceIO io, Block block) {
		if (io == FaceIO.INPUT) {
			return ALUMINUM_COATED_INPUT.getTextureLocation();
		} else if (io == FaceIO.OUTPUT) {
			return ALUMINUM_COATED_OUTLET.getTextureLocation();
		}
		return ALUMINUM_COATED.getTextureLocation();
	}

	// public static final EntityRenderData ALUMINUM = new EntityRenderData("tile/cable_aluminum", 1F, 0F);
	// public static final EntityRenderData ALUMINUM_INPUT = new EntityRenderData("tile/cable_aluminum_input", 1F, 0F);
	// public static final EntityRenderData ALUMINUM_OUTLET = new EntityRenderData("tile/cable_aluminum_outlet", 1F, 0F);
	// public static final EntityRenderData ALUMINUM_POWERED = new EntityRenderData("tile/cable_aluminum_powered", 1F, 0F);

	public static final EntityRenderData ALUMINUM_COATED = new EntityRenderData("tile/cable_aluminum_coated", 1F, 0F);
	public static final EntityRenderData ALUMINUM_COATED_INPUT = new EntityRenderData("tile/cable_aluminum_coated_input", 1F, 0F);
	public static final EntityRenderData ALUMINUM_COATED_OUTLET = new EntityRenderData("tile/cable_aluminum_coated_outlet", 1F, 0F);
	public static final EntityRenderData ALUMINUM_COATED_POWERED = new EntityRenderData("tile/cable_aluminum_coated_powered", 1F, 0F);
