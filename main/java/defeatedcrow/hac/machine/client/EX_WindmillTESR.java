...
import defeatedcrow.hac.machine.client.model.ModelWindmill_EX;
...
public class EX_WindmillTESR extends DCTorqueTESRBase {

	@Override
	protected String getTexPass(int i) {
		return "dcs_climate:textures/tiles/windmill_ex_steel.png";
	}

	private static final ModelWindmill_EX MODEL = new ModelWindmill_EX();
