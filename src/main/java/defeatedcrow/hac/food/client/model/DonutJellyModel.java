...
public class DonutJellyModel<T extends Entity> extends EntityModel<T> {

	private final ModelPart base;

	public DonutJellyModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition base = partdefinition.addOrReplaceChild("base", CubeListBuilder.create()
		    .texOffs(0, 0)
		    .addBox(-3.0F, -2.5F, -3.0F, 6.0F, 2.0F, 6.0F, new CubeDeformation(0.0F))
		    .texOffs(0, 9)
		    .addBox(-2.5F, -1.0F, -2.5F, 5.0F, 1.0F, 5.0F, new CubeDeformation(0.0F))
		    .texOffs(0, 9)
		    .addBox(-2.5F, -3.0F, -2.5F, 5.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.ZERO);
