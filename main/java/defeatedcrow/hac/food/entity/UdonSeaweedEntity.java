...
public class UdonSeaweedEntity extends FoodEntityBase {

	public UdonSeaweedEntity(World worldIn) {
		super(worldIn);
		this.setSize(0.5F, 0.3F);
	}

	public UdonSeaweedEntity(World worldIn, double posX, double posY, double posZ) {
		super(worldIn, posX, posY, posZ);
		this.setSize(0.5F, 0.3F);
	}

	public UdonSeaweedEntity(World worldIn, double posX, double posY, double posZ, @Nullable EntityPlayer player) {
	...
	protected ItemStack[] drops() {
		return new ItemStack[] { new ItemStack(FoodInit.udon, 1, 1), new ItemStack(FoodInit.udon, 1, 1) };
	}
