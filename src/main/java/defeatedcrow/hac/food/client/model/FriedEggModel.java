...
public class FriedEggModel<T extends Entity> extends EntityModel<T> {

	private final ModelPart bowl;

	public FriedEggModel(ModelPart root) {
	...
	public static LayerDefinition createEggLayer() {
		...
		PartDefinition meal = bowl.addOrReplaceChild("meal", CubeListBuilder.create()
		    .texOffs(0, 19)
		    .addBox(-3.0F, -1.8F, -1.5F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
		    .texOffs(0, 13)
		    .addBox(-1.0F, -2.0F, -2.5F, 4.0F, 1.0F, 5.0F, new CubeDeformation(0.0F))
		    .texOffs(9, 21)
		    .addBox(-2.0F, -1.8F, 2.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		    .texOffs(9, 19)
		    .addBox(0.0F, -1.8F, -3.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		    .texOffs(13, 13)
		    .addBox(-0.5F, -2.5F, -0.5F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		    .texOffs(0, 25)
		    .addBox(-3.5F, -1.5F, -3.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.ZERO);

		PartDefinition cube_r5 = bowl.addOrReplaceChild("cube_r5", CubeListBuilder.create()
		    .texOffs(15, 26)
		    .addBox(-3.3F, -1.5F, 1.5F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.1745F, 0.0F));

		PartDefinition cube_r6 = bowl.addOrReplaceChild("cube_r6", CubeListBuilder.create()
		    .texOffs(9, 25)
		    .addBox(-3.5F, 0.0F, -5.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.4363F, 0.0F, 0.0F));

		PartDefinition cube_r7 = bowl.addOrReplaceChild("cube_r7", CubeListBuilder.create()
		    .texOffs(9, 25)
		    .addBox(-0.5F, 0.0F, -4.5F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.4363F, 0.1745F, 0.0F));

		PartDefinition cube_r8 = bowl.addOrReplaceChild("cube_r8", CubeListBuilder.create()
		    .texOffs(9, 25)
		    .mirror()
		    .addBox(-0.5F, 0.0F, -5.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		    .mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.4363F, 3.1416F, 0.0F));
