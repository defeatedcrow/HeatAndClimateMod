...
public class QuichePotatoEntity extends FoodEntityBase {

	public QuichePotatoEntity(World worldIn) {
		super(worldIn);
		this.setSize(0.75F, 0.25F);
	}

	public QuichePotatoEntity(World worldIn, double posX, double posY, double posZ) {
		super(worldIn, posX, posY, posZ);
		this.setSize(0.75F, 0.25F);
	}

	public QuichePotatoEntity(World worldIn, double posX, double posY, double posZ, @Nullable EntityPlayer player) {
