...
public class ContainerHopperFilter extends Container {

	public final TileHopperFilter tile;
	public final InventoryPlayer playerInv;

	public ContainerHopperFilter(TileHopperFilter chest, EntityPlayer player) {
		this.tile = chest;
