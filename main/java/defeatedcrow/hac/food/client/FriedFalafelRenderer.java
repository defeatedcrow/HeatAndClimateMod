...
public class FriedFalafelRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/fried_falafel.png");
	private static final ModelDeepFry MODEL = new ModelDeepFry(false);

	public FriedFalafelRenderer(RenderManager renderManager) {
		super(renderManager);
	}
