...
public class SimmeredSpinachRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate", "textures/entity/food/simmered_spinach.png");
	private static final ModelSimmered MODEL = new ModelSimmered(false);

	public SimmeredSpinachRenderer(RenderManager renderManager) {
		super(renderManager);
	}
