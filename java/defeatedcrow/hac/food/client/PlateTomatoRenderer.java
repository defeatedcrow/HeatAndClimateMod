...
public class PlateTomatoRenderer extends DCRenderFoodBase<SoupPlateEntity> {
	...
	@Override
	public void doRender(SoupPlateEntity entity, double x, double y, double z, float yaw, float partialTicks) {
