...
import defeatedcrow.hac.machine.client.model.ModelCrusher;
...
public class CrusherTESR extends DCTorqueTESRBase {

	@Override
	protected String getTexPass(int i) {
		return "dcs_climate:textures/tiles/roller_crusher.png";
	}

	private static final DCTileModelBase MODEL = new ModelCrusher();
