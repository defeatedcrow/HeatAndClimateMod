...
public class CropBlockPeas extends ClimateCropBaseBlock {
	...
	public ItemLike getSeedItem(CropTier t) {
		return switch (t) {
		case COMMON -> FoodInit.BLOCK_PE_GARBANZO.get();
		case RARE -> FoodInit.BLOCK_PE_SOY.get();
		case EPIC -> FoodInit.BLOCK_PE_ADZUKI.get();
		default -> FoodInit.BLOCK_PE_GREEN.get();
		};
	}
	...
	public Item getCropItem(CropTier t) {
		return switch (t) {
		case COMMON -> FoodInit.CROP_PE_GARBANZO.get();
		case RARE -> FoodInit.CROP_PE_SOY.get();
		case EPIC -> FoodInit.CROP_PE_ADZUKI.get();
		default -> FoodInit.CROP_PE_GREEN.get();
		};
	}
	...
	public Optional<Block> getMutationTarget(CropTier t) {
		return switch (t) {
		case WILD -> Optional.of(FoodInit.BLOCK_PE_GREEN.get());
		case COMMON -> Optional.of(FoodInit.BLOCK_PE_GARBANZO.get());
		case RARE -> Optional.of(FoodInit.BLOCK_PE_SOY.get());
		case EPIC -> Optional.of(FoodInit.BLOCK_PE_ADZUKI.get());
	...
	public List<String> getGeneratedBiomeTag(CropTier t) {
		return switch (t) {
		case WILD -> ImmutableList.of("COLD", "FOREST");
		case COMMON -> ImmutableList.of("SAVANNA", "HOT");
	...
	public List<String> getAvoidBiomeTag(CropTier t) {
		return switch (t) {
		case WILD -> ImmutableList.of("HOT", "CONIFEROUS");
