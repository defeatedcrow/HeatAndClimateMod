...
public class EntityDesktopAccessories_F extends DCEntityBase {

	public EntityDesktopAccessories_F(World worldIn) {
		super(worldIn);
	...
	public EntityDesktopAccessories_F(World worldIn, double posX, double posY, double posZ) {
		this(worldIn);
	...
	protected ItemStack drops() {
		return new ItemStack(MainInit.desktopAccessories, 1, 5);
	}
	...
	public boolean processInitialInteract(EntityPlayer player, EnumHand hand) {
		...
		if (MainUtil.isHeldItem(new ItemStack(MainInit.colorChanger), player)) {
			Entity change = new EntityDesktopAccessories_G(player.getEntityWorld());
