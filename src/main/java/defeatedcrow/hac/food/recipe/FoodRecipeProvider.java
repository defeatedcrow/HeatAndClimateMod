...
public class FoodRecipeProvider extends RecipeProvider {
	...
	static void foodRecipes(Consumer<FinishedRecipe> cons) {
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.BREAD_ROUND_RAW_ITEM.get(), 3)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.BREAD_SQUARE_RAW_ITEM.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.BREAD_CORN_RAW_ITEM.get(), 3)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.BREAD_NUTS_RAW_ITEM.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.DOUGH))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.BREAD_CINNAMON_RAW_ITEM.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.DOUGH))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.BREAD_ANKO_RAW_ITEM.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.DOUGH))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.BREAD_CREAM_RAW_ITEM.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.DOUGH))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.BREAD_SAUSAGE_RAW_ITEM.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.DOUGH))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.SANDWICH_FRUIT_ITEM.get(), 3)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.SANDWICH_MARMALADE_ITEM.get(), 3)
		    .requires(Ingredient.of(TagDC.ItemTag.BREAD))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.SANDWICH_EGG_ITEM.get(), 3)
		    .requires(Ingredient.of(TagDC.ItemTag.BREAD))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.SANDWICH_SALAD_ITEM.get(), 3)
		    .requires(Ingredient.of(TagDC.ItemTag.BREAD))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.SANDWICH_SALMON_ITEM.get(), 3)
		    .requires(Ingredient.of(TagDC.ItemTag.BREAD))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.TACO_MEAT.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.TACO_AVOCADO.get(), 1)
		    .requires(Ingredient.of(FoodInit.BREAD_TORTILLA_BAKED_ITEM.get()))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_AVOCADO))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.TACO_FISH.get(), 1)
		    .requires(Ingredient.of(FoodInit.BREAD_TORTILLA_BAKED_ITEM.get()))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.PIZZA_TOMATO_RAW_ITEM.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.PIZZA_MARGHERITA_RAW_ITEM.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.PIZZA_ROMANA_RAW_ITEM.get(), 1)
		    .requires(Ingredient.of(FoodInit.PIZZA_TOMATO_RAW_ITEM.get()))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_BASIL))
		    .requires(Ingredient.of(TagDC.ItemTag.CHEESE))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.PIZZA_TONNO_RAW_ITEM.get(), 1)
		    .requires(Ingredient.of(FoodInit.PIZZA_TOMATO_RAW_ITEM.get()))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_ONIONS))
		    .requires(Ingredient.of(TagDC.ItemTag.CHEESE))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_OLIVE))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.PIZZA_SAUSAGE_RAW_ITEM.get(), 1)
		    .requires(Ingredient.of(FoodInit.PIZZA_TOMATO_RAW_ITEM.get()))
		    .requires(Ingredient.of(TagDC.ItemTag.COOKED_SAUSAGE))
		    .requires(Ingredient.of(TagDC.ItemTag.CHEESE))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.PIZZA_MENTAI_RAW_ITEM.get(), 1)
		    .requires(Ingredient.of(FoodInit.BREAD_FLAT_RAW_ITEM.get()))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.CAKE_BUTTER.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.DUST_BREAD_GRAINS))
		    .requires(Ingredient.of(TagDC.ItemTag.SUGARS))
		    .requires(Ingredient.of(Tags.Items.EGGS))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.CAKE_BERRY.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.CAKE_CHOCOLATE.get(), 1)
		    .requires(Ingredient.of(FoodInit.CAKE_BUTTER.get()))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.CAKE_GREENTEA.get(), 1)
		    .requires(Ingredient.of(FoodInit.CAKE_BUTTER.get()))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.CAKE_LEMON.get(), 1)
		    .requires(Ingredient.of(FoodInit.CAKE_BUTTER.get()))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.WAGASHI_BOTA.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.WAGASHI_KUSA.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.RICE_CAKE))
		    .requires(Ingredient.of(TagDC.ItemTag.ANKO))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.WAGASHI_SAKURA.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.RICE_CAKE))
		    .requires(Ingredient.of(TagDC.ItemTag.ANKO))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.WAGASHI_DAIHUKU.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.RICE_CAKE))
		    .requires(Ingredient.of(TagDC.ItemTag.ANKO))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.STICK_BEEF_RAW.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.STICK_PORK_RAW.get(), 1)
		    .requires(Ingredient.of(Tags.Items.RODS_WOODEN))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.STICK_MUTTON_RAW.get(), 1)
		    .requires(Ingredient.of(Tags.Items.RODS_WOODEN))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.STICK_CHICKEN_RAW.get(), 1)
		    .requires(Ingredient.of(Tags.Items.RODS_WOODEN))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.STICK_OFFAL_RAW.get(), 1)
		    .requires(Ingredient.of(Tags.Items.RODS_WOODEN))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.STICK_FISH_RAW.get(), 1)
		    .requires(Ingredient.of(Tags.Items.RODS_WOODEN))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.STICK_CORN_RAW.get(), 1)
		    .requires(Ingredient.of(Tags.Items.RODS_WOODEN))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.SWEETPOTATO_RAW.get(), 1)
		    .requires(Ingredient.of(Items.PAPER))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.PLATE_BEEF_RAW.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.RAW_BEEF))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_VEGETABLES))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.PLATE_MEAT_RAW.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.RAW_PORK))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_VEGETABLES))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_TUBERS))
		    .unlockedBy("has_pork", has(TagDC.ItemTag.RAW_PORK))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.PLATE_LEGS_RAW.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.RAW_CHICKEN))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_VEGETABLES))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_TUBERS))
		    .unlockedBy("has_chicken", has(TagDC.ItemTag.RAW_CHICKEN))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.PLATE_GARLIC_RAW.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.RAW_BEEF))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_GARLIC))
		    .requires(Ingredient.of(TagDC.ItemTag.BUTTER))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.PLATE_CHICKEN_BIG_RAW.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.RAW_CHICKEN))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.PLATE_FISH_RAW.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.RAW_EDIBLE_FISH))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_VEGETABLES))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_TUBERS))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.PLATE_BONE_MARROW_RAW.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.PLATE_STUFFED_BELL_RAW.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_BELL))
		    .requires(Ingredient.of(TagDC.ItemTag.STAFFING))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.PLATE_STUFFED_PAPRIKA_RAW.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_PAPRIKA))
		    .requires(Ingredient.of(TagDC.ItemTag.STAFFING))
		    .requires(Ingredient.of(TagDC.ItemTag.ALL_RAW_MEAT))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.PLATE_PUMPKIN_RAW.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_PUMPKIN))
		    .requires(Ingredient.of(TagDC.ItemTag.STAFFING))
		    .requires(Ingredient.of(TagDC.ItemTag.ALL_RAW_MEAT))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.PLATE_POTATO_RAW.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_TUBERS))
		    .requires(Ingredient.of(TagDC.ItemTag.PLANT_OIL))
		    .requires(Ingredient.of(TagDC.ItemTag.CHEESE))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.TART_APPLE_RAW_ITEM.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.TART_PEACH_RAW_ITEM.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.PASTRY))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.TART_BERRY_RAW_ITEM.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.PASTRY))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_BERRY))
		    .requires(Ingredient.of(TagDC.ItemTag.FOOD_FAT))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_NUTS))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.TART_LEMON_RAW_ITEM.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.PASTRY))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_LEMON))
		    .requires(Ingredient.of(TagDC.ItemTag.FOOD_FAT))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_NUTS))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.TART_COCOA_RAW_ITEM.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.PASTRY))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_COCOA))
		    .requires(Ingredient.of(TagDC.ItemTag.FOOD_FAT))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_NUTS))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.TART_PISTACHIO_RAW_ITEM.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.PASTRY))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.TART_QUICHE_RAW_ITEM.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.PASTRY))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_TOMATO))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_GREEN_LEAFS))
		    .requires(Ingredient.of(TagDC.ItemTag.ALL_RAW_MEAT))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.CASSEROLE_SHEPHERDS_PIE_RAW_ITEM.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_TUBERS))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.CASSEROLE_GRATIN_SHRIMP_RAW_ITEM.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.CASSEROLE_GRATIN_ONION_RAW_ITEM.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.CASSEROLE_DORIA_RAW_ITEM.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.CASSEROLE_MOUSSAKA_RAW_ITEM.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.CASSEROLE_PARMIGIANA_RAW_ITEM.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_EGGPLANT))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_TOMATO))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_ONIONS))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_GARLIC))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.CASSEROLE_JANSSONS_FRESTELESE_RAW_ITEM.get(), 1)
		    .requires(Ingredient.of(FoodInit.FOOD_ANCHOVY.get()))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_TUBERS))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_ONION))
		    .requires(Ingredient.of(TagDC.ItemTag.CREAMS))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.CASSEROLE_STUFFING_RAW_ITEM.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.BASESOUP))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_BEANS))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.OATMEAL_MILK.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.MILKS))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.MUESLI.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.MILKS))
		    .requires(Ingredient.of(TagDC.ItemTag.DUST_OAT))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_NUTS))
		    .requires(
		        Ingredient.of(TagDC.ItemTag.CROP_FRUITS))
		    .unlockedBy("has_oat", has(TagDC.ItemTag.CROP_OAT))
		    .save(cons, "dcs_climate:food/muesli_oat");

		ShapelessRecipeBuilder
		    .shapeless(FoodInit.RICE_NAPA.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.BOILED_RICE))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_NAPA))
		    .requires(Ingredient.of(TagDC.ItemTag.DUST_SALT))
		    .unlockedBy(
		        "has_boiled_rice", has(TagDC.ItemTag.BOILED_RICE))
		    .save(cons, "dcs_climate:food/nameshi_0");

		ShapelessRecipeBuilder
		    .shapeless(FoodInit.RICE_FISH.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.BOILED_RICE))
		    .requires(Ingredient.of(TagDC.ItemTag.COOKED_FISH))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.CHAZUKE_UME.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.BOILED_RICE))
		...
		ShapelessRecipeBuilder
		    ...
		    .requires(Ingredient.of(FoodInit.FOOD_UMEBOSHI.get()))
		    .requires(
		        Ingredient.of(FoodInit.FOOD_TSUKEMONO.get()))
		    .unlockedBy("has_boiled_rice", has(TagDC.ItemTag.BOILED_RICE))
		    .save(cons, "dcs_climate:food/ume_chazuke_2");

		ShapelessRecipeBuilder
		    .shapeless(FoodInit.CHAZUKE_SAKE.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.BOILED_RICE))
		    .requires(Ingredient.of(FoodInit.TEA_GREEN.get()))
		    .requires(Ingredient.of(TagDC.ItemTag.COOKED_SALMON))
		    .requires(
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.CHAZUKE_TAI.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.BOILED_RICE))
		    .requires(Ingredient.of(FoodInit.TEA_GREEN.get()))
		    .requires(Ingredient.of(TagDC.ItemTag.SEABREAM))
		    .requires(
		        Ingredient.of(TagDC.ItemTag.CROP_SESAMI))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.CHAZUKE_TARAKO.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.BOILED_RICE))
		    .requires(Ingredient.of(FoodInit.TEA_GREEN.get()))
		    .requires(Ingredient.of(TagDC.ItemTag.ROE))
		    .requires(
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.SOUP_GASPACHO.get(), 3)
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_TOMATO))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.SOUP_TARATOR.get(), 3)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.KOBACHI_NAMASU.get(), 3)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.SASHIMI_WHITE.get(), 2)
		    .requires(Ingredient.of(TagDC.ItemTag.FISH_WHITE))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_LEEKS))
		    .unlockedBy("has_white_fish", has(TagDC.ItemTag.FISH_WHITE))
		    .save(
		...
		ShapelessRecipeBuilder
		    ...
		    .unlockedBy("has_white_fish",
		        has(TagDC.ItemTag.FISH_WHITE))
		    .save(cons, "dcs_climate:food/sashimi_white_2");

		ShapelessRecipeBuilder
		    .shapeless(FoodInit.SASHIMI_SALMON.get(), 2)
		    .requires(Ingredient.of(TagDC.ItemTag.RAW_SALMON))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_LEEKS))
		    .unlockedBy("has_salmon_fish",
		        has(TagDC.ItemTag.RAW_SALMON))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.SASHIMI_BLUE.get(), 2)
		    .requires(Ingredient.of(TagDC.ItemTag.FISH_BLUE))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_LEEKS))
		    .unlockedBy("has_blue_fish", has(TagDC.ItemTag.FISH_BLUE))
		    .save(cons,
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.SASHIMI_TUNA.get(), 3)
		    .requires(Ingredient.of(TagDC.ItemTag.TUNA))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_LEEKS))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.SASHIMI_SQUID.get(), 2)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.CURRY_RICE.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.SALAD_SIMPLE.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_GREEN_LEAFS))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_GREEN_LEAFS))
		    .unlockedBy("has_green_leaves",
		        has(TagDC.ItemTag.CROP_GREEN_LEAFS))
		    .save(cons, "dcs_climate:food/salad_simple_0");

		ShapelessRecipeBuilder
		    .shapeless(FoodInit.SALAD_GREEN.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_GREEN_LEAFS))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_EDIBLE_RAW_VEGGIE))
		    .requires(
		        Ingredient.of(TagDC.ItemTag.CROP_TOMATO))
		    .unlockedBy("has_green_leaves", has(TagDC.ItemTag.CROP_GREEN_LEAFS))
		    .save(cons, "dcs_climate:food/salad_green_0");

		ShapelessRecipeBuilder
		    .shapeless(FoodInit.SALAD_POTATO.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_GREEN_LEAFS))
		    .requires(Ingredient.of(Tags.Items.EGGS))
		    .requires(Ingredient.of(Items.BAKED_POTATO))
		    .unlockedBy(
		        "has_green_leaves", has(TagDC.ItemTag.CROP_GREEN_LEAFS))
		    .save(cons, "dcs_climate:food/salad_potato_0");

		ShapelessRecipeBuilder
		    .shapeless(FoodInit.SALAD_NUTS.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_GREEN_LEAFS))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_NUTS))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_BEANS))
		    .unlockedBy(
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.SALAD_CITRUS.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_GREEN_LEAFS))
		    .requires(Ingredient.of(Tags.Items.CROPS_CARROT))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_CITRUS))
		    .unlockedBy(
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.SALAD_MELON.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_GREEN_LEAFS))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.SALAD_SALMON.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_GREEN_LEAFS))
		    .requires(Ingredient.of(TagDC.ItemTag.RAW_SALMON))
		    .requires(
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.SALAD_TOFU.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_GREEN_LEAFS))
		...
		ShapedRecipeBuilder
		    ...
		    .unlockedBy(
		        "has_dust_wheat", has(TagDC.ItemTag.DUST_WHEAT))
		    .save(cons, "dcs_climate:core/cake_hac_recipe");

		ShapedRecipeBuilder
		    .shaped(Items.COOKIE, 4)
		    .pattern("XYX")
		...
		// drink
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.DRINK_APPLE_SODA.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.DRINK_BERRY_SODA.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.DRINK_MELON_SODA.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.DRINK_GRAPE_SODA.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.DRINK_GRAPE_WHITE_SODA.get(), 1)
		    .requires(FoodInit.DRINK_GRAPE_WHITE.get())
		    .requires(TagDC.ItemTag.SPARKLING)
		    .group("drink_craft")
		    .unlockedBy("has_sparkling",
		        has(TagDC.ItemTag.SPARKLING))
		    .save(cons, "dcs_climate:core/drink_grape_white_soda_0");

		ShapelessRecipeBuilder
		    .shapeless(FoodInit.DRINK_PLUM_SODA.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.DRINK_PEACH_SODA.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.DRINK_GUAVA_SODA.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.DRINK_MANGO_SODA.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.DRINK_CITRUS_SODA.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.DRINK_TEA_SODA.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.DRINK_LASSI_PLANE.get(), 1)
		    .requires(TagDC.ItemTag.YOGULT)
		    .requires(TagDC.ItemTag.WATER)
		    .requires(TagDC.ItemTag.SUGARS)
		    .group("drink_craft")
		    .unlockedBy("has_yogult",
		        has(TagDC.ItemTag.YOGULT))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.DRINK_LASSI_MANGO.get(), 1)
		    .requires(TagDC.ItemTag.YOGULT)
		    .requires(TagDC.ItemTag.WATER)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.DRINK_LASSI_CITRUS.get(), 1)
		    .requires(TagDC.ItemTag.YOGULT)
		    .requires(TagDC.ItemTag.WATER)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.TEA_BLACK_LEMON.get(), 1)
		    .requires(FoodInit.TEA_BLACK.get())
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.TEA_MALLOW_LEMON.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.TEA_BLACK_MILK.get(), 1)
		    .requires(FoodInit.TEA_BLACK.get())
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.TEA_APPLE_MILK.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.TEA_BERRY_MILK.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.TEA_GREEN_MILK.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.TEA_BLUE_MILK.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.TEA_COCOA_MILK.get(), 1)
	...
	static void mortarRecipes(Consumer<FinishedRecipe> cons) {
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.FOOD_WHEAT.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.FOOD_HONEY.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.CROP_CN_CINNAMON.get(), 1)
		    .requires(FoodInit.LOG_CN_CINNAMON.get())
		    .requires(CoreInit.MORTAR.get())
		    .group("crusher_mortar")
		    .unlockedBy("has_log_cinnamon",
		        has(FoodInit.LOG_CN_CINNAMON.get()))
		    .save(cons, "dcs_climate:core/mortar_cinnamon");

		ShapelessRecipeBuilder
		    .shapeless(FoodInit.FIBER_WOOD.get(), 3)
		...
		ShapedRecipeBuilder
		    .shaped(FoodInit.STRING_PLANT.get(), 4)
		    .pattern("XXX")
		    .pattern("XYX")
		    .pattern("XXX")
		    ...
		    .group("hand_spindle")
		    .unlockedBy(
		        "has_fiber_plant", has(TagDC.ItemTag.FIBER_PLANT))
		    .save(cons, "dcs_climate:core/spindle_string_plant");

		ShapedRecipeBuilder
		    .shaped(FoodInit.STRING_TREE.get(), 4)
		    .pattern("XXX")
		    .pattern("XYX")
		    .pattern("XXX")
		    ...
		    .define('Y', CoreInit.HAND_SPINDLE.get())
		    .group("hand_spindle")
		    .unlockedBy("has_fiber_wood",
		        has(TagDC.ItemTag.FIBER_WOOD))
		    .save(cons, "dcs_climate:core/spindle_string_wood");

		ShapedRecipeBuilder
		    .shaped(FoodInit.STRING_COTTON.get(), 4)
		    .pattern("XXX")
		    .pattern("XYX")
		    .pattern("XXX")
		    ...
		    .define('Y', CoreInit.HAND_SPINDLE.get())
		    .group("hand_spindle")
		    .unlockedBy("has_cotton",
		        has(TagDC.ItemTag.CROP_COTTON))
		    .save(cons, "dcs_climate:core/spindle_string_cotton");

		ShapelessRecipeBuilder
		    .shapeless(FoodInit.STRING_WOOL.get(), 2)
		...
		ShapedRecipeBuilder
		    .shaped(FoodInit.STRING_WOOL.get(), 4)
		    .pattern(" X ")
		    .pattern("XYX")
		    .pattern(" X ")
	...
	static void materialRecipes(Consumer<FinishedRecipe> cons) {
		...
		ShapedRecipeBuilder
		    .shaped(FoodInit.CLOTH_COTTON.get(), 1)
		    .pattern(" X ")
		    .pattern("X X")
		    .pattern(" X ")
		...
		ShapedRecipeBuilder
		    .shaped(FoodInit.CLOTH_WOOL.get(), 1)
		    .pattern(" X ")
		    .pattern("X X")
		    .pattern(" X ")
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.PLANK_CN_CAMPHOR.get(), 4)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.PLANK_MR_MULBERRY.get(), 4)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.PLANK_SU_LACQUER.get(), 4)
		...
		ShapedRecipeBuilder
		    .shaped(FoodInit.PLANK_RE_SORGHUM.get(), 1)
		    .pattern("XX")
		    .pattern("XX")
		...
		ShapedRecipeBuilder
		    ...
		    .unlockedBy("has_lacquer_sap",
		        has(TagDC.ItemTag.SAP_LACQUER))
		    .save(cons, "dcs_climate:food/lacquerware_planks");

		ShapedRecipeBuilder
		    .shaped(Items.CANDLE, 1)
		    .pattern("X")
		    .pattern("Y")
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.FERTILIZER_MIXED.get(), 4)
		    .requires(Ingredient.of(TagDC.ItemTag.DUST_NITER))
		    .requires(Ingredient.of(TagDC.ItemTag.FISH_POWDER))
		    .requires(Ingredient.of(TagDC.ItemTag.DUST_ASH))
		    .unlockedBy(
		        "has_dust_niter", has(TagDC.ItemTag.DUST_NITER))
		    .save(cons, "dcs_climate:food/craft_fertilizer_mixed4");

		ShapelessRecipeBuilder
		    .shapeless(FoodInit.BIOMASS_PELLET.get(), 2)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.CONT_LOG_RAW_BRIQUET.get(), 2)
		...
		ShapelessRecipeBuilder
		    ...
		    .unlockedBy("has_dust_niter",
		        has(TagDC.ItemTag.DUST_NITER))
		    .save(cons, "dcs_climate:core/gunpowder_another_0");

		ShapedRecipeBuilder
		    .shaped(FoodInit.FERTILE_PLANTER.get(), 1)
		    .pattern("YXY")
		    .pattern("YYY")
		...
		ShapedRecipeBuilder
		    .shaped(FoodInit.FERTILE_PLANTER_GEM.get(), 1)
		    .pattern("YXY")
		    .pattern("YYY")
		    .define('X', ItemTags.DIRT)
		...
		ShapedRecipeBuilder
		    .shaped(FoodInit.MEAL_FEEDER.get(), 1)
		    .pattern("YXY")
		    .pattern("YYY")
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.FOOD_PASTRY.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.DUST_WHEAT))
		    .requires(Ingredient.of(TagDC.ItemTag.FOOD_FAT))
		    .requires(Ingredient.of(Tags.Items.EGGS))
		    .requires(
		        Ingredient.of(TagDC.ItemTag.DUST_SALT))
		    .unlockedBy("has_dust_wheat", has(TagDC.ItemTag.DUST_WHEAT))
		    .save(cons, "dcs_climate:food/foodmaterial_pastry");

		ShapelessRecipeBuilder
		    .shapeless(FoodInit.NOODLE_PASTA.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.DUST_WHEAT))
		    .requires(Ingredient.of(TagDC.ItemTag.WATER))
		    .unlockedBy("has_dust_wheat", has(TagDC.ItemTag.DUST_WHEAT))
		    .save(cons,
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.NOODLE_WHEAT.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.DUST_WHEAT))
		    .requires(Ingredient.of(TagDC.ItemTag.WATER))
		    .requires(Ingredient.of(TagDC.ItemTag.DUST_SALT))
		    .unlockedBy(
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.NOODLE_BRINE.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.DUST_WHEAT))
		    .requires(Ingredient.of(TagDC.ItemTag.WATER))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.NOODLE_BUCKWHEAT.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.DUST_BUCKWHEAT))
		    .requires(Ingredient.of(TagDC.ItemTag.DUST_WHEAT))
		    .requires(Ingredient.of(TagDC.ItemTag.WATER))
		    .unlockedBy(
		        "has_dust_buckwheat", has(TagDC.ItemTag.DUST_BUCKWHEAT))
		    .save(cons, "dcs_climate:food/foodmaterial_buckwheat_noodle");

		ShapelessRecipeBuilder
		    .shapeless(FoodInit.NOODLE_RICE.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.DUST_RICES))
		    .requires(Ingredient.of(TagDC.ItemTag.WATER))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.FOOD_MOCHI.get(), 2)
		    .requires(Ingredient.of(TagDC.ItemTag.BOILED_RICE))
		    .requires(Ingredient.of(TagDC.ItemTag.BOILED_RICE))
		    .unlockedBy("has_boiled_rices",
		        has(TagDC.ItemTag.BOILED_RICE))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.FOOD_BUTTER.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.CREAM))
		    .requires(Ingredient.of(TagDC.ItemTag.DUST_SALT))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.FOOD_MARGARINE.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.PLANT_OIL))
		    .requires(Ingredient.of(TagDC.ItemTag.DUST_SALT))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.FOOD_MAKOMOTAKE.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.RAW_SAUSAGE.get(), 3)
		    .requires(Ingredient.of(TagDC.ItemTag.RAW_MEAT))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_HERBS))
		    .requires(Ingredient.of(TagDC.ItemTag.OFFAL))
		    .unlockedBy("has_offal",
		        has(TagDC.ItemTag.OFFAL))
		    .save(cons, "dcs_climate:food/raw_sausage_meat");

		ShapelessRecipeBuilder
		    .shapeless(FoodInit.RAW_SAUSAGE.get(), 2)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.RAW_SAUSAGE.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_HERBS))
		    .requires(Ingredient.of(TagDC.ItemTag.OFFAL))
		    .unlockedBy("has_offal", has(TagDC.ItemTag.OFFAL))
		    .save(cons,
		...
		ShapelessRecipeBuilder
		    ...
		    .requires(Ingredient.of(TagDC.ItemTag.PLANT_OIL))
		    .unlockedBy(
		        "has_white_fish", has(TagDC.ItemTag.FISH_WHITE))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.FOOD_ROE.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.FOOD_MAYONNAISE.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.VINEGAR))
		    .requires(Ingredient.of(TagDC.ItemTag.PLANT_OIL))
		    .requires(Ingredient.of(Tags.Items.EGGS))
		    .unlockedBy("has_eggs",
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.FOOD_HERB_SALT.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.DUST_SALT))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_HERBS))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_SPICES))
		    .unlockedBy(
		        "has_salt", has(TagDC.ItemTag.DUST_SALT))
		    .save(cons, "dcs_climate:food/foodmaterial_herb_salt");

		ShapelessRecipeBuilder
		    .shapeless(FoodInit.FOOD_MIXED_SPICES.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_CARDAMOM))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_CINNAMON))
		    .requires(
		        Ingredient.of(TagDC.ItemTag.CROP_CLOVE))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_GINGER))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_CHILI))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.FOOD_SPARKLING.get(), 4)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.FOOD_PLANT_OIL.get(), 4)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.FOOD_HONEY.get(), 4)
		...
		// leaves
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.CONT_LEAVES.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.CONT_FALLEN_LEAVES.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.CONT_WASTE.get(), 1)
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.FEED_COMPOUND.get(), 3)
		    .requires(Ingredient.of(TagDC.ItemTag.PRESS_CAKE))
		...
		ShapelessRecipeBuilder
		    .shapeless(FoodInit.FEED_COMPOUND.get(), 5)
		    .requires(Ingredient.of(TagDC.ItemTag.PRESS_CAKE))
		    .requires(Ingredient.of(TagDC.ItemTag.BRAN))
	...
	static void copperRecipes(Consumer<FinishedRecipe> cons) {
		ShapelessRecipeBuilder
		    .shapeless(Blocks.COPPER_BLOCK, 1)
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_CITRUS))
		...
		ShapelessRecipeBuilder
		    .shapeless(Blocks.CUT_COPPER_SLAB, 1)
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_CITRUS))
		...
		ShapelessRecipeBuilder
		    .shapeless(Blocks.CUT_COPPER_STAIRS, 1)
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_CITRUS))
		...
		ShapelessRecipeBuilder
		    .shapeless(Blocks.WAXED_COPPER_BLOCK, 1)
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_CITRUS))
		...
		ShapelessRecipeBuilder
		    .shapeless(Blocks.WAXED_CUT_COPPER, 1)
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_CITRUS))
		...
		ShapelessRecipeBuilder
		    .shapeless(Blocks.WAXED_CUT_COPPER_SLAB, 1)
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_CITRUS))
		...
		ShapelessRecipeBuilder
		    .shapeless(Blocks.WAXED_CUT_COPPER_STAIRS, 1)
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_CITRUS))
	...
	private static void woodRecipes(Consumer<FinishedRecipe> cons, PlantRecipes.Wood wood) {
		...
		if (wood.logBlock().get() != null) {
			ShapelessRecipeBuilder
			    .shapeless(wood.plankBlock().get(), 4)
			    .requires(wood.logBlock().get())
			    .unlockedBy("has_" + wood.name() + "_log", has(
			        wood.logBlock().get()))
			    .save(cons, "dcs_climate:food/planks_" + wood.name());
		}

		ShapedRecipeBuilder
		    .shaped(wood.stairsBlock().get(), 4)
		    .pattern("X  ")
		    .pattern("XX ")
		    .pattern("XXX")
		    .define('X', wood.plankBlock().get())
		    .unlockedBy("has_" + wood.name() + "_planks", has(
		        wood.plankBlock().get()))
		    .save(cons,
		...
		ShapedRecipeBuilder
		    .shaped(wood.slimStairsBlock().get(), 3)
		    .pattern("X  ")
		    .pattern("YX ")
		    .pattern(" YX")
		    .define('X', wood.plankBlock().get())
		...
		ShapedRecipeBuilder
		    .shaped(wood.fenceBlock().get(), 6)
		    .pattern("XYX")
		    .pattern("XYX")
		    .define('X', wood.plankBlock().get())
		    .define('Y', Tags.Items.RODS_WOODEN)
		    .unlockedBy("has_" + wood.name() + "_planks",
		        has(wood.plankBlock().get()))
		    .save(cons, "dcs_climate:build/fence2_" + wood.name());

		if (wood.doorBlock().get() != null) {
			ShapedRecipeBuilder
			    .shaped(wood.doorBlock().get(), 3)
			    .pattern("XX")
			    .pattern("XX")
			    .pattern("XX")
			    .define('X', wood.plankBlock().get())
		...
		if (wood.trapdoorBlock().get() != null) {
			ShapedRecipeBuilder
			    .shaped(wood.trapdoorBlock().get(), 3)
			    .pattern("XXX")
			    .pattern("XXX")
			    .define('X', wood.plankBlock().get())
			    .unlockedBy("has_" + wood.name() + "_planks", has(wood.plankBlock().get()))
	...
	static void contRecipes(Consumer<FinishedRecipe> cons, ContainerRecipes.Cont pair) {
		if (pair.inputTag().get() != TagDC.ItemTag.DUMMY) {
			...
			ShapedRecipeBuilder
			    .shaped(pair.output().get(), 1)
			    .pattern("XXX")
			    .pattern("XXX")
			    .pattern("XXX")
			    .define('X', pair.inputTag().get())
			    .unlockedBy("has_" + pair.name(), has(
			        pair.inputTag().get()))
			    .save(cons, "dcs_climate:container/cont_" + pair.name());

			ShapelessRecipeBuilder
			    .shapeless(pair.input().get(), 9)
