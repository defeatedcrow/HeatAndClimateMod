...
public class StewChiliRenderer extends DCRenderFoodBase<FoodEntityBase> {
	...
	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/stew_chili.png");
	private static final ModelStewBowl MODEL = new ModelStewBowl(false);

	public StewChiliRenderer(RenderManager renderManager) {
		super(renderManager);
	}
