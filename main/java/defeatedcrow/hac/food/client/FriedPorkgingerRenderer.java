...
import defeatedcrow.hac.food.client.model.ModelPorkGinger;
...
public class FriedPorkgingerRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/fried_porkginger.png");
	private static final ModelPorkGinger MODEL = new ModelPorkGinger(false);

	public FriedPorkgingerRenderer(RenderManager renderManager) {
		super(renderManager);
	}
