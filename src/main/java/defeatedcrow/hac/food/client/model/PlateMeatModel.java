...
public class PlateMeatModel<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition steak3 = Steak.addOrReplaceChild("steak3", CubeListBuilder.create().texOffs(0, 32).mirror().addBox(-3.0F, -6.0F, -2.0F, 6.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false)
			.texOffs(0, 32).mirror().addBox(-3.0F, -4.0F, -0.3F, 6.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false)
			.texOffs(0, 32).mirror().addBox(-3.0F, -2.0F, 1.0F, 6.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 1.0F, 0.0F, 0.7854F, 1.2566F, 0.0F));
