...
public class SaladGreenRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/salad_green.png");
	private static final ModelSaladVegi MODEL = new ModelSaladVegi(false);

	public SaladGreenRenderer(RenderManager renderManager) {
		super(renderManager);
	}
