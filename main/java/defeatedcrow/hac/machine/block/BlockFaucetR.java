 ...
 */
public class BlockFaucetR extends BlockContainerDC {

	protected static final AxisAlignedBB AABB_SOUTH = new AxisAlignedBB(0.3125D, 0.25D, 0.5D, 0.6875D, 1.0D, 1.0D);
	protected static final AxisAlignedBB AABB_NORTH = new AxisAlignedBB(0.3125D, 0.25D, 0.0D, 0.6875D, 1.0D, 0.5D);
	protected static final AxisAlignedBB AABB_EAST = new AxisAlignedBB(0.5D, 0.25D, 0.3125D, 1.0D, 1.0D, 0.6875D);
	protected static final AxisAlignedBB AABB_WEST = new AxisAlignedBB(0.0D, 0.25D, 0.3125D, 0.5D, 1.0D, 0.6875D);
	protected static final AxisAlignedBB AABB_DOWN = new AxisAlignedBB(0.3125D, 0.0D, 0.3125D, 0.6875D, 1.0D, 0.6875D);

	public BlockFaucetR(String s) {
