...
import defeatedcrow.hac.machine.client.model.ModelSpinningMachine;
...
public class SpinningMachineTESR extends DCTorqueTESRBase {

	@Override
	protected String getTexPass(int i) {
		return "dcs_climate:textures/tiles/spinning_wood.png";
	}

	private static final DCTileModelBase MODEL = new ModelSpinningMachine();
