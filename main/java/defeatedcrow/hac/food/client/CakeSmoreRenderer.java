...
public class CakeSmoreRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/cake_smore.png");
	private static final ModelSmore MODEL = new ModelSmore(false);

	public CakeSmoreRenderer(RenderManager renderManager) {
		super(renderManager);
	}
