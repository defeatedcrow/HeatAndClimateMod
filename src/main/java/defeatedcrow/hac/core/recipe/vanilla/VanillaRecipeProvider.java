...
public class VanillaRecipeProvider extends RecipeProvider {
	...
	private static void alloyRecipes(Consumer<FinishedRecipe> cons, MaterialRecipes.Alloy alloy) {
		...
		ShapedRecipeBuilder.shaped(alloy.metalBlock()
		    ...
		    .pattern("XXX")
		    .pattern("XXX")
		    .define('X', alloy.ingotItem()
		        .get())
		    .group("storage_pack")
		    .unlockedBy("has_" + alloy.name() + "_ingot", has(alloy.ingotItem()
		        .get()))
	...
	private static void mortarMetalRecipes(Consumer<FinishedRecipe> cons, MaterialRecipes.Color color) {
		...
		if (color.block()
		    .get()
		    .asItem() instanceof IItemDC) {
			TagKey<Item> ore = ((IItemDC) color.block()
			    .get()
			    .asItem()).getPairTag();
			...
			ShapelessRecipeBuilder.shapeless(color.orePri()
			    ...
			    .unlockedBy("has_" + color.name() + "_ore", has(color.block()
			        .get()
			        .asItem()))
		...
		if (color.blockDeep()
		    .get()
		    .asItem() instanceof IItemDC) {
			TagKey<Item> ore = ((IItemDC) color.blockDeep()
			    .get()
			    .asItem()).getPairTag();
			...
			ShapelessRecipeBuilder.shapeless(color.oreSec()
			    ...
			    .requires(CoreInit.MORTAR.get())
			    .group("crusher_mortar")
			    .unlockedBy("has_" + color.name() + "_deepore", has(color.blockDeep()
			        .get()
			        .asItem()))
	...
	private static void mortarGemRecipes(Consumer<FinishedRecipe> cons, MaterialRecipes.Gem gem) {
		if (gem.ore()
		    .get()
		    .asItem() instanceof IItemDC) {
			TagKey<Item> ore = ((IItemDC) gem.ore()
			    .get()
			    .asItem()).getPairTag();
	...
	private static void mortarMillsRecipes(Consumer<FinishedRecipe> cons, MillsDC.Crops mill) {
		if (mill.input()
		    .get() instanceof IItemDC) {
			TagKey<Item> ore = ((IItemDC) mill.input()
			    .get()
			    .asItem()).getPairTag();
	...
	private static void mortarMiscRecipes(Consumer<FinishedRecipe> cons, MillsDC.Miscs mill) {
		if (mill.input()
			...
			ShapelessRecipeBuilder.shapeless(mill.outputPri()
			    ...
			    .requires(CoreInit.MORTAR.get())
			    .group("crusher_mortar")
			    .unlockedBy("has_" + mill.name(), has(mill.input()
			        .get()))
	...
	private static void smeltingRecipes(Consumer<FinishedRecipe> cons) {
		...
		smeltingRecipe(cons, Ingredient.of(TagDC.ItemTag.DUST_CRYSTAL), BuildInit.GLASS_CRYSTAL.get()
		    .asItem(), 200, "dust_crystal", CoreInit.DUST_CRYSTAL.get(), "has_dust_crystal");
		...
		smeltingRecipe(cons, Ingredient.of(TagDC.ItemTag.DUSTBLOCK_STEEL), Items.IRON_BLOCK, 200, "container_iron", CoreInit.DUSTBLOCK_STEEL.get()
		    .asItem(), "has_dustblock_iron");
		smeltingRecipe(cons, Ingredient.of(TagDC.ItemTag.DUSTBLOCK_BRASS), CoreInit.METALBLOCK_BRASS.get()
		    .asItem(), 200, "container_brass",
		    CoreInit.DUSTBLOCK_BRASS.get()
		        .asItem(),
		    "has_dustblock_brass");
		smeltingRecipe(cons, Ingredient.of(TagDC.ItemTag.DUSTBLOCK_BRONZE), CoreInit.METALBLOCK_BRONZE.get()
		    .asItem(), 200, "container_bronze",
		    CoreInit.DUSTBLOCK_BRONZE.get()
		        .asItem(),
		    "has_dustblock_bronze");
		smeltingRecipe(cons, Ingredient.of(TagDC.ItemTag.DUSTBLOCK_SILVER), CoreInit.METALBLOCK_SILVER.get()
		    .asItem(), 200, "container_silver",
		    CoreInit.DUSTBLOCK_SILVER.get()
		        .asItem(),
		    "has_dustblock_silver");

		// アルミ建材の還元
		smeltingRecipe(cons, Ingredient.of(BuildInit.SLAB_METAL.get()), CoreInit.INGOT_ALUMINUM.get(), 200, "reduction_slab_metal", BuildInit.SLAB_METAL.get()
		    .asItem(), "has_slab_metal");
		smeltingRecipe(cons, Ingredient.of(BuildInit.FENCE_METAL.get()), CoreInit.INGOT_ALUMINUM.get(), 200, "reduction_fence_metal", BuildInit.FENCE_METAL.get()
		    .asItem(), "has_fence_metal");
		smeltingRecipe(cons, Ingredient.of(BuildInit.LADDER_METAL.get()), CoreInit.INGOT_ALUMINUM.get(), 200, "reduction_ladder_metal", BuildInit.LADDER_METAL.get()
		    .asItem(), "has_ladder_metal");
		smeltingRecipe(cons, Ingredient.of(BuildInit.STAIRS_METAL.get()), CoreInit.INGOT_ALUMINUM.get(), 200, "reduction_stairs_metal", BuildInit.STAIRS_METAL.get()
		    .asItem(), "has_stairs_metal");
		smeltingRecipe(cons, Ingredient.of(BuildInit.STAIRS_SLIM_METAL.get()), CoreInit.INGOT_ALUMINUM.get(), 200, "reduction_slim_stairs_metal", BuildInit.STAIRS_SLIM_METAL.get()
		    .asItem(), "has_slim_stairs_metal");
		smeltingRecipe(cons, Ingredient.of(TagDC.ItemTag.ALMINUM_LOUVERS), CoreInit.INGOT_ALUMINUM.get(), 200, "reduction_louver_metal", BuildInit.LOUVER_HOL_METAL.get()
		    .asItem(), "has_louver_metal");
		smeltingRecipe(cons, Ingredient.of(TagDC.ItemTag.ALMINUM_WINDOWS), CoreInit.INGOT_ALUMINUM.get(), 200, "reduction_window_metal", BuildInit.WINDOW_SIMPLE_METAL.get()
		    .asItem(), "has_window_metal");
		smeltingRecipe(cons, Ingredient.of(TagDC.ItemTag.ALMINUM_ROOFS), CoreInit.INGOT_ALUMINUM.get(), 200, "reduction_roof_metal", BuildInit.ROOF_METAL_GRAY.get()
		    .asItem(), "has_roof_metal");
	}
