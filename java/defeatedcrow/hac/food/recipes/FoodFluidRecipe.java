...
public class FoodFluidRecipe {
	...
	static void loadCookingRecipes() {
		...
		regBoilrecipe(null, null, 0F, new FluidStack(FoodInit.coffee, 1000), null, null, false, new FluidStack(
				FluidRegistry.WATER, 1000), new Object[] {
						new ItemStack(FoodInit.teaLeaves, 1, 0)
		});

		regBoilrecipe(null, null, 0F, new FluidStack(FoodInit.greenTea, 1000), null, null, false, new FluidStack(
				FluidRegistry.WATER, 1000), new Object[] {
						new ItemStack(FoodInit.teaLeaves, 1, 1)
		});

		regBoilrecipe(null, null, 0F, new FluidStack(FoodInit.blackTea, 1000), null, null, false, new FluidStack(
				FluidRegistry.WATER, 1000), new Object[] {
						new ItemStack(FoodInit.teaLeaves, 1, 2)
		});

		regBoilrecipe(null, null, 0F, new FluidStack(FoodInit.stock, 1000), null, null, false, new FluidStack(
				FluidRegistry.WATER, 1000), new Object[] {
						"foodAnyMeat",
						"cropHerb",
						"listAllveggie"
		...
		regBoilrecipe(new ItemStack(FoodInit.bowlSoup, 3, 0), null, 0F, null, null, null, false, new FluidStack(
				FoodInit.stock, 1000), new Object[] {
						"cropOnion",
						"cropCarrot",
						"listAllveggie"
		});
		...
		regBoilrecipe(new ItemStack(FoodInit.cake, 3, 3), null, 0F, null, null, null, false, new FluidStack(
				FoodInit.coffee, 1000), new Object[] {
						"dustSugar",
						"foodCream",
						"foodAgar"
		});
		...
		regBoilrecipe(new ItemStack(FoodInit.cake, 3, 4), null, 0F, null, null, null, false, new FluidStack(
				FoodInit.cream, 1000), new Object[] {
						"dustSugar",
						"cropLemon",
						"foodAgar"
		});
