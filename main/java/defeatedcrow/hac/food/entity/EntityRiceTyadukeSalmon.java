...
public class EntityRiceTyadukeSalmon extends FoodEntityBase {

	public EntityRiceTyadukeSalmon(World worldIn) {
		super(worldIn);
		this.setSize(0.35F, 0.35F);
	}

	public EntityRiceTyadukeSalmon(World worldIn, double posX, double posY, double posZ) {
	...
	protected ItemStack[] drops() {
		return new ItemStack[] {
				new ItemStack(FoodInit.ricebowl, 1, 8),
				new ItemStack(FoodInit.ricebowl, 1, 8)
		};
	}
