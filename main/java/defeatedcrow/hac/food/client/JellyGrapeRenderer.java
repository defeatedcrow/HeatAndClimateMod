...
public class JellyGrapeRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/jelly_grape.png");
	private static final ModelJelly MODEL = new ModelJelly(false);

	public JellyGrapeRenderer(RenderManager renderManager) {
		super(renderManager);
	}
