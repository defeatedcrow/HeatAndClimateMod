...
public class MagicIceSpitRenderer extends MagicDaggerRenderer {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/magic/dagger_ice.png");

	public MagicIceSpitRenderer(RenderManager renderManager) {
		super(renderManager);
	}
