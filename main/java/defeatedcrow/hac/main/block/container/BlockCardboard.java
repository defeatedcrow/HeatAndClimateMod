...
public class BlockCardboard extends DCSidedBlock implements ITexturePath, IRapidCollectables, ICompressionRecipe {
	...
	public String[] getNameSuffix() {
		String[] name = { "beef", "pork", "chicken", "sheep", "egg", "wool" };
		return name;
	}
