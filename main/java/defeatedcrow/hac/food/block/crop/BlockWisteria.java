...
public class BlockWisteria extends BlockDC implements INameSuffix, IClimateCrop, IRapidCollectables, IGrowable {
	...
	public List<ItemStack> getCropItems(IBlockState state, int fortune) {
		...
		ret.add(new ItemStack(FoodInit.seeds, 1, 14));
		return ret;
	}
