...
public class MsgTileSimpleIntegerToS implements IPacketDC {
	...
	public MsgTileSimpleIntegerToS() {}

	public MsgTileSimpleIntegerToS(UUID i, BlockPos pos, int b) {
		id = i;
		x = pos.getX();
		y = pos.getY();
		z = pos.getZ();
	...
	public MsgTileSimpleIntegerToS(UUID i, int i1, int i2, int i3, int b) {
		id = i;
		x = i1;
		y = i2;
		z = i3;
	...
	public static MsgTileSimpleIntegerToS decode(FriendlyByteBuf buf) {
		UUID i = buf.readUUID();
		int x1 = buf.readInt();
		int y1 = buf.readInt();
		int z1 = buf.readInt();
		int b = buf.readInt();
		return new MsgTileSimpleIntegerToS(i, x1, y1, z1, b);
	}
	...
	public static void sendToServer(Player player, BlockPos pos, int b) {
		if (player != null) {
			MsgTileSimpleIntegerToS packet = new MsgTileSimpleIntegerToS(player.getUUID(), pos, b);
