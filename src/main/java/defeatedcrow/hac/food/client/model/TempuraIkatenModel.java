...
public class TempuraIkatenModel<T extends Entity> extends EntityModel<T> {

	private final ModelPart bowl;
	private final ModelPart meal;

	public TempuraIkatenModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r5 = meal.addOrReplaceChild("cube_r5", CubeListBuilder.create()
				.texOffs(9, 27).addBox(-4.0F, -2.0F, -3.0F, 3.0F, 0.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(0, 25).addBox(-3.5F, -2.5F, -3.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(9, 15).addBox(1.0F, -2.0F, -0.5F, 3.0F, 0.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(0, 13).addBox(1.5F, -2.5F, -0.5F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0873F, 0.5236F, 0.0F));

		PartDefinition cube_r6 = meal.addOrReplaceChild("cube_r6", CubeListBuilder.create()
				.texOffs(9, 21).addBox(-1.5F, -2.0F, -1.5F, 3.0F, 0.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(0, 19).addBox(-1.0F, -2.5F, -1.5F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.1745F, 0.5236F, 0.0F));
