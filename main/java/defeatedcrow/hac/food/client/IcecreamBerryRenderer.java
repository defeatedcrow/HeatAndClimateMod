...
public class IcecreamBerryRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate", "textures/entity/food/icecream_berry.png");
	private static final ModelIcecream MODEL = new ModelIcecream(false);

	public IcecreamBerryRenderer(RenderManager renderManager) {
		super(renderManager);
	}
