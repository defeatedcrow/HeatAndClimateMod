...
public class DonutModel<T extends Entity> extends EntityModel<T> {

	private final ModelPart base;

	public DonutModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition base = partdefinition.addOrReplaceChild("base", CubeListBuilder.create()
		    ...
		    .texOffs(0, 4)
		    .addBox(1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.ZERO);
		...
		PartDefinition base2 = base.addOrReplaceChild("base2", CubeListBuilder.create()
		    ...
		    .texOffs(0, 0)
		    .addBox(-3.0F, -2.0F, -3.0F, 6.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, (float) Math.PI, 0.0F));
