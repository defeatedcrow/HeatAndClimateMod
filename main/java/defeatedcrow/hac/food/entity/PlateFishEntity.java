...
public class PlateFishEntity extends FoodEntityBase {

	public PlateFishEntity(World worldIn) {
		super(worldIn);
		this.setSize(0.75F, 0.25F);
	}

	public PlateFishEntity(World worldIn, double posX, double posY, double posZ) {
		super(worldIn, posX, posY, posZ);
		this.setSize(0.75F, 0.25F);
	}

	public PlateFishEntity(World worldIn, double posX, double posY, double posZ, @Nullable EntityPlayer player) {
