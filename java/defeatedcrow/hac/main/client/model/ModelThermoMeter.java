...
public class ModelThermoMeter extends DCTileModelBase {
	...
	private void setFloatPoint(float[] points) {
		if (points != null) {
			fro.rotationPointY = points[0] + 8.0F;
			cld.rotationPointY = points[1] + 8.0F;
			coo.rotationPointY = points[2] + 8.0F;
			nor.rotationPointY = points[3] + 8.0F;
			wam.rotationPointY = points[4] + 8.0F;
			hot.rotationPointY = points[5] + 6.0F;
			ovn.rotationPointY = points[6] + 6.0F;
			kln.rotationPointY = points[7] + 6.0F;
			smt.rotationPointY = points[8] + 6.0F;
			uht.rotationPointY = points[9] + 6.0F;
		}
	}
