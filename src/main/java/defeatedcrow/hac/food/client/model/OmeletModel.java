...
public class OmeletModel<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition egg = partdefinition.addOrReplaceChild("egg", CubeListBuilder.create(), PartPose.ZERO);

		PartDefinition cube_r5 = egg.addOrReplaceChild("cube_r5", CubeListBuilder.create()
				.texOffs(12, 17).addBox(-3.5F, -1.5F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(16, 17).addBox(2.5F, -1.5F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(6, 16).addBox(2.0F, -1.8F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
				.texOffs(0, 16).addBox(-3.0F, -1.8F, -1.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
				.texOffs(0, 12).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.7854F, 0.0F));

		PartDefinition vegi = partdefinition.addOrReplaceChild("vegi", CubeListBuilder.create()
				.texOffs(4, 19).addBox(-2.5F, -1.5F, 0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.ZERO);

		PartDefinition cube_r6 = vegi.addOrReplaceChild("cube_r6", CubeListBuilder.create()
				.texOffs(-3, 21).addBox(-4.0F, -1.0F, 1.0F, 3.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.3491F, 0.4363F, 0.0F));

		PartDefinition cube_r7 = vegi.addOrReplaceChild("cube_r7", CubeListBuilder.create()
				.texOffs(3, 21).addBox(-4.0F, -1.0F, 1.0F, 3.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.2618F, 0.7854F, 0.0F));

		PartDefinition cube_r8 = vegi.addOrReplaceChild("cube_r8", CubeListBuilder.create()
				.texOffs(4, 19).addBox(-3.5F, -1.5F, 1.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.3054F, 0.0F));

		PartDefinition cube_r9 = vegi.addOrReplaceChild("cube_r9", CubeListBuilder.create()
				.texOffs(0, 19).addBox(-3.5F, -1.0F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.1745F));
