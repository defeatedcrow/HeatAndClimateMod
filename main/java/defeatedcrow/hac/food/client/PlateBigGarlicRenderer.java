...
import defeatedcrow.hac.food.client.model.ModelBigGarlicSteak;
...
public class PlateBigGarlicRenderer extends DCRenderFoodBase<BigGarlicPlateEntity> {

	private static final ResourceLocation RAW_TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/steak_big_garlic_raw.png");
	private static final ResourceLocation BAKED_TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/steak_big_garlic_cooked.png");
	private static final ModelBigGarlicSteak RAW_MODEL = new ModelBigGarlicSteak(false);
	private static final ModelBigGarlicSteak BAKED_MODEL = new ModelBigGarlicSteak(true);
	...
	@Override
	public void doRender(BigGarlicPlateEntity entity, double x, double y, double z, float yaw, float partialTicks) {
	...
	public PlateBigGarlicRenderer(RenderManager renderManager) {
		super(renderManager);
	}
