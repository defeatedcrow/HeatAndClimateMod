...
public class MealShawarmaRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/shawarma.png");
	private static final ModelShawarma MODEL = new ModelShawarma(false);

	public MealShawarmaRenderer(RenderManager renderManager) {
		super(renderManager);
	}
