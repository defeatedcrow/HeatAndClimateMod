...
public class StewEggRenderer extends DCRenderFoodBase<FoodEntityBase> {
	...
	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/stew_egg.png");
	private static final ModelStewBowl MODEL = new ModelStewBowl(false);

	public StewEggRenderer(RenderManager renderManager) {
		super(renderManager);
	}
