...
import defeatedcrow.hac.food.client.model.ModelBigChickenSteak;
...
public class PlateBigChickenRenderer extends DCRenderFoodBase<PlateBigChickenEntity> {

	private static final ResourceLocation RAW_TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/steak_big_chicken_raw.png");
	private static final ResourceLocation BAKED_TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/steak_big_chicken_baked.png");
	private static final ModelBigChickenSteak RAW_MODEL = new ModelBigChickenSteak(false);
	private static final ModelBigChickenSteak BAKED_MODEL = new ModelBigChickenSteak(true);
	...
	@Override
	public void doRender(PlateBigChickenEntity entity, double x, double y, double z, float yaw, float partialTicks) {
	...
	public PlateBigChickenRenderer(RenderManager renderManager) {
		super(renderManager);
	}
