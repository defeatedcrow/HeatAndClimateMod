...
public class KichenStoveMenu extends AbstractContainerMenu {

	private final KichenStoveTile container;
	...
	public static KichenStoveMenu getMenu(int i, Inventory playerInv, KichenStoveTile cont) {
		return new KichenStoveMenu(MachineInit.CHAMBER_MENU.get(), i, playerInv, cont, new SimpleContainerData(2));
	}

	public KichenStoveMenu(MenuType<?> type, int s, Inventory playerInv, KichenStoveTile cont, ContainerData d) {
		super(type, s);
