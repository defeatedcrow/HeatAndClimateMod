...
public class Rice_JambalayaModel<T extends Entity> extends EntityModel<T> {

	private final ModelPart bowl;
	private final ModelPart rice;
	private final ModelPart meat;

	public Rice_JambalayaModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = bowl.addOrReplaceChild("cube_r1", CubeListBuilder.create()
		    .texOffs(36, 8)
		    .addBox(-6.5F, -6.0F, 4.0F, 13.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.0F, 0.0F, -0.4363F, 1.5708F, 0.0F));

		PartDefinition cube_r2 = bowl.addOrReplaceChild("cube_r2", CubeListBuilder.create()
		    .texOffs(36, 8)
		    .addBox(-6.5F, -6.0F, 4.0F, 13.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.0F, 0.0F, -0.4363F, 3.1416F, 0.0F));
		...
		PartDefinition cube_r4 = bowl.addOrReplaceChild("cube_r4", CubeListBuilder.create()
		    .texOffs(36, 8)
		    .addBox(-6.5F, -6.0F, 4.0F, 13.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.0F, 0.0F, -0.4363F, 0.0F, 0.0F));
		...
		PartDefinition meat3_r1 = meat.addOrReplaceChild("meat3_r1", CubeListBuilder.create()
		    .texOffs(47, 15)
		    .addBox(-3.0F, -3.5F, -3.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
		    .texOffs(47, 15)
		    .addBox(1.5F, -3.5F, -2.5F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.1745F, 0.0F));

		PartDefinition meat2_r1 = meat.addOrReplaceChild("meat2_r1", CubeListBuilder.create()
		    .texOffs(47, 23)
		    .addBox(-0.8F, -3.5F, -2.5F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0873F, 0.0F));
