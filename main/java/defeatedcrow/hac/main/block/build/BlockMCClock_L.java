...
public class BlockMCClock_L extends BlockContainerDC {
	...
	public BlockMCClock_L(Material m, String s) {
		super(m, s);
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileMCClock_L();
	}

	@Override
	public boolean onRightClick(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand,
			EnumFacing side, float hitX, float hitY, float hitZ) {
		if (player != null && MainUtil.isPlayerHeldItem(MainInit.wrench, player)) {
			TileEntity t = world.getTileEntity(pos);
			if (t instanceof TileMCClock_L) {
				TileMCClock_L clock = (TileMCClock_L) t;
