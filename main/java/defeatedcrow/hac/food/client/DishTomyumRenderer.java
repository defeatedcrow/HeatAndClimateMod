...
public class DishTomyumRenderer extends DCRenderFoodBase<FoodEntityBase> {
	...
	public DishTomyumRenderer(RenderManager renderManager) {
		super(renderManager);
	}
	...
	protected ResourceLocation getTex() {
		String s = "textures/entity/food/dish_tomyum.png";
