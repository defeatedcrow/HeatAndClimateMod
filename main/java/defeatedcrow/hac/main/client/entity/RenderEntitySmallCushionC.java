...
public class RenderEntitySmallCushionC extends Render<EntitySmallCushionA> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/cushion_straw.png");
	private static final ModelSmallCution MODEL = new ModelSmallCution(false);

	public RenderEntitySmallCushionC(RenderManager renderManager) {
		super(renderManager);
