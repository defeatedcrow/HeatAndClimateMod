...
import defeatedcrow.hac.machine.client.model.ModelHandCrank;
...
public class HandCrankTESR extends DCTorqueTESRBase {

	@Override
	protected String getTexPass(int i) {
		return "dcs_climate:textures/tiles/handcrank_brass.png";
	}

	private static final DCTileModelBase MODEL = new ModelHandCrank();
