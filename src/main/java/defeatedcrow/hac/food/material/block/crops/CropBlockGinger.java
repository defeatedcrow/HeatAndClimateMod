...
public class CropBlockGinger extends ClimateCropBaseBlock {
	...
	public List<JsonModelDC> getBlockModel() {
		return ImmutableList.of(
		    ...
		    new JsonModelDC("dcs_climate:block/dcs_cross", ImmutableMap.of("cross", "dcs_climate:block/crop/ginger_" + getSpeciesName(cropTier) + "_d")));
	}
	...
	public ItemLike getSeedItem(CropTier t) {
		return switch (t) {
		case COMMON -> FoodInit.BLOCK_GN_CARDAMOM.get();
		case RARE -> FoodInit.BLOCK_GN_TURMERIC.get();
		default -> FoodInit.BLOCK_GN_COMMON.get();
		};
	}
	...
	public Item getCropItem(CropTier t) {
		return switch (t) {
		case COMMON -> FoodInit.CROP_GN_CARDAMOM.get();
		case RARE -> FoodInit.CROP_GN_TURMERIC.get();
		default -> FoodInit.CROP_GN_COMMON.get();
		};
	}
	...
	public Optional<Block> getMutationTarget(CropTier t) {
		return switch (t) {
		case WILD -> Optional.of(FoodInit.BLOCK_GN_COMMON.get());
		case COMMON -> Optional.of(FoodInit.BLOCK_GN_CARDAMOM.get());
		case RARE -> Optional.of(FoodInit.BLOCK_GN_TURMERIC.get());
	...
	public List<String> getGeneratedBiomeTag(CropTier t) {
		return switch (t) {
		case WILD, COMMON -> ImmutableList.of("JUNGLE", "SWAMP");
