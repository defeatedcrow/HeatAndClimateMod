...
public class WagashiIsobeRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate", "textures/entity/food/wagashi_isobe.png");
	private static final ModelMochi MODEL = new ModelMochi(false);

	public WagashiIsobeRenderer(RenderManager renderManager) {
		super(renderManager);
	}
