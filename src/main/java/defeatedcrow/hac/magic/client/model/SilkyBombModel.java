...
public class SilkyBombModel extends EntityModel<ChairEntity> {

	private final ModelPart base;

	public SilkyBombModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition main = partdefinition.addOrReplaceChild("base", CubeListBuilder.create()
