...
public class EntityDesktopAccessories_I extends DCEntityBase {

	public EntityDesktopAccessories_I(World worldIn) {
		super(worldIn);
	...
	public EntityDesktopAccessories_I(World worldIn, double posX, double posY, double posZ) {
		this(worldIn);
	...
	protected ItemStack drops() {
		return new ItemStack(MainInit.desktopAccessories, 1, 8);
	}
	...
	public boolean processInitialInteract(EntityPlayer player, EnumHand hand) {
		...
		if (MainUtil.isHeldItem(new ItemStack(MainInit.colorChanger), player)) {
			Entity change = new EntityDesktopAccessories_A(player.getEntityWorld());
