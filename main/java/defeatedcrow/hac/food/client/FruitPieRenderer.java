...
public class FruitPieRenderer extends DCRenderFoodBase<PieFruitEntity> {
	...
	public FruitPieRenderer(RenderManager renderManager) {
		super(renderManager);
	}
