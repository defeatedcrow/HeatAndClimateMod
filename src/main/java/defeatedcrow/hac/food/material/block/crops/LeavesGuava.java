...
public class LeavesGuava extends LeavesCropBlockDC {

	public LeavesGuava() {
		super(CropType.MYRTLE, CropTier.COMMON, false);
		this.setSeason(EnumSeason.SPRING_EARLY, EnumSeason.SUMMER_LATE);
		flowerSeasons.add(EnumSeason.SPRING_LATE);
		cropSeasons.add(EnumSeason.AUTUMN_EARLY);
	}
	...
	public String getRegistryName() {
		return "food/leaves_myrtle_guava";
	}
	...
	public ItemLike getSeedItem(CropTier t) {
		return FoodInit.BLOCK_MY_GUAVA.get();
	}
	...
	public List<String> getGeneratedBiomeTag(CropTier t) {
		return ImmutableList.of("JANGLE, SWAMP");
	}
