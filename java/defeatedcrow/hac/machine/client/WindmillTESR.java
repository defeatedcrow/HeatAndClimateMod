...
import defeatedcrow.hac.machine.client.model.ModelWindmill;
...
public class WindmillTESR extends DCTorqueTESRBase {

	@Override
	protected String getTexPass(int i) {
		return "dcs_climate:textures/tiles/windmill_brass.png";
	}

	private static final DCTileModelBase MODEL = new ModelWindmill();
