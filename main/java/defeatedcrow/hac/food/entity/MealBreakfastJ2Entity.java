...
public class MealBreakfastJ2Entity extends FoodEntityBase {

	public MealBreakfastJ2Entity(World worldIn) {
		super(worldIn);
		this.setSize(0.75F, 0.25F);
	}

	public MealBreakfastJ2Entity(World worldIn, double posX, double posY, double posZ) {
		super(worldIn, posX, posY, posZ);
		this.setSize(0.75F, 0.25F);
	}

	public MealBreakfastJ2Entity(World worldIn, double posX, double posY, double posZ, @Nullable EntityPlayer player) {
	...
	protected ItemStack[] drops() {
		return new ItemStack[] { new ItemStack(FoodInit.setMeal, 1, 2), new ItemStack(FoodInit.setMeal, 1, 2) };
	}
