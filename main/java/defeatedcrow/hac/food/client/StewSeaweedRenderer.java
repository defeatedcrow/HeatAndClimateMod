...
public class StewSeaweedRenderer extends DCRenderFoodBase<FoodEntityBase> {
	...
	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/stew_seaweed.png");
	private static final ModelStewBowl MODEL = new ModelStewBowl(false);

	public StewSeaweedRenderer(RenderManager renderManager) {
		super(renderManager);
	}
