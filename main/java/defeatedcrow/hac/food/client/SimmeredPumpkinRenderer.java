...
public class SimmeredPumpkinRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/simmered_pumpkin.png");
	private static final ModelSimmered MODEL = new ModelSimmered(false);

	public SimmeredPumpkinRenderer(RenderManager renderManager) {
		super(renderManager);
	}
