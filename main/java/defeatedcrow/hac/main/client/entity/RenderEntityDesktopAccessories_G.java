...
import defeatedcrow.hac.main.client.model.ModelDesktopAccessories_F;
...
public class RenderEntityDesktopAccessories_G extends Render<DCEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/desktop_g.png");
	private static final DCTileModelBase MODEL = new ModelDesktopAccessories_F();

	public RenderEntityDesktopAccessories_G(RenderManager renderManager) {
		super(renderManager);
