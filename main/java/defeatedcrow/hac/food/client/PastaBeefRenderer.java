...
public class PastaBeefRenderer extends DCRenderFoodBase<FoodEntityBase> {
	...
	private static final ResourceLocation PASTA_TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/pasta_beef.png");
	private static final ModelDishPasta MODEL = new ModelDishPasta(false);

	public PastaBeefRenderer(RenderManager renderManager) {
		super(renderManager);
	}
