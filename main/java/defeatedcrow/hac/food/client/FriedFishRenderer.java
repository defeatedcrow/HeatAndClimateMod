...
public class FriedFishRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/fried_fish.png");
	private static final ModelDeepFry MODEL = new ModelDeepFry(false);

	public FriedFishRenderer(RenderManager renderManager) {
		super(renderManager);
	}
