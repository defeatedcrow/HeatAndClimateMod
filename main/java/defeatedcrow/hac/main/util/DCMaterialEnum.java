...
public enum DCMaterialEnum {
	...
	// 耐火耐寒性能の高さ以外特になし
	LINEN(0, "linen", 1.0F, new int[] { 1, 2, 2, 1 }, 0, 72, 0.0F, 20, 2.0F, 1.0F, new ItemStack(MainInit.clothes, 1,
			0), SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0.0F),
	// 少し耐寒より
	CLOTH(1, "cloth", 1.0F, new int[] { 1, 2, 2, 1 }, 0, 108, 0.0F, 25, 2.0F, 3.0F, new ItemStack(MainInit.clothes, 1,
			1), SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0.0F),
	// 純金属は基本的に利用しない
	COPPER(2, "copper", 2.0F, new int[] { 1, 2, 2, 1 }, 1, 128, 1.0F, 5, 0.5F, 0.5F, new ItemStack(MainInit.oreIngot, 1,
			0), SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F),
	ZINC(3, "zinc", 2.0F, new int[] { 1, 2, 2, 1 }, 1, 128, 1.0F, 5, 0.5F, 0.5F, new ItemStack(MainInit.oreIngot, 1,
			1), SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F),
	NICKEL(4, "nickel", 2.0F, new int[] { 1, 2, 2, 1 }, 1, 256, 1.0F, 5, 1.0F, 1.0F, new ItemStack(MainInit.oreIngot, 1,
			2), SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F),
	...
	WOOL(14, "wool", 3.0F, new int[] { 1, 2, 2, 1 }, 1, 64, 0.0F, 10, 1.0F, 3.0F, new ItemStack(Blocks.WOOL, 1,
			0), SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0.0F),
	// 耐久の低い攻性の金属素材
	TOOLMETAL(15, "toolmetal", 15.0F, new int[] { 6, 10, 8, 5 }, 5, 720, 12.0F, 10, 0.0F, 0.0F, new ItemStack(
			MainInit.oreIngot, 1, 17), SoundEvents.ITEM_ARMOR_EQUIP_IRON, 2.0F);
