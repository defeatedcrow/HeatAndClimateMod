...
public class CakeYogurtRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/cake_yogurt.png");
	private static final ModelJelly MODEL = new ModelJelly(false);

	public CakeYogurtRenderer(RenderManager renderManager) {
		super(renderManager);
	}
