...
import defeatedcrow.hac.food.client.model.ModelSmore;
...
public class CakeRaisinRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/cake_raisin.png");
	private static final ModelSmore MODEL = new ModelSmore(false);

	public CakeRaisinRenderer(RenderManager renderManager) {
		super(renderManager);
	}
