...
public class AnkoBreadRenderer extends DCRenderFoodBase<BreadRoundEntity> {
	...
	public AnkoBreadRenderer(RenderManager renderManager) {
		super(renderManager);
	}
