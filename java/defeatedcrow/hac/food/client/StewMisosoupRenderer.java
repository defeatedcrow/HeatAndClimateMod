...
public class StewMisosoupRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation BOWL_TEX = new ResourceLocation("dcs_climate", "textures/entity/food/stewbowl_base.png");
	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate", "textures/entity/food/stew_misosoup.png");
	private static final ModelStewBowl MODEL = new ModelStewBowl(false);

	public StewMisosoupRenderer(RenderManager renderManager) {
		super(renderManager);
	}
