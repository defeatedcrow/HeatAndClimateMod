...
public class WagashiNerikiriRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate", "textures/entity/food/wagashi_nerikiri.png");
	private static final ModelMochi MODEL = new ModelMochi(false);

	public WagashiNerikiriRenderer(RenderManager renderManager) {
		super(renderManager);
	}
