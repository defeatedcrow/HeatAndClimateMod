...
public class MaterialRecipes {
	...
	public static final Color WHITE
	    = new Color("white", MagicColor.WHITE, CoreInit.ORE_WHITE, CoreInit.ORE_WHITE_DEEP, CoreInit.GEM_CRYSTAL, CoreInit.GEM_THUNDEREGG, CoreInit.GEM_CATSEYE, CoreInit.OREITEM_WHITE1, CoreInit.OREITEM_WHITE2, CoreInit.OREITEM_WHITE3, CoreInit.OREDUST_WHITE1, CoreInit.OREDUST_WHITE2, CoreInit.OREDUST_WHITE3);

	public static final Color BLUE
	    = new Color("blue", MagicColor.BLUE, CoreInit.ORE_BLUE, CoreInit.ORE_BLUE_DEEP, () -> Items.LAPIS_LAZULI, CoreInit.GEM_CELESTITE, CoreInit.GEM_SAPPHIRE, CoreInit.OREITEM_BLUE1, CoreInit.OREITEM_BLUE2, CoreInit.OREITEM_BLUE3, CoreInit.OREDUST_BLUE1, CoreInit.OREDUST_BLUE2, CoreInit.OREDUST_BLUE3);

	public static final Color BLACK
	    = new Color("black", MagicColor.BLACK, CoreInit.ORE_BLACK, CoreInit.ORE_BLACK_DEEP, CoreInit.GEM_VIVIANITE, CoreInit.GEM_FANG, CoreInit.GEM_OPAL, CoreInit.OREITEM_BLACK1, CoreInit.OREITEM_BLACK2, CoreInit.OREITEM_BLACK3, CoreInit.OREDUST_BLACK1, CoreInit.OREDUST_BLACK2, CoreInit.OREDUST_BLACK3);

	public static final Color RED
	    = new Color("red", MagicColor.RED, CoreInit.ORE_RED, CoreInit.ORE_RED_DEEP, CoreInit.GEM_JASPER, CoreInit.GEM_ALMANDINE, CoreInit.GEM_RUBY, CoreInit.OREITEM_RED1, CoreInit.OREITEM_RED2, CoreInit.OREITEM_RED3, CoreInit.OREDUST_RED1, CoreInit.OREDUST_RED2, CoreInit.OREDUST_RED3);

	public static final Color GREEN
	    = new Color("green", MagicColor.GREEN, CoreInit.ORE_GREEN, CoreInit.ORE_GREEN_DEEP, CoreInit.GEM_MALACHITE, CoreInit.GEM_OLIVINE, CoreInit.GEM_DEMANTOID, CoreInit.OREITEM_GREEN1, CoreInit.OREITEM_GREEN2, CoreInit.OREITEM_GREEN3, CoreInit.OREDUST_GREEN1, CoreInit.OREDUST_GREEN2, CoreInit.OREDUST_GREEN3);

	public static final Color[] COLOR_VARIANT = { WHITE, BLUE, BLACK, RED, GREEN };

	public static final Alloy BRASS
	    = new Alloy("brass", Rarity.COMMON, CoreInit.METALBLOCK_BRASS, CoreInit.DUSTBLOCK_BRASS, CoreInit.INGOT_BRASS, () -> TagDC.ItemTag.DUST_COPPER, () -> TagDC.ItemTag.DUST_ZINC, () -> TagDC.ItemTag.DUST_ZINC);

	public static final Alloy BRONZE
	    = new Alloy("bronze", Rarity.COMMON, CoreInit.METALBLOCK_BRONZE, CoreInit.DUSTBLOCK_BRONZE, CoreInit.INGOT_BRONZE, () -> TagDC.ItemTag.DUST_COPPER, () -> TagDC.ItemTag.DUST_TIN, () -> TagDC.ItemTag.DUST_TIN);

	public static final Alloy NICKEL_SILVER
	    = new Alloy("nickel_silver", Rarity.UNCOMMON, CoreInit.METALBLOCK_NICKEL_SILVER, CoreInit.DUSTBLOCK_NICKEL_SILVER, CoreInit.INGOT_NICKEL_SILVER, () -> TagDC.ItemTag.DUST_COPPER, () -> TagDC.ItemTag.DUST_NICKEL, () -> TagDC.ItemTag.DUST_ZINC);

	public static final Alloy STEEL
	    = new Alloy("steel", Rarity.UNCOMMON, CoreInit.METALBLOCK_STEEL, CoreInit.DUSTBLOCK_STEEL, CoreInit.INGOT_STEEL, () -> TagDC.ItemTag.DUST_IRON, () -> TagDC.ItemTag.DUST_IRON, () -> TagDC.ItemTag.DUST_COAL);

	public static final Alloy ALUMINUM
	    = new Alloy("aluminum", Rarity.UNCOMMON, CoreInit.METALBLOCK_ALUMINUM, CoreInit.DUSTBLOCK_ALUMINUM, CoreInit.INGOT_ALUMINUM, () -> TagDC.ItemTag.DUST_ALUMINUM, () -> TagDC.ItemTag.DUST_ALUMINUM, () -> TagDC.ItemTag.GEM_FLUORITE);

	public static final Alloy SILVER
	    = new Alloy("silver", Rarity.COMMON, CoreInit.METALBLOCK_SILVER, CoreInit.DUSTBLOCK_SILVER, CoreInit.INGOT_SILVER, () -> TagDC.ItemTag.DUST_SILVER, () -> TagDC.ItemTag.DUST_SILVER, () -> TagDC.ItemTag.DUST_GOLD);

	public static final Alloy SUS = new Alloy("sus", Rarity.RARE, CoreInit.METALBLOCK_SUS, CoreInit.DUSTBLOCK_SUS, CoreInit.INGOT_SUS, () -> TagDC.ItemTag.DUST_IRON, () -> TagDC.ItemTag.DUST_CHROMIUM, () -> TagDC.ItemTag.DUST_NICKEL);

	public static final Alloy TITANIUM
	    = new Alloy("titanium", Rarity.RARE, CoreInit.METALBLOCK_TITANIUM, CoreInit.DUSTBLOCK_TITANIUM, CoreInit.INGOT_TITANIUM, () -> TagDC.ItemTag.DUST_TITANIUM, () -> TagDC.ItemTag.DUST_ALUMINUM, () -> TagDC.ItemTag.DUST_CHROMIUM);

	public static final Alloy MAGNET
	    = new Alloy("magnet", Rarity.RARE, CoreInit.METALBLOCK_MAGNET, CoreInit.DUSTBLOCK_MAGNET, CoreInit.INGOT_MAGNET, () -> TagDC.ItemTag.DUST_MAGNETITE, () -> TagDC.ItemTag.DUST_COAL, () -> TagDC.ItemTag.GEM_CELESTITE);

	public static final Alloy COBALT
	    = new Alloy("cobalt_alloy", Rarity.RARE, CoreInit.METALBLOCK_COBALT, CoreInit.DUSTBLOCK_COBALT, CoreInit.INGOT_COBALT, () -> TagDC.ItemTag.DUST_COBALT, () -> TagDC.ItemTag.DUST_CHROMIUM, () -> TagDC.ItemTag.DUST_TUNGSTEN);

	public static final Alloy HASTELLOY
	    = new Alloy("hastelloy", Rarity.RARE, CoreInit.METALBLOCK_HASTELLOY, CoreInit.DUSTBLOCK_HASTELLOY, CoreInit.INGOT_HASTELLOY, () -> TagDC.ItemTag.DUST_NICKEL, () -> TagDC.ItemTag.DUST_CHROMIUM, () -> TagDC.ItemTag.DUST_MOLYBDENUM);

	public static final Alloy BSCCO
	    = new Alloy("bscco", Rarity.RARE, CoreInit.METALBLOCK_BSCCO, CoreInit.DUSTBLOCK_BSCCO, CoreInit.INGOT_BSCCO, () -> TagDC.ItemTag.DUST_COPPER, () -> TagDC.ItemTag.DUST_BISMUTH, () -> TagDC.ItemTag.GEM_CELESTITE);
	...
	public static final Stone MUD = new Stone("mud", CoreInit.STONE_MUD, BuildInit.BRICKS_MUD, BuildInit.PILLAR_MUD, BuildInit.CHISELED_MUD, BuildInit.STAIRS_MUD, BuildInit.SLAB_MUD, BuildInit.WALL_MUD);
	public static final Stone GYPSUM = new Stone("gypsum", CoreInit.STONE_GYPSUM, BuildInit.BRICKS_GYPSUM, BuildInit.PILLAR_GYPSUM, BuildInit.CHISELED_GYPSUM, BuildInit.STAIRS_GYPSUM, BuildInit.SLAB_GYPSUM, BuildInit.WALL_GYPSUM);
	public static final Stone SERPENTINE_STONE
	    = new Stone("serpentine", CoreInit.STONE_SERPENTINE, BuildInit.BRICKS_SERPENTINE, BuildInit.PILLAR_SERPENTINE, BuildInit.CHISELED_SERPENTINE, BuildInit.STAIRS_SERPENTINE, BuildInit.SLAB_SERPENTINE, BuildInit.WALL_SERPENTINE);
	public static final Stone GREISEN = new Stone("greisen", CoreInit.STONE_GREISEN, BuildInit.BRICKS_GREISEN, BuildInit.PILLAR_GREISEN, BuildInit.CHISELED_GREISEN, BuildInit.STAIRS_GREISEN, BuildInit.SLAB_GREISEN, BuildInit.WALL_GREISEN);
	public static final Stone SKARN = new Stone("skarn", CoreInit.STONE_SKARN, BuildInit.BRICKS_SKARN, BuildInit.PILLAR_SKARN, BuildInit.CHISELED_SKARN, BuildInit.STAIRS_SKARN, BuildInit.SLAB_SKARN, BuildInit.WALL_SKARN);
	public static final Stone HORNFELS
	    = new Stone("hornfels", CoreInit.STONE_HORNFELS, BuildInit.BRICKS_HORNFELS, BuildInit.PILLAR_HORNFELS, BuildInit.CHISELED_HORNFELS, BuildInit.STAIRS_HORNFELS, BuildInit.SLAB_HORNFELS, BuildInit.WALL_HORNFELS);
	public static final Stone MARBLE = new Stone("marble", CoreInit.STONE_MARBLE, BuildInit.BRICKS_MARBLE, BuildInit.PILLAR_MARBLE, BuildInit.CHISELED_MARBLE, BuildInit.STAIRS_MARBLE, BuildInit.SLAB_MARBLE, BuildInit.WALL_MARBLE);
	public static final Stone SCHIST_BLUE
	    = new Stone("schist_blue", CoreInit.STONE_SCHIST_BLUE, BuildInit.BRICKS_SCHIST_BLUE, BuildInit.PILLAR_SCHIST_BLUE, BuildInit.CHISELED_SCHIST_BLUE, BuildInit.STAIRS_SCHIST_BLUE, BuildInit.SLAB_SCHIST_BLUE, BuildInit.WALL_SCHIST_BLUE);
	public static final Stone SCHIST_NETHER
	    = new Stone("schist_nether", CoreInit.STONE_SCHIST_NETHER, BuildInit.BRICKS_SCHIST_NETHER, BuildInit.PILLAR_SCHIST_NETHER, BuildInit.CHISELED_SCHIST_NETHER, BuildInit.STAIRS_SCHIST_NETHER, BuildInit.SLAB_SCHIST_NETHER, BuildInit.WALL_SCHIST_NETHER);
	public static final Stone GRANITE = new Stone("granite", CoreInit.STONE_GRANITE, BuildInit.BRICKS_GRANITE, BuildInit.PILLAR_GRANITE, BuildInit.CHISELED_GRANITE, BuildInit.STAIRS_GRANITE, BuildInit.SLAB_GRANITE, BuildInit.WALL_GRANITE);
	public static final Stone MORTAR = new Stone("mortar", BuildInit.MORTAR, BuildInit.BRICKS_MORTAR, BuildInit.PILLAR_MORTAR, BuildInit.CHISELED_MORTAR, BuildInit.STAIRS_MORTAR, BuildInit.SLAB_MORTAR, BuildInit.WALL_MORTAR);
