...
public class DCPluginMCE {
	...
	public static void load() {
		...
		MCEconomyAPI.addPurchaseItem(new ItemStack(MainInit.gems, 1, 4), 800);
		MCEconomyAPI.addPurchaseItem(new ItemStack(MainInit.gems, 1, 5), 300);
		MCEconomyAPI.addPurchaseItem(new ItemStack(MainInit.gems, 1, 6), 5000);
		MCEconomyAPI.addPurchaseItem(new ItemStack(MainInit.gems, 1, 7), 9000);
		...
		MCEconomyAPI.addPurchaseItem(new ItemStack(MainInit.gems, 1, 11), 800);
		MCEconomyAPI.addPurchaseItem(new ItemStack(MainInit.gems, 1, 12), 20);
		MCEconomyAPI.addPurchaseItem(new ItemStack(MainInit.gems, 1, 13), 800);
		MCEconomyAPI.addPurchaseItem(new ItemStack(MainInit.gems, 1, 14), 800);
		MCEconomyAPI.addPurchaseItem(new ItemStack(MainInit.gems, 1, 15), 800);
		...
		MCEconomyAPI.addPurchaseItem(new ItemStack(MainInit.gems, 1, 19), 5000);
		MCEconomyAPI.addPurchaseItem(new ItemStack(MainInit.gems, 1, 20), 5000);
		MCEconomyAPI.addPurchaseItem(new ItemStack(MainInit.gems, 1, 21), 5000);
		MCEconomyAPI.addPurchaseItem(new ItemStack(MainInit.gems, 1, 22), 5000);
		MCEconomyAPI.addPurchaseItem(new ItemStack(MainInit.gems, 1, 23), 300);
		MCEconomyAPI.addPurchaseItem(new ItemStack(MainInit.gems, 1, 24), 1000);
