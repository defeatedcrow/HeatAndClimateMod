...
public class StewMushroomRenderer extends DCRenderFoodBase<FoodEntityBase> {
	...
	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/stew_mushroom.png");
	private static final ModelStewBowl MODEL = new ModelStewBowl(false);

	public StewMushroomRenderer(RenderManager renderManager) {
		super(renderManager);
	}
