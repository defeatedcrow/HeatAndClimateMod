...
public class TESRCubeFlame extends TileEntitySpecialRenderer<TileCubeFlame> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate", "textures/tiles/cube_fire.png");
	private static final ModelMagicCube MODEL = new ModelMagicCube();

	@Override
	public void render(TileCubeFlame te, double x, double y, double z, float partialTicks, int destroyStage, float a) {
