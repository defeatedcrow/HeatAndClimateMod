...
public class PulveriseRecipes {
	...
	public static void init() {
		...
		DeviceRecipeList.addPulverizeRecipe(1, RecipeTypeDC.SQUEEZE,
		    new ItemStack(FoodInit.FOOD_STARCH.get(), 3), ItemStack.EMPTY, 0, ItemStack.EMPTY, 0, FluidStack.EMPTY,
		...
		DeviceRecipeList.addPulverizeRecipe(14, RecipeTypeDC.SQUEEZE,
		    new ItemStack(FoodInit.FOOD_PLANT_OIL.get(), 2), new ItemStack(FoodInit.DUST_PLANT.get(), 1), 100, ItemStack.EMPTY, 0,
		    new FluidStack(CoreInit.PLANT_OIL.getStillFluid().get(), 500),
		...
		DeviceRecipeList.addPulverizeRecipe(3, RecipeTypeDC.PULVERISE,
		    new ItemStack(Items.MAGENTA_DYE, 3), new ItemStack(FoodInit.FIBER_PLANT.get(), 1), 50, new ItemStack(FoodInit.DUST_PLANT.get()), 25, FluidStack.EMPTY,
		...
		DeviceRecipeList.addPulverizeRecipe(1, RecipeTypeDC.PULVERISE,
		    new ItemStack(Items.ORANGE_DYE, 3), new ItemStack(FoodInit.DUST_PLANT.get()), 100, ItemStack.EMPTY, 0, FluidStack.EMPTY,
		...
		DeviceRecipeList.addPulverizeRecipe(15, RecipeTypeDC.PULVERISE,
		    new ItemStack(FoodInit.FOOD_PLANT_OIL.get(), 2), new ItemStack(Items.YELLOW_DYE, 1), 100, ItemStack.EMPTY, 0, FluidStack.EMPTY,
