...
public class LeavesAlmond extends LeavesCropBlockDC {

	public LeavesAlmond() {
		super(CropType.CHERRY, CropTier.EPIC, true);
	...
	public String getRegistryName() {
		return "food/leaves_cherry_almond";
	}
	...
	public ItemLike getSeedItem(CropTier t) {
		return FoodInit.BLOCK_CH_ALMOND.get();
	}
