...
import defeatedcrow.hac.main.client.model.ModelDesktopAccessories_E;
...
public class RenderEntityDesktopAccessories_F extends Render<DCEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/desktop_f.png");
	private static final DCTileModelBase MODEL = new ModelDesktopAccessories_E();

	public RenderEntityDesktopAccessories_F(RenderManager renderManager) {
		super(renderManager);
