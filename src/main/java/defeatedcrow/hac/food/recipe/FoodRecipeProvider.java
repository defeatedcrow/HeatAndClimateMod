...
public class FoodRecipeProvider extends RecipeProvider {
	...
	protected void buildCraftingRecipes(Consumer<FinishedRecipe> cons) {
		...
		SpecialRecipeBuilder.special((SimpleRecipeSerializer<?>) CoreInit.FLAVOR_SEREALIZER.get())
	...
	static void foodRecipes(Consumer<FinishedRecipe> cons) {
		...
		ShapelessRecipeBuilder.shapeless(FoodInit.BREAD_CORN_RAW_ITEM.get(), 3)
		...
		ShapelessRecipeBuilder.shapeless(FoodInit.STICK_POTATO_RAW.get(), 1)
		    .requires(Ingredient.of(Tags.Items.RODS_WOODEN))
		...
		ShapelessRecipeBuilder.shapeless(FoodInit.STICK_EGGPLANT_RAW.get(), 1)
		    .requires(Ingredient.of(Tags.Items.RODS_WOODEN))
		...
		ShapelessRecipeBuilder.shapeless(FoodInit.STICK_LETTUCE_RAW.get(), 2)
		    .requires(Ingredient.of(Tags.Items.RODS_WOODEN))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_LETTUCE))
		    .requires(Ingredient.of(TagDC.ItemTag.RAW_PORK))
		...
		ShapelessRecipeBuilder.shapeless(FoodInit.TART_QUICHE_POTATO_RAW_ITEM.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.PASTRY))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_TUBERS))
		    .requires(Ingredient.of(TagDC.ItemTag.MILKS))
		    .requires(Ingredient.of(Tags.Items.EGGS))
		...
		ShapelessRecipeBuilder.shapeless(FoodInit.TART_QUICHE_COD_RAW_ITEM.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.PASTRY))
		...
		ShapelessRecipeBuilder.shapeless(FoodInit.TART_QUICHE_SALMON_RAW_ITEM.get(), 1)
		    .requires(Ingredient.of(TagDC.ItemTag.PASTRY))
		...
		ShapelessRecipeBuilder.shapeless(FoodInit.KOBACHI_SKIPJACK_AVOCADO.get(), 3)
		    .requires(Ingredient.of(TagDC.ItemTag.SKIPJACK))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_AVOCADO))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_ONIONS))
		    .requires(Ingredient.of(TagDC.ItemTag.CROP_GARLIC))
		...
		ShapelessRecipeBuilder.shapeless(FoodInit.KOBACHI_POISSON_CRU.get(), 3)
		    .requires(Ingredient.of(TagDC.ItemTag.RAW_EDIBLE_FISH))
		...
		ShapelessRecipeBuilder.shapeless(FoodInit.TEA_COFFEE_MILK.get(), 1)
	...
	static void materialRecipes(Consumer<FinishedRecipe> cons) {
		...
		ShapedRecipeBuilder.shaped(FoodInit.CLOTH_TREE.get(), 1)
		    .pattern(" X ")
		    .pattern("X X")
		    .pattern(" X ")
		...
		ShapelessRecipeBuilder.shapeless(FoodInit.PLANK_EU_KUKUI.get(), 4)
		...
		ShapelessRecipeBuilder.shapeless(FoodInit.SAP_POISON.get(), 1)
	...
	private static void woodRecipes(Consumer<FinishedRecipe> cons, PlantRecipes.Wood wood) {
		...
		if (wood.logBlock()
		    .get() != null) {
			ShapelessRecipeBuilder.shapeless(wood.plankBlock()
			    .get(), 4)
		...
		ShapedRecipeBuilder.shaped(wood.stairsBlock()
		    .get(), 4)
		    .pattern("X  ")
		    .pattern("XX ")
		    .pattern("XXX")
		...
		ShapedRecipeBuilder.shaped(wood.slimStairsBlock()
		    .get(), 3)
		    .pattern("X  ")
		    .pattern("YX ")
		    .pattern(" YX")
		...
		ShapedRecipeBuilder.shaped(wood.slabBlock()
		    .get(), 6)
		    .pattern("XXX")
		    .define('X', wood.plankBlock()
		        .get())
		...
		ShapedRecipeBuilder.shaped(wood.fenceBlock()
		    .get(), 6)
		    .pattern("XYX")
		    .pattern("XYX")
		    .define('X', wood.plankBlock()
		...
		if (wood.doorBlock()
		    .get() != null) {
			ShapedRecipeBuilder.shaped(wood.doorBlock()
			    .get(), 3)
			    .pattern("XX")
			    .pattern("XX")
			    .pattern("XX")
		...
		if (wood.trapdoorBlock()
		    .get() != null) {
			ShapedRecipeBuilder.shaped(wood.trapdoorBlock()
			    .get(), 3)
			    .pattern("XXX")
			    .pattern("XXX")
			    .define('X', wood.plankBlock()
	...
	private static void seedingRecipes(Consumer<FinishedRecipe> cons, PlantRecipes.Seeding seed) {
		if (seed.output()
			...
			ShapelessRecipeBuilder.shapeless(seed.output()
			    .get(), seed.count())
			    .requires(seed.input()
			        .get())
	...
	static void contRecipes(Consumer<FinishedRecipe> cons, ContainerRecipes.Cont pair) {
		if (pair.inputTag()
			...
			ShapedRecipeBuilder.shaped(pair.output()
			    .get(), 1)
			    .pattern("XXX")
			    .pattern("XXX")
			    .pattern("XXX")
			...
			ShapelessRecipeBuilder.shapeless(pair.input()
			    .get(), 9)
