...
public class VeinTableRegister implements IVeinTableRegister {
	...
	public void registerVeins() {
		...
		VeinTable sand = new VeinTable(EnumVein.SAND_SEDIMENT, new OreSetDC(100, new BlockSet(MainInit.ores_2, 0),
				SAND), new OreSetDC(100, new BlockSet(MainInit.ores_2, 0), SAND));
		sand.addOreToTable1(new OreSetDC(40, new BlockSet(MainInit.ores_2, 1), SAND), new OreSetDC(30, new BlockSet(
				MainInit.ores_2, 2), SAND), new OreSetDC(30, new BlockSet(MainInit.ores_2, 0), SAND));
		sand.addOreToTable2(new OreSetDC(40, new BlockSet(MainInit.ores_2, 1)), new OreSetDC(30, new BlockSet(
		...
		VeinTable bx = new VeinTable(EnumVein.BAUXITE, new OreSetDC(100, new BlockSet(MainInit.ores_2, 10), STONE2),
				new OreSetDC(100, new BlockSet(MainInit.ores_2, 10), STONE2));
		bx.addOreToTable1(new OreSetDC(30, new BlockSet(Blocks.STONE, 1), STONE2), new OreSetDC(70, new BlockSet(
				MainInit.ores_2, 10), STONE2));
		bx.addOreToTable2(new OreSetDC(30, new BlockSet(Blocks.STONE, 1), STONE2), new OreSetDC(70, new BlockSet(
				MainInit.ores_2, 10), STONE2));
		list.add(bx);
		...
		ks.addOreToTable1(new OreSetDC(40, new BlockSet(MainInit.ores, 6), new BlockSet(MainInit.ores, 7), 20),
				new OreSetDC(30, new BlockSet(MainInit.ores, 8), new BlockSet(MainInit.ores_2, 9), 5), new OreSetDC(20,
						new BlockSet(MainInit.ores, 4), new BlockSet(MainInit.ores, 7), 30), new OreSetDC(10,
		...
		ks.addOreToTable2(new OreSetDC(40, new BlockSet(MainInit.ores, 6), new BlockSet(MainInit.ores, 7), 20),
				new OreSetDC(30, new BlockSet(MainInit.ores, 8), new BlockSet(MainInit.ores_2, 9), 5), new OreSetDC(20,
						new BlockSet(MainInit.ores, 4), new BlockSet(MainInit.ores_2, 4), 20), new OreSetDC(10,
								new BlockSet(MainInit.ores, 7)));
		list.add(ks);

		VeinTable qt = new VeinTable(EnumVein.QUARTZ, new OreSetDC(100, new BlockSet(Blocks.STONE, 1)), new OreSetDC(
				100, new BlockSet(MainInit.ores, 9)));
		qt.addOreToTable1(new OreSetDC(30, new BlockSet(MainInit.ores, 8), new BlockSet(MainInit.ores_2, 9), 5, CHAL),
				new OreSetDC(30, new BlockSet(MainInit.ores, 15), CHAL), new OreSetDC(10, new BlockSet(MainInit.ores,
						10), CHAL), new OreSetDC(20, new BlockSet(MainInit.ores, 12), CHAL), new OreSetDC(10,
								new BlockSet(MainInit.ores, 11), CHAL));
		...
		VeinTable go = new VeinTable(EnumVein.GEODE, new OreSetDC(100, new BlockSet(Blocks.STONE, 1)), new OreSetDC(100,
				new BlockSet(MainInit.ores, 9)));
		go.addOreToTable1(new OreSetDC(20, new BlockSet(MainInit.ores, 9)), new OreSetDC(10, new BlockSet(MainInit.ores,
				13), CHAL), new OreSetDC(10, new BlockSet(MainInit.ores, 14), CHAL), new OreSetDC(10, new BlockSet(
						MainInit.ores, 10), CHAL), new OreSetDC(20, new BlockSet(MainInit.ores, 12), CHAL),
				new OreSetDC(10, new BlockSet(MainInit.ores_2, 5), CHAL), new OreSetDC(10, new BlockSet(MainInit.ores_2,
						11), CHAL), new OreSetDC(10, new BlockSet(Blocks.AIR, 0)));
		go.addOreToTable2(new OreSetDC(20, new BlockSet(MainInit.ores, 9)), new OreSetDC(10, new BlockSet(MainInit.ores,
				13), CHAL), new OreSetDC(10, new BlockSet(MainInit.ores, 14), CHAL), new OreSetDC(10, new BlockSet(
						MainInit.ores, 10), CHAL), new OreSetDC(20, new BlockSet(MainInit.ores, 12), CHAL),
				new OreSetDC(10, new BlockSet(MainInit.ores_2, 5), CHAL), new OreSetDC(10, new BlockSet(MainInit.ores_2,
						11), CHAL), new OreSetDC(10, new BlockSet(Blocks.AIR, 0)));
		...
		VeinTable sk = new VeinTable(EnumVein.SKARN, new OreSetDC(100, new BlockSet(MainInit.ores_2, 0)), new OreSetDC(
				100, new BlockSet(MainInit.gemBlock, 6)));
		sk.addOreToTable1(new OreSetDC(30, new BlockSet(MainInit.ores, 6)), new OreSetDC(30, new BlockSet(MainInit.ores,
				8), new BlockSet(MainInit.ores_2, 9), 5), new OreSetDC(20, new BlockSet(MainInit.ores, 4)),
				new OreSetDC(20, new BlockSet(MainInit.ores_2, 4)));
		...
		VeinTable sku = new VeinTable(EnumVein.SKARN_UNDER, new OreSetDC(100, new BlockSet(MainInit.ores_2, 0)),
				new OreSetDC(100, new BlockSet(MainInit.gemBlock, 6)));
