...
import defeatedcrow.hac.food.client.model.ModelBreakfastB;
...
public class SetmealBreakfastRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/setmeal_breakfast.png");
	private static final ModelBreakfastB MODEL = new ModelBreakfastB(false);

	public SetmealBreakfastRenderer(RenderManager renderManager) {
		super(renderManager);
	}
