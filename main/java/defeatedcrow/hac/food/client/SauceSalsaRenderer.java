...
public class SauceSalsaRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/sauce_salsa.png");
	private static final ModelCocotte MODEL = new ModelCocotte(false);

	public SauceSalsaRenderer(RenderManager renderManager) {
		super(renderManager);
	}
