...
public class ClimateMain {
	...
	public static final int MOD_BUILD = 12;
	public static final String MOD_DEPENDENCIES = "required-after:Forge@[12.18.3.2185,);required-after:dcs_climate|lib@[1.5.9,)";
