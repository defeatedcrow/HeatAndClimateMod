...
public class LoadingBuildingRecipe {
	...
	public static void advanced(RecipeResourcesMain res) {
		if (ModuleConfig.build_advanced) {
			...
			DCRecipe.jsonShapedRecipe(HaCModule.BUILD_ADVANCED, "main_build", new ItemStack(MainInit.smallTableWood,
					1, 0), new Object[] {
							"XXX",
							"Y Y",
							'X',
			...
			DCRecipe.jsonShapedRecipe(HaCModule.BUILD_ADVANCED, "main_build", new ItemStack(MainInit.smallTableStone,
					1, 0), new Object[] {
							"XXX",
							"Y Y",
							'X',
			...
			DCRecipe.jsonShapedRecipe(HaCModule.BUILD_ADVANCED, "main_build", new ItemStack(MainInit.sofaPink, 1,
					0), new Object[] {
							" X ",
							"YYY",
							"ZZZ",
			...
			DCRecipe.jsonShapedRecipe(HaCModule.BUILD_ADVANCED, "main_build", new ItemStack(MainInit.sofaGreen, 1,
					0), new Object[] {
							" X ",
							"YYY",
							"ZZZ",
			...
			DCRecipe.jsonShapedRecipe(HaCModule.BUILD_ADVANCED, "main_build", new ItemStack(MainInit.sofaBlue, 1,
					0), new Object[] {
							" X ",
							"YYY",
							"ZZZ",
			...
			DCRecipe.jsonShapedRecipe(HaCModule.BUILD_ADVANCED, "main_build", new ItemStack(MainInit.sofaRattan, 1,
					0), new Object[] {
							"YXY",
							"YYY",
							'X',
			...
			DCRecipe.jsonShapedRecipe(HaCModule.BUILD_ADVANCED, "main_build", new ItemStack(MainInit.stoolSmall, 1,
					0), new Object[] {
							"Y",
							"Z",
							'Y',
			...
			DCRecipe.jsonShapedRecipe(HaCModule.BUILD_ADVANCED, "main_build", new ItemStack(MainInit.coatRack,
					1, 0), new Object[] {
							"Z",
							"X",
							"Y",
