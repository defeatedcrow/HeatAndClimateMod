...
public class BasicRecipeRegister {
	...
	static void loadAnotherRecipes(RecipeResourcesMain res) {
		...
		DCRecipe.jsonShapelessRecipe(HaCModule.CORE, "main", 2, new ItemStack(Items.FLINT_AND_STEEL, 1,
				0), new Object[] {
						new ItemStack(MainInit.oreItem, 1, 3),
		...
		for (int i = 0; i < 16; i++) {
			DCRecipe.jsonShapedRecipe(HaCModule.CORE, "main", new ItemStack(Blocks.STAINED_HARDENED_CLAY, 8,
					i), new Object[] {
							"XXX",
							"XYX",
							"XXX",
