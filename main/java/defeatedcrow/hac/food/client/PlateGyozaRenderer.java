...
import defeatedcrow.hac.food.client.model.ModelGyoza;
...
public class PlateGyozaRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation RAW_TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/gyoza_raw.png");
	private static final ResourceLocation BAKED_TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/gyoza_baked.png");
	private static final ModelGyoza RAW_MODEL = new ModelGyoza(false);
	private static final ModelGyoza BAKED_MODEL = new ModelGyoza(true);
	...
	public void doRender(FoodEntityBase entity, double x, double y, double z, float yaw, float partialTicks) {
		...
		GlStateManager.scale(1.02F, 1.02F, 1.02);
	...
	public PlateGyozaRenderer(RenderManager renderManager) {
		super(renderManager);
	}
