...
public class HaCVillagerAgriResearchHouse extends StructureVillagePieces.Village {
	...
	public static HaCVillagerAgriResearchHouse createPiece(StructureVillagePieces.Start start,
		...
		StructureBoundingBox box = StructureBoundingBox.getComponentToAddBoundingBox(minX, minY, minZ, 0, 0, 0, 11, 7,
				11, facing);
		return StructureComponent.findIntersecting(list, box) != null
				? null
	...
	public boolean addComponentParts(World world, Random rand, StructureBoundingBox box) {
		...
		this.func_189927_a(world, box, rand, 3, 1, 5, EnumFacing.SOUTH);
		this.func_189926_a(world, EnumFacing.SOUTH, 3, 3, 4, box);
		...
		this.func_189927_a(world, box, rand, 6, 1, 0, EnumFacing.NORTH);
		this.setBlockState(world, stair1, 6, 0, -1, box);
		this.func_189926_a(world, EnumFacing.NORTH, 6, 3, 1, box);
	...
	protected int chooseProfession(int villagersSpawned, int currentVillagerProfession) {
		FMLControlledNamespacedRegistry registry = (FMLControlledNamespacedRegistry) VillagerRegistry.instance()
				.getRegistry();
