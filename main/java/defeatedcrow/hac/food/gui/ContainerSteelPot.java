...
public class ContainerSteelPot extends Container {

	public final TileSteelPot processor;
	public final InventoryPlayer player;

	private int[] current = new int[10];

	public ContainerSteelPot(TileSteelPot tile, InventoryPlayer playerInv) {
		this.processor = tile;
