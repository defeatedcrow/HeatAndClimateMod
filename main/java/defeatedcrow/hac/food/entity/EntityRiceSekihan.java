...
public class EntityRiceSekihan extends FoodEntityBase {

	public EntityRiceSekihan(World worldIn) {
		super(worldIn);
		this.setSize(0.25F, 0.25F);
	}

	public EntityRiceSekihan(World worldIn, double posX, double posY, double posZ) {
		super(worldIn, posX, posY, posZ);
		this.setSize(0.25F, 0.25F);
	}

	public EntityRiceSekihan(World worldIn, double posX, double posY, double posZ, @Nullable EntityPlayer player) {
	...
	protected ItemStack[] drops() {
		return new ItemStack[] {
				new ItemStack(FoodInit.ricebowl, 1, 6),
				new ItemStack(FoodInit.ricebowl, 1, 6)
		};
	}
