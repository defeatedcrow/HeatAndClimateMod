...
public class CakeChocolateRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/cake_chocolate.png");
	private static final ModelJelly MODEL = new ModelJelly(false);

	public CakeChocolateRenderer(RenderManager renderManager) {
		super(renderManager);
	}
