...
public class BowlSoupModel<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bowl = partdefinition.addOrReplaceChild("bowl", CubeListBuilder.create()
				...
				.texOffs(-9, 23).addBox(-4.5F, -1.8F, -4.5F, 9.0F, 0.0F, 9.0F, new CubeDeformation(0.0F))
				...
				.texOffs(19, 14).addBox(2.0F, -1.9F, -2.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(19, 22).addBox(-1.5F, -1.9F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.ZERO);
	...
	public void renderOverlay(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
