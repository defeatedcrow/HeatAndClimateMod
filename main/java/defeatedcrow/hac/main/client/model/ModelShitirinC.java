...
public class ModelShitirinC extends DCTileModelBase {
	// fields
	...
	public ModelShitirinC() {
		textureWidth = 64;
		textureHeight = 64;

		body = new ModelRenderer(this);
		body.setRotationPoint(0.0F, 8.0F, 0.0F);
		body.cubeList.add(new ModelBox(body, 0, 0, -8.0F, -4.0F, -8.0F, 16, 1, 16, 0.0F, false));
		body.cubeList.add(new ModelBox(body, 0, 33, -7.0F, -13.0F, -7.0F, 14, 0, 14, 0.0F, false));
		body.cubeList.add(new ModelBox(body, 0, 17, -8.0F, -16.0F, -8.0F, 16, 12, 1, 0.0F, false));
		body.cubeList.add(new ModelBox(body, 0, 7, 4.0F, -3.0F, -7.0F, 3, 3, 3, 0.0F, false));
		body.cubeList.add(new ModelBox(body, 0, 7, -7.0F, -3.0F, -7.0F, 3, 3, 3, 0.0F, false));
		body.cubeList.add(new ModelBox(body, 0, 7, 4.0F, -3.0F, 4.0F, 3, 3, 3, 0.0F, false));
		body.cubeList.add(new ModelBox(body, 0, 7, -7.0F, -3.0F, 4.0F, 3, 3, 3, 0.0F, false));
