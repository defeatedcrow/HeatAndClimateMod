...
public class Rice_ChaofanModel<T extends Entity> extends EntityModel<T> {

	private final ModelPart bowl;
	private final ModelPart rice;

	public Rice_ChaofanModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition rice = partdefinition.addOrReplaceChild("rice", CubeListBuilder.create()
		    .texOffs(0, 21)
		    .addBox(-4.5F, -3.0F, -4.5F, 9.0F, 2.0F, 9.0F, new CubeDeformation(0.0F))
		    .texOffs(30, 21)
		    .addBox(-4.0F, -4.0F, -4.0F, 8.0F, 1.0F, 8.0F, new CubeDeformation(0.0F))
		    .texOffs(36, 14)
		    .addBox(-3.0F, -4.5F, -3.0F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.ZERO);
