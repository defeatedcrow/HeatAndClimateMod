...
public class PlateGratinRenderer extends DCRenderFoodBase<FoodEntityBase> {
	...
	public PlateGratinRenderer(RenderManager renderManager) {
		super(renderManager);
	}
