...
public class SimmeredNattoRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/simmered_natto.png");
	private static final ModelSimmered MODEL = new ModelSimmered(false);

	public SimmeredNattoRenderer(RenderManager renderManager) {
		super(renderManager);
	}
