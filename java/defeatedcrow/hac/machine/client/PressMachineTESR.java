...
public class PressMachineTESR extends DCTorqueTESRBase {

	private static final DCTileModelBase MODEL = new ModelPressMachine();

	@Override
	protected String getTexPass(int i) {
		return "dcs_climate:textures/tiles/press_machine.png";
	}
