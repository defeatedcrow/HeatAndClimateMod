...
public class JellyKuzuRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/jelly_kuzu.png");
	private static final ModelJelly MODEL = new ModelJelly(false);

	public JellyKuzuRenderer(RenderManager renderManager) {
		super(renderManager);
	}
