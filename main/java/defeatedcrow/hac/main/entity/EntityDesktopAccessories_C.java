...
public class EntityDesktopAccessories_C extends DCEntityBase {
	...
	public EntityDesktopAccessories_C(World worldIn) {
		super(worldIn);
	...
	public EntityDesktopAccessories_C(World worldIn, double posX, double posY, double posZ) {
		this(worldIn);
	...
	public boolean processInitialInteract(EntityPlayer player, EnumHand hand) {
		...
		if (MainUtil.isHeldItem(new ItemStack(MainInit.colorChanger), player)) {
			Entity change = new EntityDesktopAccessories_D(player.getEntityWorld());
