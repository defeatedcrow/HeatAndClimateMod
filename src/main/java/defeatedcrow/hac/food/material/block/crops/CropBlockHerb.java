...
public class CropBlockHerb extends ClimateCropBaseBlock {
	...
	public List<JsonModelDC> getBlockModel() {
		return ImmutableList.of(
				...
				new JsonModelDC("dcs_climate:block/dcs_cross", ImmutableMap.of("cross", "dcs_climate:block/crop/herb_" + getSpeciesName(cropTier) + "_d")));
	}
