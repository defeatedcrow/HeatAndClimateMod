...
public class PancakeModel<T extends Entity> extends EntityModel<T> implements TranslucentPartModel {

	private final ModelPart bowl;
	private final ModelPart meal;
	private final ModelPart honey;

	public PancakeModel(ModelPart root) {
		this.bowl = root.getChild("bowl");
		this.meal = root.getChild("meal");
		this.honey = root.getChild("honey");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition meal = partdefinition.addOrReplaceChild("meal", CubeListBuilder.create()
		    ...
		    .texOffs(18, 13)
		    .addBox(-1.0F, -5.0F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.ZERO);

		PartDefinition cube_r5 = meal.addOrReplaceChild("cube_r5", CubeListBuilder.create()
		    .texOffs(0, 13)
		    .addBox(-3.0F, -3.0F, -3.0F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0436F, 0.0F));

		PartDefinition cube_r6 = meal.addOrReplaceChild("cube_r6", CubeListBuilder.create()
		    .texOffs(0, 13)
		    .addBox(-3.0F, -2.0F, -3.0F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.0873F, 0.0F));

		PartDefinition honey = partdefinition.addOrReplaceChild("honey", CubeListBuilder.create()
		    .texOffs(0, 21)
		    .addBox(-1.25F, -4.25F, -2.75F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
		    .texOffs(0, 26)
		    .addBox(0.25F, -4.25F, -3.25F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
		    .texOffs(2, 26)
		    .addBox(-0.5F, -1.25F, -3.5F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.ZERO);
	...
	public void renderTranslucent(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		honey.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
	}
}
