...
import defeatedcrow.hac.food.client.model.ModelCocotte;
...
public class CakeOnionRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/cocotte_onion_raw.png");
	private static final ResourceLocation BAKED = new ResourceLocation("dcs_climate",
			"textures/entity/food/cocotte_onion_baked.png");
	private static final ModelCocotte MODEL = new ModelCocotte(false);

	public CakeOnionRenderer(RenderManager renderManager) {
		super(renderManager);
	}
