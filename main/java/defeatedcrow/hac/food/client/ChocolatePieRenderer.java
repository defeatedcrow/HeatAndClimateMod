...
public class ChocolatePieRenderer extends DCRenderFoodBase<PieChocolateEntity> {
	...
	public ChocolatePieRenderer(RenderManager renderManager) {
		super(renderManager);
	}
