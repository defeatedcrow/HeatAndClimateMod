	...
	public static void advanced(RecipeResourcesMain res) {
		if (ModuleConfig.build_advanced) {
			...
			for (int i = 0; i < 3; i++) {
				...
				DCRecipe.addShapedRecipe(res.getRecipeName(), new ItemStack(MainInit.chalLamp, 1, 12 + i),
						new Object[] {
								"Y",
								"Z",
								'Y',
			...
			DCRecipe.addShapedRecipe(res.getRecipeName(), new ItemStack(MainInit.squaretableMarble, 1, 0),
					new Object[] {
							"XXX",
							"X X",
							'X',
			...
			DCRecipe.addShapedRecipe(res.getRecipeName(), new ItemStack(MainInit.squaretableChecker, 1, 0),
					new Object[] {
							"XXX",
							"X X",
							'X',
			...
			for (int i = 0; i < 16; i++) {
				DCRecipe.addShapelessRecipe(res.getRecipeName(), new ItemStack(MainInit.linoleum, 4, i), new Object[] {
						"plankWood",
						"dustPlant",
						"foodOil",
						"dustLime",
			...
			DCRecipe.addShapedRecipe(res.getRecipeName(), new ItemStack(MainInit.cushionGray, 1, 0), new Object[] {
					" X ",
					"YYY",
					" X ",
					'X',
			...
			DCRecipe.addShapelessRecipe(res.getRecipeName(), new ItemStack(MainInit.cushionGray, 1, 1), new Object[] {
