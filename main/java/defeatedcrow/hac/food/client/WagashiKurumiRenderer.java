...
public class WagashiKurumiRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate", "textures/entity/food/wagashi_kurumiyubesi.png");
	private static final ModelMochi MODEL = new ModelMochi(false);

	public WagashiKurumiRenderer(RenderManager renderManager) {
		super(renderManager);
	}
