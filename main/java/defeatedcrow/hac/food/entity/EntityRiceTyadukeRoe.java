...
public class EntityRiceTyadukeRoe extends FoodEntityBase {

	public EntityRiceTyadukeRoe(World worldIn) {
		super(worldIn);
		this.setSize(0.35F, 0.35F);
	}

	public EntityRiceTyadukeRoe(World worldIn, double posX, double posY, double posZ) {
		super(worldIn, posX, posY, posZ);
		this.setSize(0.35F, 0.35F);
	}

	public EntityRiceTyadukeRoe(World worldIn, double posX, double posY, double posZ, @Nullable EntityPlayer player) {
	...
	protected ItemStack[] drops() {
		return new ItemStack[] {
				new ItemStack(FoodInit.ricebowl, 1, 9),
				new ItemStack(FoodInit.ricebowl, 1, 9)
		};
	}
