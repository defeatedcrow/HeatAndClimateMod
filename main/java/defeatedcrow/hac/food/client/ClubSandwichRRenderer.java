...
public class ClubSandwichRRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/clubsand_round.png");
	private static final ModelClubSand MODEL = new ModelClubSand(false);

	public ClubSandwichRRenderer(RenderManager renderManager) {
		super(renderManager);
	}
