...
import defeatedcrow.hac.machine.client.model.ModelHeatExchanger;
...
public class HeatExchangerTESR extends DCTorqueTESRBase {

	private static final DCTileModelBase MODEL = new ModelHeatExchanger();

	@Override
	protected String getTexPass(int i) {
		return "dcs_climate:textures/tiles/heat_exchanger.png";
	}
