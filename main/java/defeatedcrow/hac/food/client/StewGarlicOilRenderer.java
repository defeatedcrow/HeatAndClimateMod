...
public class StewGarlicOilRenderer extends DCRenderFoodBase<FoodEntityBase> {
	...
	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/stew_garlic_oil.png");
	private static final ModelStewBowl MODEL = new ModelStewBowl(false);

	public StewGarlicOilRenderer(RenderManager renderManager) {
		super(renderManager);
	}
