...
public class DrinkTomatoRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/coldsoup_tomato.png");
	private static final ModelDrinkTomato MODEL = new ModelDrinkTomato(false);

	public DrinkTomatoRenderer(RenderManager renderManager) {
		super(renderManager);
	}
