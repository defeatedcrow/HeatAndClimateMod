...
public class JellyCoffeeRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/jelly_coffee.png");
	private static final ModelJelly MODEL = new ModelJelly(false);

	public JellyCoffeeRenderer(RenderManager renderManager) {
		super(renderManager);
	}
