...
public class DrinkGingerRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/drink_ginger.png");
	private static final ModelDrinkGinger MODEL = new ModelDrinkGinger(false);

	public DrinkGingerRenderer(RenderManager renderManager) {
		super(renderManager);
	}
