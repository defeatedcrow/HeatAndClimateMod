...
public class BiomeTagProviderDC extends BiomeTagsProvider {
	...
	protected void addTags() {
		...
		tag(TagDC.BiomeTag.RED_BIOME).addTags(Tags.Biomes.IS_SANDY, BiomeTags.IS_MOUNTAIN, BiomeTags.IS_BADLANDS);
		tag(TagDC.BiomeTag.GREEN_BIOME).addTags(Tags.Biomes.IS_DENSE, BiomeTags.IS_FOREST, BiomeTags.IS_JUNGLE);
