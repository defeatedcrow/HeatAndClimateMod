...
public class DCPluginMekanism {
	...
	public static void sendIMC() {
		...
		dust_nicke2.setTag("input", new ItemStack(MainInit.ores, 2, 8).writeToNBT(new NBTTagCompound()));
		...
		ore3_nicke2.setTag("input", new ItemStack(MainInit.ores, 2, 8).writeToNBT(new NBTTagCompound()));
		...
		ore4_nicke2.setTag("input", new ItemStack(MainInit.ores, 2, 8).writeToNBT(new NBTTagCompound()));
