...
public class JellyCreamRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/jelly_bakedcream.png");
	private static final ModelJelly MODEL = new ModelJelly(false);

	public JellyCreamRenderer(RenderManager renderManager) {
		super(renderManager);
	}
