...
public class SimmeredBeansRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/simmered_beans.png");
	private static final ModelSimmered MODEL = new ModelSimmered(false);

	public SimmeredBeansRenderer(RenderManager renderManager) {
		super(renderManager);
	}
