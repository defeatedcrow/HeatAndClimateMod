...
public class LeavesLemon extends LeavesCropBlockDC {

	public LeavesLemon() {
		super(CropType.CITRUS, CropTier.RARE);
		this.setSeason(EnumSeason.SPRING_LATE, EnumSeason.SUMMER_EARLY);
	...
	public String getRegistryName() {
		return "food/leaves_citrus_lemon";
	}

	@Override
	public List<JsonModelDC> getBlockModel() {
		return ImmutableList.of(
			new JsonModelDC("dcs_climate:block/dcs_leaves", ImmutableMap.of("all", "dcs_climate:block/tree/citrus_lemon_leaves")),
			new JsonModelDC("dcs_climate:block/dcs_leaves", ImmutableMap.of("all", "dcs_climate:block/tree/citrus_lemon_leaves")),
			new JsonModelDC("dcs_climate:block/dcs_leaves", ImmutableMap.of("all", "dcs_climate:block/tree/citrus_lemon_leaves")),
			new JsonModelDC("dcs_climate:block/dcs_leaves", ImmutableMap.of("all", "dcs_climate:block/tree/citrus_lemon_leaves")),
			new JsonModelDC("dcs_climate:block/dcs_leaves", ImmutableMap.of("all", "dcs_climate:block/tree/citrus_lemon_leaves_f")),
			new JsonModelDC("dcs_climate:block/dcs_leaves", ImmutableMap.of("all", "dcs_climate:block/tree/citrus_lemon_leaves_c")));
	}
	...
	public ItemLike getSeedItem(CropTier t) {
		return FoodInit.BLOCK_CT_LEMON.get();
	}
