...
public class FriedEggModel<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition meal = partdefinition.addOrReplaceChild("meal", CubeListBuilder.create()
			.texOffs(2, 25).addBox(-3.0F, -1.8F, -1.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
			.texOffs(4, 16).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 1.0F, 5.0F, new CubeDeformation(0.0F))
			.texOffs(12, 26).addBox(-2.0F, -1.8F, 3.0F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
			.texOffs(12, 23).addBox(0.0F, -1.8F, -3.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
			.texOffs(22, 17).addBox(-0.5F, -2.5F, 0.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, -0.5F));
