...
public class StewLazijiRenderer extends DCRenderFoodBase<FoodEntityBase> {
	...
	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/stew_laziji.png");
	private static final ModelStewBowl MODEL = new ModelStewBowl(false);

	public StewLazijiRenderer(RenderManager renderManager) {
		super(renderManager);
	}
