...
public class PastaCodRenderer extends DCRenderFoodBase<FoodEntityBase> {
	...
	private static final ResourceLocation PASTA_TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/pasta_cod.png");
	private static final ModelDishPasta MODEL = new ModelDishPasta(false);

	public PastaCodRenderer(RenderManager renderManager) {
		super(renderManager);
	}
