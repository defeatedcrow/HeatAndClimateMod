...
public class StewVegiRenderer extends DCRenderFoodBase<FoodEntityBase> {
	...
	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/stew_vegi.png");
	private static final ModelStewBowl MODEL = new ModelStewBowl(false);

	public StewVegiRenderer(RenderManager renderManager) {
		super(renderManager);
	}
