...
import defeatedcrow.hac.main.client.model.ModelDesktopAccessories_A;
...
public class RenderEntityDesktopAccessories_B extends Render<DCEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/desktop_b.png");
	private static final DCTileModelBase MODEL = new ModelDesktopAccessories_A();

	public RenderEntityDesktopAccessories_B(RenderManager renderManager) {
		super(renderManager);
