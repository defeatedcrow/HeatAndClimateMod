...
public class PlatePaellaRenderer extends DCRenderFoodBase<FoodEntityBase> {
	...
	public PlatePaellaRenderer(RenderManager renderManager) {
		super(renderManager);
	}
