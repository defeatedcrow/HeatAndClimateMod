...
public class PlatePaellaEntity extends FoodEntityBase {

	public PlatePaellaEntity(World worldIn) {
		super(worldIn);
		this.setSize(0.75F, 0.25F);
	}

	public PlatePaellaEntity(World worldIn, double posX, double posY, double posZ) {
		super(worldIn, posX, posY, posZ);
		this.setSize(0.75F, 0.25F);
	}

	public PlatePaellaEntity(World worldIn, double posX, double posY, double posZ, @Nullable EntityPlayer player) {
	...
	protected ItemStack[] drops() {
		return new ItemStack[] { new ItemStack(FoodInit.plateSoup, 1, 6), new ItemStack(FoodInit.plateSoup, 1, 7) };
	}
