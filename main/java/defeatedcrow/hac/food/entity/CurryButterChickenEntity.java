...
public class CurryButterChickenEntity extends FoodEntityBase {

	public CurryButterChickenEntity(World worldIn) {
		super(worldIn);
		this.setSize(0.75F, 0.25F);
	}

	public CurryButterChickenEntity(World worldIn, double posX, double posY, double posZ) {
	...
	protected ItemStack[] drops() {
		return new ItemStack[] {
				new ItemStack(FoodInit.curry, 1, 4),
				new ItemStack(FoodInit.curry, 1, 4)
		};
	}
