...
public class EntityDesktopAccessories_E extends DCEntityBase {

	public EntityDesktopAccessories_E(World worldIn) {
		super(worldIn);
	...
	public EntityDesktopAccessories_E(World worldIn, double posX, double posY, double posZ) {
		this(worldIn);
	...
	protected ItemStack drops() {
		return new ItemStack(MainInit.desktopAccessories, 1, 4);
	}
	...
	public boolean processInitialInteract(EntityPlayer player, EnumHand hand) {
		...
		if (MainUtil.isHeldItem(new ItemStack(MainInit.colorChanger), player)) {
			Entity change = new EntityDesktopAccessories_F(player.getEntityWorld());
