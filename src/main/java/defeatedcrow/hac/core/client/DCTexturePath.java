...
public enum DCTexturePath {
	...
	GUI_CHAMBER_KICHEN("textures/gui/kitchen_stove_inv.png"),
	GUI_CHAMBER_OVEN("textures/gui/kitchen_oven_inv.png"),
	...
	GUI_HOPPER_EXP("textures/gui/hopper_exp_inv.png"),
	...
	GUI_BLACK_ROD("textures/gui/card_stocker_inv.png");
	...
	public static List<DCTexturePath> elements() {
		return ImmutableList.of(POTION, HUD, GRAY, HOT_DISP, COLD_DISP, GUI_INV_SINGLE, GUI_INV_DOUBLE, GUI_DISPLAY_SHELF, GUI_CHAMBER_ITEM, GUI_CHAMBER_FLUID, GUI_FLUID_TANK,
				...
				GUI_HOPPER_FILTER, GUI_HOPPER_GOLD, GUI_HOPPER_GOLD_FILTER, GUI_CONVEYOR_SORTER, GUI_KICHEN_BENCH, GUI_MONITOR_ANDON, GUI_BORING, GUI_DISPLAY_DOUBLE_SHELF,
				GUI_CHAMBER_KICHEN, GUI_CHAMBER_OVEN, GUI_BLACK_ROD, GUI_HOPPER_EXP);
	}
}
