...
public class UdonMeatEntity extends FoodEntityBase {

	public UdonMeatEntity(World worldIn) {
		super(worldIn);
	}

	public UdonMeatEntity(World worldIn, double posX, double posY, double posZ) {
		super(worldIn, posX, posY, posZ);
	}

	public UdonMeatEntity(World worldIn, double posX, double posY, double posZ, @Nullable EntityPlayer player) {
		super(worldIn, posX, posY, posZ, player);
	}

	@Override
	protected ItemStack[] drops() {
		return new ItemStack[] { new ItemStack(FoodInit.udon, 1, 0), new ItemStack(FoodInit.udon, 1, 0) };
	}
