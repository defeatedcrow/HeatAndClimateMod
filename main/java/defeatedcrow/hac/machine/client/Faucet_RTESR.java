...
import defeatedcrow.hac.machine.client.model.ModelFaucet_R;
...
public class Faucet_RTESR extends DCTESRBase {

	private static final DCTileModelBase MODEL1 = new ModelFaucet_S();
	private static final DCTileModelBase MODEL2 = new ModelFaucet_R();
