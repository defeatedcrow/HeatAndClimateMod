...
public class StewGarlicOilEntity extends FoodEntityBase {

	public StewGarlicOilEntity(World worldIn) {
		super(worldIn);
		this.setSize(0.4F, 0.2F);
	}

	public StewGarlicOilEntity(World worldIn, double posX, double posY, double posZ) {
		super(worldIn, posX, posY, posZ);
		this.setSize(0.4F, 0.2F);
	}

	public StewGarlicOilEntity(World worldIn, double posX, double posY, double posZ, @Nullable EntityPlayer player) {
	...
	protected ItemStack[] drops() {
		return new ItemStack[] { new ItemStack(FoodInit.bowlSoup, 1, 14), new ItemStack(FoodInit.bowlSoup, 1, 14) };
	}
