...
public class PastaSquidRenderer extends DCRenderFoodBase<FoodEntityBase> {
	...
	private static final ResourceLocation PASTA_TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/pasta_squid.png");
	private static final ModelDishPasta MODEL = new ModelDishPasta(false);

	public PastaSquidRenderer(RenderManager renderManager) {
		super(renderManager);
	}
