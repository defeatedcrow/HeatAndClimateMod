...
public class BlockLeavesOlive extends ClimateCropBase implements ITexturePath, IShearable {
	...
	public BlockLeavesOlive(String s) {
	...
	public List<ItemStack> getCropItems(IBlockState thisState, int fortune) {
		...
		list.add(new ItemStack(FoodInit.crops, i, 7));
		return list;
	}
