...
public class PlantRecipes {
	...
	private PlantRecipes() {
		...
		list1.add(new Seeding(() -> FoodInit.BLOCK_AL_GARLIC.get(), () -> FoodInit.CROP_AL_WILD.get(), 1));
		...
		list1.add(new Seeding(() -> FoodInit.CROP_RE_SORGHUM.get(), () -> FoodInit.CROP_RE_SORGHUM.get(), 1));
