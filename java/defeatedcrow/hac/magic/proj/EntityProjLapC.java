...
public class EntityProjLapC extends EntityMagicProjBase {

	public EntityProjLapC(World worldIn) {
		super(worldIn);
	}

	public EntityProjLapC(World worldIn, double x, double y, double z) {
		super(worldIn, x, y, z);
	}

	public EntityProjLapC(World worldIn, EntityLivingBase shooter) {
		super(worldIn, shooter);
	}

	@Override
	public ItemStack getDropStack() {
		return new ItemStack(MagicInit.daggerMagic, 1, 9);
	}
	...
	protected boolean onGroundHit() {
		...
		EntityMobBarrier circle = new EntityMobBarrier(worldObj);
