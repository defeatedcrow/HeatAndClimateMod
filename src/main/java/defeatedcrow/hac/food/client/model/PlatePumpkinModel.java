...
public class PlatePumpkinModel<T extends Entity> extends EntityModel<T> {

	private final ModelPart plate;
	private final ModelPart steak;

	public PlatePumpkinModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Steak = partdefinition.addOrReplaceChild("steak", CubeListBuilder.create()
				.texOffs(0, 32).addBox(-4.0F, -5.0F, -4.0F, 8.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.ZERO);
