...
public class DrinkKuzuRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/drink_kuzu.png");
	private static final ModelDrinkKuzu MODEL = new ModelDrinkKuzu(false);

	public DrinkKuzuRenderer(RenderManager renderManager) {
		super(renderManager);
	}
