...
public class RiceMushroomRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/ricebowl_mushroom.png");
	private static final ModelRiceBowl MODEL = new ModelRiceBowl(false);

	public RiceMushroomRenderer(RenderManager renderManager) {
		super(renderManager);
	}
