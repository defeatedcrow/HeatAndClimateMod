...
public class RiceBowlRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/ricebowl_white.png");
	private static final ModelRiceBowl MODEL = new ModelRiceBowl(false);

	public RiceBowlRenderer(RenderManager renderManager) {
		super(renderManager);
	}
