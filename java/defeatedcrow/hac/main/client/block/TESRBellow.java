...
public class TESRBellow extends DCTorqueTESRBase {
	...
	public void render(TileTorqueBase te, DCTileModelBase model, float rot, float speed, float tick) {
		if (te != null && te instanceof TileBellow) {
			TileBellow bellow = (TileBellow) te;
