...
public class ModelShaft_TA extends DCTileModelBase {
	// fields
	ModelRenderer pad1;
	...
	public ModelShaft_TA() {
		...
		shaftcube1.addBox(-1.5F, -6.5F, -1.5F, 3, 5, 3);
		...
		pad3 = new ModelRenderer(this, 0, 34);
		pad3.addBox(-3F, 7F, -3F, 6, 1, 6);
		pad3.setRotationPoint(0F, 0F, 0F);
		pad3.setTextureSize(64, 32);
		pad3.mirror = true;
		setRotation(pad3, 0F, 0F, 0F);
		shaftcube3 = new ModelRenderer(this, 6, 17);
		shaftcube3.addBox(-1.5F, 3F, -1.5F, 3, 4, 3);
