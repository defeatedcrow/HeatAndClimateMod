...
import defeatedcrow.hac.main.client.block.TESRDisplayShopCase;
import defeatedcrow.hac.main.client.block.TESRDisplayStand;
import defeatedcrow.hac.main.client.block.TESRDisplayVendingMachine;
...
public class ClientMainProxy extends CommonMainProxy {
	...
	public void loadTE() {
		...
		registerTileEntity(TileDisplayShopCase.class, "dcs_te_display_shopcase", new TESRDisplayShopCase());
		registerTileEntity(TileDisplayVendingMachine.class, "dcs_te_display_vending_machine", new TESRDisplayVendingMachine());
