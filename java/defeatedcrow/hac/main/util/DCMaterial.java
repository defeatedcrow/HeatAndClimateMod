...
public enum DCMaterial {
	...
	COPPER(
			...
			0.5F,
			0.5F,
			new ItemStack(MainInit.oreIngot, 1, 0),
	...
	ZINC(
			...
			0.5F,
			0.5F,
			new ItemStack(MainInit.oreIngot, 1, 1),
			SoundEvents.ITEM_ARMOR_EQUIP_IRON,
			0.0F),
	NICKEL(
			4,
			...
			0.5F,
			0.5F,
			new ItemStack(MainInit.oreIngot, 1, 2),
			SoundEvents.ITEM_ARMOR_EQUIP_IRON,
			0.0F),
	...
	SILVER(
			...
			0.5F,
			0.5F,
			new ItemStack(MainInit.oreIngot, 1, 3),
	...
	BRASS(
			...
			0.25F,
			0.25F,
			new ItemStack(MainInit.oreIngot, 1, 4),
	...
	NICKELSILVER(
			...
			0.5F,
			0.5F,
			new ItemStack(MainInit.oreIngot, 1, 6),
			SoundEvents.ITEM_ARMOR_EQUIP_IRON,
			0.0F),
	// 熱に弱いが他が強い
	STEEL(
			...
			0.25F,
			0.25F,
			new ItemStack(MainInit.oreIngot, 1, 5),
			SoundEvents.ITEM_ARMOR_EQUIP_IRON,
			1.0F),
	// ピーキー性能
	CHALCEDONY(
	...
	SAPPHIRE(
			...
			0.5F,
			0.5F,
			new ItemStack(MainInit.gems, 1, 4),
