...
public class UdonSeaweedRenderer extends DCRenderFoodBase<FoodEntityBase> {

	private static final ResourceLocation TEX = new ResourceLocation("dcs_climate",
			"textures/entity/food/udon_seaweed.png");
	private static final ModelUdon MODEL = new ModelUdon(false);

	public UdonSeaweedRenderer(RenderManager renderManager) {
		super(renderManager);
	}
