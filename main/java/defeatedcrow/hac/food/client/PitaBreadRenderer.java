...
public class PitaBreadRenderer extends DCRenderFoodBase<FoodEntityBase> {
	...
	public PitaBreadRenderer(RenderManager renderManager) {
		super(renderManager);
	}
