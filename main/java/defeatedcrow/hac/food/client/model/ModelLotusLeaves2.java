...
public class ModelLotusLeaves2 extends DCTileModelBase {
	...
	public ModelLotusLeaves2() {
		...
		stem3.addBox(3F, -4F, 0F, 1, 12, 1, 0F);
		...
		leaf1.setRotationPoint(0F, -10F, 3F);
		leaf1.rotateAngleX = 0.03490658F;
		leaf1.rotateAngleY = 0F;
		leaf1.rotateAngleZ = 0F;
		leaf1.mirror = false;
		leaf2 = new ModelRenderer(this, 16, 0);
		leaf2.addBox(-1F, -1F, -0.5F, 2, 2, 4, 0F);
		leaf2.setRotationPoint(3F, -3F, 0F);
