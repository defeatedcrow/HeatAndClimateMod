...
public class FishPlateEntity extends FoodEntityBase {

	public FishPlateEntity(World worldIn) {
		super(worldIn);
		this.setSize(0.75F, 0.25F);
	}

	public FishPlateEntity(World worldIn, double posX, double posY, double posZ) {
		super(worldIn, posX, posY, posZ);
		this.setSize(0.75F, 0.25F);
	}

	public FishPlateEntity(World worldIn, double posX, double posY, double posZ, @Nullable EntityPlayer player) {
	...
	protected ItemStack[] drops() {
		return new ItemStack[] {
				new ItemStack(FoodInit.plateMeal, 1, 6),
				new ItemStack(FoodInit.plateMeal, 1, 7)
		};
	}
